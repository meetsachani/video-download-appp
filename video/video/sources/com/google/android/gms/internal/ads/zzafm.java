...
public final class zzafm implements zzadn {
    ...
    public final zzaeo b = new zzaeo(-1, -1, "image/avif");

    public final boolean a(zzado zzadoVar, int i) throws IOException {
        zzek zzekVar = this.a;
        zzekVar.i(4);
    ...
    public final boolean g(zzado zzadoVar) throws IOException {
        ...
        if (!a(zzadoVar, 1718909296) || !a(zzadoVar, C9276rZ.D)) {
            return false;
        }
        return true;
    }
