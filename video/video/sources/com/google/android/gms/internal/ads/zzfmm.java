...
public final class zzfmm implements zzfmj {
    ...
    public final JSONObject a(View view) {
        if (view == null) {
            return zzfmt.a(0, 0, 0, 0);
        }
        int[] iArr = this.a;
        int width = view.getWidth();
        int height = view.getHeight();
        view.getLocationOnScreen(iArr);
        return zzfmt.a(iArr[0], iArr[1], width, height);
    }
    ...
    public final void b(View view, JSONObject jSONObject, zzfmi zzfmiVar, boolean z, boolean z2) {
        ...
        if (view instanceof ViewGroup) {
            ...
            if (z) {
                ...
                while (i3 < size) {
                    ...
                    while (true) {
                        i = i3 + 1;
                        if (i4 < size2) {
                            zzfmiVar.a((View) arrayList3.get(i4), this, jSONObject, z2);
                            i4++;
                        }
                    }
                    i3 = i;
            ...
            for (int i5 = 0; i5 < viewGroup.getChildCount(); i5++) {
                zzfmiVar.a(viewGroup.getChildAt(i5), this, jSONObject, z2);
            }
        }
    }
}
