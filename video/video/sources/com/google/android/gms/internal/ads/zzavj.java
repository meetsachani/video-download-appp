...
public class zzavj extends zzavh {
    public static zzaug A1 = null;
    public static zzavo B1 = null;
    public static final Object t1 = new Object();
    public static final String u1 = "zzavj";
    @InterfaceC5056aJ2
    public static boolean v1 = false;
    public static long w1;
    public static zzavr x1;
    public static zzawx y1;
    public static zzawp z1;
    public final zzavi q1;
    @InterfaceC5056aJ2
    public zzawv r1;
    public final Map s1;
                        ...
                        if (g.p()) {
                            ...
                            try {
                                if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.d3)).booleanValue()) {
                                    g.r("LLos9e8Ql/sv7oIXEM/FCVf2w4qxksYVSJjnFOiKAZfJ/fOB+3TAGyZw1OkiJRsU", "lmzfMnrRinUoapvwdylnImZxEAh1S0BzbHZ4/bdyts0=", List.class);
                                }
                            ...
                            try {
                                if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.V2)).booleanValue()) {
                                    ...
                                    g.r("L3kNtlg7QY6D9Xl7pPswVVS/MCBOYXcB4vflYd8GjH187tfdUwj4wLKq5xN70kha", "7KShiw4CrXn9e1sAZ1bf68KLoTIikFllvC3ALPO42ag=", cls3, cls3, cls3, cls3);
                                }
                            } catch (IllegalStateException unused5) {
                            }
                            try {
                                if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.U2)).booleanValue()) {
                                    g.r("q8irn8XqClynUBOsRuq73Jawzwc3gJeVDnk3iDYtMcevrbEAuNWFzcNhN+feXrfp", "dam+Wb9GR7yMSr36KIsK6PGM3yrtzGfNR9lAtk4lliE=", long[].class, Context.class, View.class);
                                }
    ...
    public static zzawq r(zzawo zzawoVar, MotionEvent motionEvent, DisplayMetrics displayMetrics) throws zzawe {
        Method i = zzawoVar.i("L8xVO+KaaDA3r3acgbwvVAQfORMu/AO/jc+P7Gm7GVrn51wWH/CUynJHZ2tWyb88", "cA0h1lVVQMOm5i8Ftty3JhPXQ/C7ZIGa6qN3R34rFvI=");
        if (i != null && motionEvent != null) {
            try {
                return new zzawq((String) i.invoke(null, motionEvent, displayMetrics));
    ...
    public static synchronized void t(Context context, zzavi zzaviVar) {
        synchronized (zzavj.class) {
            try {
                if (!v1) {
                    w1 = System.currentTimeMillis() / 1000;
                    zzavh.p1 = q(context, zzaviVar.a);
                    if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.G3)).booleanValue()) {
                        x1 = zzavr.c(context);
                    }
                    ExecutorService j = zzavh.p1.j();
                    if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.H3)).booleanValue() && j != null) {
                        y1 = zzawx.d(context, j);
                    }
                    if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.V2)).booleanValue()) {
                        z1 = new zzawp();
                    }
                    if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.a3)).booleanValue() || zzaviVar.c.h()) {
                        B1 = new zzavo(context, j);
                    }
                    if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.W2)).booleanValue() || zzaviVar.c.g()) {
                        A1 = new zzaug(context, j, zzaviVar.c, B1);
                    }
                    v1 = true;
                }
            } catch (Throwable th) {
    ...
    public static final void u(List list) {
        ExecutorService j;
        if (zzavh.p1 != null && (j = zzavh.p1.j()) != null && !list.isEmpty()) {
            try {
                j.invokeAll(list, ((Long) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.Q2)).longValue(), TimeUnit.MILLISECONDS);
    ...
    public final void b(View view) {
        ...
        if (this.r1 == null) {
            zzawo zzawoVar = zzavh.p1;
            this.r1 = new zzawv(zzawoVar.a, zzawoVar.f());
        }
        this.r1.d(view);
    }
    ...
    public final long j(StackTraceElement[] stackTraceElementArr) throws zzawe {
        Method i = zzavh.p1.i("UtW7g7feJqOHsjIRMP7TbkL8M4VYsmVrsaULCIKJGwvBOELKcxTQZfT6AHg6wl4V", "3s4OpKjyDjUzqtut1o8wCVCKFRdtRePXWRu+sqk/xG8=");
        if (i != null && stackTraceElementArr != null) {
            try {
                return new zzawf((String) i.invoke(null, stackTraceElementArr)).b.longValue();
            } catch (IllegalAccessException | InvocationTargetException e) {
                throw new zzawe(e);
            }
        }
    ...
    @Override // com.google.android.gms.internal.ads.zzavh
    public final zzask k(Context context, View view, Activity activity) {
        w();
        if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.V2)).booleanValue()) {
            z1.i();
        }
        zzavi zzaviVar = this.q1;
        zzask S2 = zzath.S2();
        String str = zzaviVar.b;
        if (!TextUtils.isEmpty(str)) {
            S2.L2(str);
        }
        s(q(context, zzaviVar.a), S2, view, activity, true, context);
        return S2;
    }

    @Override // com.google.android.gms.internal.ads.zzavh
    public final zzask l(Context context, zzarx zzarxVar) {
        long j;
        long j2;
        w();
        if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.V2)).booleanValue()) {
        ...
        if (!q.p()) {
            ...
            arrayList.add(new zzaxc(q, "5l2BxulTXy+0Wovy9T0xreNvMgccuxz9Mfzqj2nIzDWreku9cf/hyHYbFP2gke7n", "rfz55QLsxMWzB2XqDjYWCElC2tXCWyMh5Hq3cP2KfWk=", S2, a, 27, context, null, zzaviVar.c, A1));
            arrayList.add(new zzaxf(q, "bz3lIaHWpCquphICM8d57wBZcB7vA3QBLpLSSF22FzCVTv7HI8nqsTojeybBUatg", "nJy2u10FH1OsIt1ONuXNmQ7d3Q3+he826LogUVDBAds=", S2, w1, a, 25));
            arrayList.add(new zzaxo(q, "d4PN2fwB2P9jxIUN6NPwGCD1vcjTZd510+VTbYWnWivlqPuX4Pd9jb/zoaClHGV2", "B7r3opNSMuM8FMoC6aVwUNpehxdhrcT61rhsqayMJbM=", S2, a, 1));
            arrayList.add(new zzaxr(q, "G1O+5tqulLBNCxZxcYiJSAGrazgAMWmQ49z8g8PEPhhOgnBizp9p2UWwJMiSx+ju", "xfUFYLaeYlsk7z1gy27YVxCq/UzpfsdVkNtosT4BuNc=", S2, a, 31, context));
            arrayList.add(new zzaxw(q, "AkswGwusnlvibekdTn6rp1TLruqBIpT26qUqw6ERX2GI+0q3NNodYWGNobvk/KA0", "+ySS/EYovSzthax5b5cNVBSw7OeHS3QqC5FfLg20T6g=", S2, a, 33));
            arrayList.add(new zzaxb(q, "agDdf5wrmtJ0cP5XVK0JCsJ4BViR17o/n9P6hmH0muvYwmpx2DZ552/tAJvOo6qR", "48yXjRp5G93PEoVZx8WBMAeqgOhil0yQSUdmW98nZyI=", S2, a, 29, context));
            arrayList.add(new zzaxd(q, "ptULCqFpkxWHwh0HVZoMpk0Xr91rKWbEROvrSrbrHF8bfcD+J1G9qxssmqT2HcO0", "gABvx04l+Prrr7UIzRlxJTdbXEyGkYLmeTdDcw+INuA=", S2, a, 5));
            arrayList.add(new zzaxn(q, "8IJIsIBlDz5+1RGl+6kTNxKhKd20laJu7Ry/q2vMjbAxuJnkIuDVJXV0JiVYkZ0x", "TGJcgVVlBzpT0hARXkl1Qb1oxDrm3oU5utV1aupQqoE=", S2, a, 12));
            arrayList.add(new zzaxp(q, "+T/U1hw7+KZ4U7a2mmAOu7BJ15632T6q77fmzX/Xgjcy3uK841Ng+VsVpINIYuXP", "GzjxqsxzxT+aATwD+mE+LGwR24OtaI/aqws6qGNlH18=", S2, a, 3));
            arrayList.add(new zzaxe(q, "n8+dbEkb8sSSkj8RrAZPAIBpRkB5kUln+00UVnn84X80gYgRIiK8WSxHPJEqxXHc", "yKnJQpgvAxtK/oRpf77IDthT8ZJJ6VXKsBNJ0lMvjYQ=", S2, a, 44));
            arrayList.add(new zzaxj(q, "2yqQbpMMcqKX38M442dN+dCyzykwnAxluzbiBDnzfSZwwykVdh1BxKbQaA6qVZBU", "1XIQFsxUhHfLRHhylour2btyczZCL08SFkmijCbkayQ=", S2, a, 22));
            arrayList.add(new zzaxx(q, "1BnW1+pN8ACAA5SCwHeu4aDyUa+GdAsZQaTQjOE/fWA7hyCouT0ju5bDmhkUNXUI", "kp4jwXczzGPw0lGC8OB8RleYASbnnNEZzgNaMBT0Bfw=", S2, a, 48));
            arrayList.add(new zzaxa(q, "WQkp0526ddrUi1BRkagos9QKSJQ1uugrJcxnlXdGVtysNEwcyhf7H4AuLi1Daa/J", "bIxRlixcWzGpKi+RzORPGFA/CCK1ebxNEgd5yxb9Upc=", S2, a, 49));
            arrayList.add(new zzaxu(q, "ZfusKpZJ8SBLRBp0x6BWNud7pIzhvWIkVd0V0uxTu84aE2cfWFwKn+FMoh4smXgk", "VN0WZ1yYObu9EYHkfC3f48JbFLjOwnUEkH1X8nPNLSU=", S2, a, 51));
            arrayList.add(new zzaxs(q, "jIv42z2v6FXxayFh75bTXtsxRSsCK/ciQjkFKmgks8cLq7HP+HDebRZyGvyOBC97", "2wHbvH170oRSgA6rj2BMxMfMsZs+WbUtizDquheRwWE=", S2, a, 61));
            if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.G3)).booleanValue()) {
                zzawx zzawxVar = y1;
                if (zzawxVar != null) {
                    long c = zzawxVar.c();
                ...
                arrayList.add(new zzaxm(q, "Q2alXHIIp2vvtZN4ZNw4W3dXvS5FZxkSx8F3noC2XP6gq0/XB0ulYQV32h8ZSW0i", "bHzouddPHTqhUNsOeni/FRK++KVVMe5yU+yUqilZ/gg=", S2, a, 11, x1, j, j2));
            }
            if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.F3)).booleanValue()) {
                arrayList.add(new zzaxq(q, "4HRSTLOwWZkuNJXWodn1qJJgWaIIvv19EC2kc5Tc35PPh8H51LV3J7XsfwYf6N8B", "x59qZ2C8s/H9o8A43vx+gBO6K2fFzzXR0hkzA9nrVNs=", S2, a, 73));
            }
            arrayList.add(new zzaxk(q, "dRD+JVHrAp9KS52Ek5z+07PqwexnB2SlEw3dstFC/1pUdbIUHq4sOL+yEg/9GhsH", "AVj0chiCvO7NARSM7gnUx+yq9iwGX0sKyhH1s5c2UEE=", S2, a, 76));
            if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.J3)).booleanValue()) {
                arrayList.add(new zzawz(q, "G6tpJfcfsXNaUQhDJn9Qju0vku5y/oa1fF8zdhZ2CFQQ0yJpdIBybAnW8Cnq7FGe", "fIK5mOsPYa+LmT3H4ctpyCeP1IjF5A1bfJROt5z4ppI=", S2, a, 89));
            }
        }
        u(arrayList);
        return S2;
    ...
    @Override // com.google.android.gms.internal.ads.zzavh
    public final zzask m(Context context, View view, Activity activity) {
        w();
        if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.V2)).booleanValue()) {
            z1.k(context, view);
        }
        ...
        zzask S2 = zzath.S2();
        S2.L2(zzaviVar.b);
        s(q(context, zzaviVar.a), S2, view, activity, false, context);
        return S2;
    }

    @Override // com.google.android.gms.internal.ads.zzavh
    public final zzawq n(MotionEvent motionEvent) throws zzawe {
        Method i = zzavh.p1.i("MzsWIz4gfLj0a3R+qdHFnq4+xme2LarFguHCIutZgqcm6GnV+OetVQKtggSwCSnr", "3rH82U9H9h0NHlfre8U+glRveAN0QJ52a1RA+MBgcOg=");
        if (i != null && motionEvent != null) {
            try {
                return new zzawq((String) i.invoke(null, motionEvent, this.n1));
            } catch (IllegalAccessException | InvocationTargetException e) {
                throw new zzawe(e);
            }
        }
    ...
    public final void s(zzawo zzawoVar, zzask zzaskVar, View view, Activity activity, boolean z, Context context) {
        List list;
        long j;
        long j2;
        ...
        if (!zzawoVar.p()) {
            ...
            if (zzawoVar.j() != null) {
                int a = zzawoVar.a();
                if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.c3)).booleanValue()) {
                    arrayList.add(new zzaxc(zzawoVar, "5l2BxulTXy+0Wovy9T0xreNvMgccuxz9Mfzqj2nIzDWreku9cf/hyHYbFP2gke7n", "rfz55QLsxMWzB2XqDjYWCElC2tXCWyMh5Hq3cP2KfWk=", zzaskVar2, a, 27, context, null, this.q1.c, A1));
                    arrayList.add(new zzaxb(zzawoVar, "agDdf5wrmtJ0cP5XVK0JCsJ4BViR17o/n9P6hmH0muvYwmpx2DZ552/tAJvOo6qR", "48yXjRp5G93PEoVZx8WBMAeqgOhil0yQSUdmW98nZyI=", zzaskVar, a, 29, context));
                    arrayList.add(new zzaxr(zzawoVar, "G1O+5tqulLBNCxZxcYiJSAGrazgAMWmQ49z8g8PEPhhOgnBizp9p2UWwJMiSx+ju", "xfUFYLaeYlsk7z1gy27YVxCq/UzpfsdVkNtosT4BuNc=", zzaskVar, a, 31, context));
                    arrayList.add(new zzaxw(zzawoVar, "AkswGwusnlvibekdTn6rp1TLruqBIpT26qUqw6ERX2GI+0q3NNodYWGNobvk/KA0", "+ySS/EYovSzthax5b5cNVBSw7OeHS3QqC5FfLg20T6g=", zzaskVar, a, 33));
                    zzawx zzawxVar = y1;
                    if (zzawxVar != null) {
                        j = zzawxVar.c();
                        j2 = zzawxVar.b();
                    ...
                    zzaskVar2 = zzaskVar;
                    arrayList.add(new zzaxm(zzawoVar, "Q2alXHIIp2vvtZN4ZNw4W3dXvS5FZxkSx8F3noC2XP6gq0/XB0ulYQV32h8ZSW0i", "bHzouddPHTqhUNsOeni/FRK++KVVMe5yU+yUqilZ/gg=", zzaskVar2, a, 11, x1, j, j2));
                    arrayList.add(new zzaxq(zzawoVar, "4HRSTLOwWZkuNJXWodn1qJJgWaIIvv19EC2kc5Tc35PPh8H51LV3J7XsfwYf6N8B", "x59qZ2C8s/H9o8A43vx+gBO6K2fFzzXR0hkzA9nrVNs=", zzaskVar2, a, 73));
                }
                arrayList.add(new zzaxg(zzawoVar, zzaskVar));
                arrayList.add(new zzaxo(zzawoVar, "d4PN2fwB2P9jxIUN6NPwGCD1vcjTZd510+VTbYWnWivlqPuX4Pd9jb/zoaClHGV2", "B7r3opNSMuM8FMoC6aVwUNpehxdhrcT61rhsqayMJbM=", zzaskVar2, a, 1));
                arrayList.add(new zzaxf(zzawoVar, "bz3lIaHWpCquphICM8d57wBZcB7vA3QBLpLSSF22FzCVTv7HI8nqsTojeybBUatg", "nJy2u10FH1OsIt1ONuXNmQ7d3Q3+he826LogUVDBAds=", zzaskVar, w1, a, 25));
                arrayList.add(new zzaxe(zzawoVar, "n8+dbEkb8sSSkj8RrAZPAIBpRkB5kUln+00UVnn84X80gYgRIiK8WSxHPJEqxXHc", "yKnJQpgvAxtK/oRpf77IDthT8ZJJ6VXKsBNJ0lMvjYQ=", zzaskVar, a, 44));
                arrayList.add(new zzaxn(zzawoVar, "8IJIsIBlDz5+1RGl+6kTNxKhKd20laJu7Ry/q2vMjbAxuJnkIuDVJXV0JiVYkZ0x", "TGJcgVVlBzpT0hARXkl1Qb1oxDrm3oU5utV1aupQqoE=", zzaskVar, a, 12));
                arrayList.add(new zzaxp(zzawoVar, "+T/U1hw7+KZ4U7a2mmAOu7BJ15632T6q77fmzX/Xgjcy3uK841Ng+VsVpINIYuXP", "GzjxqsxzxT+aATwD+mE+LGwR24OtaI/aqws6qGNlH18=", zzaskVar, a, 3));
                arrayList.add(new zzaxj(zzawoVar, "2yqQbpMMcqKX38M442dN+dCyzykwnAxluzbiBDnzfSZwwykVdh1BxKbQaA6qVZBU", "1XIQFsxUhHfLRHhylour2btyczZCL08SFkmijCbkayQ=", zzaskVar, a, 22));
                arrayList.add(new zzaxd(zzawoVar, "ptULCqFpkxWHwh0HVZoMpk0Xr91rKWbEROvrSrbrHF8bfcD+J1G9qxssmqT2HcO0", "gABvx04l+Prrr7UIzRlxJTdbXEyGkYLmeTdDcw+INuA=", zzaskVar, a, 5));
                arrayList.add(new zzaxx(zzawoVar, "1BnW1+pN8ACAA5SCwHeu4aDyUa+GdAsZQaTQjOE/fWA7hyCouT0ju5bDmhkUNXUI", "kp4jwXczzGPw0lGC8OB8RleYASbnnNEZzgNaMBT0Bfw=", zzaskVar, a, 48));
                arrayList.add(new zzaxa(zzawoVar, "WQkp0526ddrUi1BRkagos9QKSJQ1uugrJcxnlXdGVtysNEwcyhf7H4AuLi1Daa/J", "bIxRlixcWzGpKi+RzORPGFA/CCK1ebxNEgd5yxb9Upc=", zzaskVar, a, 49));
                arrayList.add(new zzaxu(zzawoVar, "ZfusKpZJ8SBLRBp0x6BWNud7pIzhvWIkVd0V0uxTu84aE2cfWFwKn+FMoh4smXgk", "VN0WZ1yYObu9EYHkfC3f48JbFLjOwnUEkH1X8nPNLSU=", zzaskVar, a, 51));
                arrayList.add(new zzaxt(zzawoVar, "UtW7g7feJqOHsjIRMP7TbkL8M4VYsmVrsaULCIKJGwvBOELKcxTQZfT6AHg6wl4V", "3s4OpKjyDjUzqtut1o8wCVCKFRdtRePXWRu+sqk/xG8=", zzaskVar, a, 45, new Throwable().getStackTrace()));
                arrayList.add(new zzaxy(zzawoVar, "h7NW4UTeHoapcAfHjNS1jSIEsdu+S9XbBUhqH3zqKlRoFqG3FEF52d6iyzd+cmzU", "UQVAYGHTy6RzP6i5dxbs04Nz2BVdis2XDzzm3D3JwpQ=", zzaskVar, a, 57, view));
                arrayList.add(new zzaxs(zzawoVar, "jIv42z2v6FXxayFh75bTXtsxRSsCK/ciQjkFKmgks8cLq7HP+HDebRZyGvyOBC97", "2wHbvH170oRSgA6rj2BMxMfMsZs+WbUtizDquheRwWE=", zzaskVar, a, 61));
                if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.R2)).booleanValue()) {
                    arrayList.add(new zzawy(zzawoVar, "YX3pd3fZ/j0e82Z3yXv98nYqAI3nsN+d0YAKVHjoLLbjd+BRZ45hNatoujYNmZM/", "2IfMUy5zOuVT1ilWAqZrt9PNbHCY94WGDxwYlYOFZTM=", zzaskVar, a, 62, view, activity));
                }
                if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.J3)).booleanValue()) {
                    arrayList.add(new zzawz(zzawoVar, "G6tpJfcfsXNaUQhDJn9Qju0vku5y/oa1fF8zdhZ2CFQQ0yJpdIBybAnW8Cnq7FGe", "fIK5mOsPYa+LmT3H4ctpyCeP1IjF5A1bfJROt5z4ppI=", zzaskVar, a, 89));
                }
                if (z) {
                    if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.T2)).booleanValue()) {
                        arrayList.add(new zzaxv(zzawoVar, "YdsvNQpLn71zCPsmNiBmaxgvKAoUotN+t67Ej8NmXEez61kI/ElwL7USsI8xuH+E", "BTo9KBR1VAIklcWQcnKn1k6hpYvG+18rom++PUlQVcU=", zzaskVar, a, 53, this.r1));
                    }
                } else {
                    try {
                        if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.U2)).booleanValue()) {
                            arrayList.add(new zzaxi(zzawoVar, "q8irn8XqClynUBOsRuq73Jawzwc3gJeVDnk3iDYtMcevrbEAuNWFzcNhN+feXrfp", "dam+Wb9GR7yMSr36KIsK6PGM3yrtzGfNR9lAtk4lliE=", zzaskVar, a, 85, this.s1, view, context));
                        }
                    } catch (IllegalStateException unused) {
                    }
                    try {
                        if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.V2)).booleanValue()) {
                            arrayList.add(new zzaxh(zzawoVar, "L3kNtlg7QY6D9Xl7pPswVVS/MCBOYXcB4vflYd8GjH187tfdUwj4wLKq5xN70kha", "7KShiw4CrXn9e1sAZ1bf68KLoTIikFllvC3ALPO42ag=", zzaskVar, a, 85, z1));
                        }
                    } catch (IllegalStateException unused2) {
                    }
                    if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.c().b(zzbcv.d3)).booleanValue()) {
                        arrayList.add(new zzaxl(zzawoVar, "LLos9e8Ql/sv7oIXEM/FCVf2w4qxksYVSJjnFOiKAZfJ/fOB+3TAGyZw1OkiJRsU", "lmzfMnrRinUoapvwdylnImZxEAh1S0BzbHZ4/bdyts0=", zzaskVar, a, 94, this.o1));
                    }
                }
            }
            list = arrayList;
    ...
    public final synchronized void v(zzawo zzawoVar, zzask zzaskVar) {
        Long l;
        int i;
        MotionEvent motionEvent;
        try {
            try {
                zzawq r = r(zzawoVar, this.X, this.n1);
                Long l2 = r.b;
                if (l2 != null) {
                    zzaskVar.k2(l2.longValue());
                }
                Long l3 = r.c;
                if (l3 != null) {
                    zzaskVar.m2(l3.longValue());
                }
                Long l4 = r.d;
                if (l4 != null) {
                    zzaskVar.h2(l4.longValue());
                }
                if (this.m1) {
                    Long l5 = r.e;
                    if (l5 != null) {
                        zzaskVar.g2(l5.longValue());
                    }
                    Long l6 = r.f;
                    if (l6 != null) {
                        zzaskVar.d2(l6.longValue());
                    }
                }
            } catch (Throwable th) {
                throw th;
        ...
        zzatd s2 = zzate.s2();
        int i2 = 1;
        if (this.Z > 0 && zzawr.e(this.n1)) {
            s2.b2(zzawr.a(this.e1, 1, this.n1));
            s2.q2(zzawr.a(this.j1 - this.h1, 1, this.n1));
            s2.r2(zzawr.a(this.k1 - this.i1, 1, this.n1));
            s2.h2(zzawr.a(this.h1, 1, this.n1));
            s2.k2(zzawr.a(this.i1, 1, this.n1));
            if (this.m1 && (motionEvent = this.X) != null) {
                long a = zzawr.a(((this.h1 - this.j1) + motionEvent.getRawX()) - this.X.getX(), 1, this.n1);
                if (a != 0) {
                    s2.o2(a);
                }
                long a2 = zzawr.a(((this.i1 - this.k1) + this.X.getRawY()) - this.X.getY(), 1, this.n1);
                if (a2 != 0) {
                    s2.p2(a2);
                }
            }
        ...
        try {
            ...
            if (this.m1) {
                ...
                if (this.Y0 > 0) {
                    if (zzawr.e(this.n1)) {
                        l = Long.valueOf(Math.round(this.d1 / this.Y0));
                    } else {
                        l = null;
                    }
                    if (l != null) {
                    ...
                    s2.a2(Math.round(this.c1 / this.Y0));
                }
                Long l12 = n.j;
                if (l12 != null) {
                    s2.c2(l12.longValue());
        ...
        try {
            ...
            if (size > 0) {
                ...
                for (int i3 = 0; i3 < size; i3++) {
                    zzawq r2 = r(zzavh.p1, (MotionEvent) linkedList.get(i3), this.n1);
                    zzatd s22 = zzate.s2();
                    s22.j2(r2.b.longValue());
                    s22.m2(r2.c.longValue());
                    zzaskVar.A2((zzate) s22.V1());
                }
            }
        } catch (zzawe unused3) {
            zzaskVar.F2();
