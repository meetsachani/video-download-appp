...
public abstract class zzgyk {
    public static zzgyc b(Class cls) {
        String format;
        ...
        try {
            try {
                try {
                    return (zzgyc) cls.cast(((zzgyk) Class.forName(format, true, classLoader).getConstructor(null).newInstance(null)).a());
            ...
            while (it.hasNext()) {
                try {
                    arrayList.add((zzgyc) cls.cast(((zzgyk) it.next()).a()));
