...
public final class zzavt {
    ...
    public final String a(byte[] bArr, byte[] bArr2) throws zzavs {
        byte[] doFinal;
        byte[] iv;
    ...
    public final byte[] b(byte[] bArr, String str) throws zzavs {
        byte[] doFinal;
        int length = bArr.length;
        try {
            byte[] b2 = zzauc.b(str, false);
