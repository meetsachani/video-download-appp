...
final class zzii extends zzhg<Double> implements zzjf<Double>, zzkv, RandomAccess {
    public static final zzii Y0 = new zzii(new double[0], 0, false);
    public double[] Y;
    public int Z;
    ...
    public final boolean addAll(Collection<? extends Double> collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zziiVar.Y, 0, this.Y, this.Z, zziiVar.Z);
            this.Z = i3;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < this.Z; i2++) {
            i = (i * 31) + zziz.b(Double.doubleToLongBits(this.Y[i2]));
        }
        return i;
    }
    ...
    public final /* synthetic */ zzjf<Double> u(int i) {
        if (i >= this.Z) {
            return new zzii(Arrays.copyOf(this.Y, i), this.Z, true);
        }
        throw new IllegalArgumentException();
    }

    public zzii(double[] dArr, int i, boolean z) {
        super(z);
        this.Y = dArr;
        this.Z = i;
    }
