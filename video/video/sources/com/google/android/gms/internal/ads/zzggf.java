...
public final class zzggf extends zzgfk {
    public final zzggm a;
    public final zzgwq b;
    public final zzgwp c;
    @InterfaceC10571ws1
    public final Integer d;

    public /* synthetic */ zzggf(zzggm zzggmVar, zzgwq zzgwqVar, zzgwp zzgwpVar, Integer num, zzgge zzggeVar) {
        this.a = zzggmVar;
        this.b = zzgwqVar;
        this.c = zzgwpVar;
        this.d = num;
