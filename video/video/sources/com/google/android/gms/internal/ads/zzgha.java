...
public final class zzgha extends zzgfk {
    public final zzghi a;
    public final zzgwq b;
    public final zzgwp c;
    @InterfaceC10571ws1
    public final Integer d;

    public /* synthetic */ zzgha(zzghi zzghiVar, zzgwq zzgwqVar, zzgwp zzgwpVar, Integer num, zzggz zzggzVar) {
        this.a = zzghiVar;
        this.b = zzgwqVar;
        this.c = zzgwpVar;
        this.d = num;
