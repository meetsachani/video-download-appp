...
public final class zzhfo {
    public static final zzhfo j = new zzhfo(1.0d, 0.0d, 0.0d, 1.0d, 0.0d, 0.0d, 1.0d, 0.0d, 0.0d);
    public static final zzhfo k = new zzhfo(0.0d, 1.0d, -1.0d, 0.0d, 0.0d, 0.0d, 1.0d, 0.0d, 0.0d);
    public static final zzhfo l = new zzhfo(-1.0d, 0.0d, 0.0d, -1.0d, 0.0d, 0.0d, 1.0d, 0.0d, 0.0d);
    public static final zzhfo m = new zzhfo(0.0d, -1.0d, 1.0d, 0.0d, 0.0d, 0.0d, 1.0d, 0.0d, 0.0d);
    ...
    public final boolean equals(Object obj) {
        ...
        if (Double.compare(zzhfoVar.d, this.d) == 0 && Double.compare(zzhfoVar.e, this.e) == 0 && Double.compare(zzhfoVar.f, this.f) == 0 && Double.compare(zzhfoVar.g, this.g) == 0 && Double.compare(zzhfoVar.h, this.h) == 0 && Double.compare(zzhfoVar.i, this.i) == 0 && Double.compare(zzhfoVar.a, this.a) == 0 && Double.compare(zzhfoVar.b, this.b) == 0 && Double.compare(zzhfoVar.c, this.c) == 0) {
            return true;
        }
        return false;
    }
