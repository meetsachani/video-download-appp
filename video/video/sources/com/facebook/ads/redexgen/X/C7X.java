...
public final class C7X extends AbstractC1794ik {
    ...
    public C7X(C1768iI c1768iI, String str) {
        super(c1768iI.A0B, str, A00(c1768iI));
        this.A01 = c1768iI;
    }

    public static C1767iH A00(C1768iI c1768iI) {
        return new C1767iH(c1768iI);
    }

    @Override // com.facebook.ads.redexgen.X.AbstractC1794ik
    ...
    public final void A09() {
        this.A00 = new C1784iZ(this.A01, this, A04());
    ...
    public final void A0F(com.facebook.ads.Ad ad, String str, AdExperienceType adExperienceType, boolean z) {
        ...
        this.A01.A08 = z;
        if (AbstractC1126Us.A09(this.A02) && AbstractC1126Us.A0B(this.A02)) {
            if (AbstractC1126Us.A0M(str)) {
                A05();
                return;
            } else {
                A09();
