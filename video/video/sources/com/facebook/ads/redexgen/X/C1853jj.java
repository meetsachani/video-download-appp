...
public final class C1853jj extends N3 {
    ...
    public NE A03;
    public NF A04;
    public EnumC1138Ve A05;
    public String A06;
    public WeakReference<C1720hT> A07;
    ...
    public static void A05() {
        A0G = new byte[]{Byte.MAX_VALUE, -88, -92, -93, 85, -102, -83, -104, -102, -91, -87, -98, -92, -93, -52, C2638Cg0.B7, C2638Cg0.C7, -44, C2638Cg0.z7, C2638Cg0.w7, C2638Cg0.n7, -33, -46, -36, -126, -112, -105, -108, -118, 126, -111, -112, -112, -117, -118, -98, -89, -100, -82, -82, -33, -24, -27, -33, -25, -35, -34, -24, C2638Cg0.C7, -104, -85, -89, -91, -108, -110, -101, -100, -95, -89, -90, -103, -108, -125, -121, 123, -127, Byte.MAX_VALUE, -119, -122, -112, -111, -82, -90, -91, -86, -94, -73, -86, -90, -72, -79, -92, -81, -80, -92, -69, -70, -17, -30, -19, -18, -22, -17, -8, -1, -14, -2, -7, -45, C2638Cg0.t7, -46, -36, -71, -84, -67, -84, -67, 2, -10, C8077mf.m, -3, 10, C2638Cg0.B7, -44, -33, C2638Cg0.B7, -43, -30, -26, -27, -18, -42, -43, -34, C2638Cg0.v7, C2638Cg0.n7, -56, C2638Cg0.z7, C2638Cg0.r7, -10, -7, -16, -18, -16, -11, C2638Cg0.p7, C2638Cg0.r7, -74, -76, -78, -76, -71, -74, -80, -66, -74, -75, -70, -78, -115, -125, -108, Byte.MAX_VALUE, -90, -95, -108, -93, -90, -101, -94, -89, -28, -43, -24, -28, -18, -13, -22, -33, -85, -103, -84, -88, -35, -42, -45, -42, -41, -33, -42, -99, -112, -116, -98, -13, -26, -30, -12, -28, -17, -20, -14, -19, -78, -97, 113, 92, -101, 99, 87, -82, 113, 92, -101, -76, C2638Cg0.y7, C2638Cg0.w7, -116, 119, -74, 126, 114, C2638Cg0.x7, -116, 119, -74, C2638Cg0.A7};
    }
    ...
    public C1853jj(C1673gi c1673gi, N4 n4, C1618fp c1618fp, C1864ju c1864ju) {
    ...
    private JSONObject A04(View view) throws JSONException {
        ...
        jSONObject.putOpt(A01(149, 4, 5), String.format(Locale.US, A01(C8463oE0.u, 12, 34), Integer.valueOf(view.getHeight()), Integer.valueOf(view.getWidth())));
        ...
        jSONObject.putOpt(A01(C10997yd1.v1, 4, 101), A01);
    ...
    private void A07(Map<String, String> map) {
        if (this.A02 != null && (this.A02.getNativeAdLayoutApi() instanceof C1702hB)) {
            C1702hB c1702hB = (C1702hB) this.A02.getNativeAdLayoutApi();
            if (c1702hB.A07()) {
                map.put(A01(87, 7, 108), Boolean.TRUE.toString());
            }
            boolean A06 = c1702hB.A06();
            if (A0H[2].charAt(5) == '8') {
                throw new RuntimeException();
            }
            String[] strArr = A0H;
    ...
    public final void A08(Map<String, String> map) {
        ...
        if (this.A00 != null && this.A0F.A0U()) {
            map.put(A01(C3503Kz.m0, 8, 30), A03(this.A00));
        }
        if (this.A0C) {
        ...
        if (this.A0B) {
            map.put(A01(C7834lj1.G, 4, 33), Boolean.TRUE.toString());
        }
        if (this.A01 != null) {
    ...
    public final void A0E(EnumC1138Ve enumC1138Ve) {
        this.A05 = enumC1138Ve;
    }
    ...
    public final void A0G(WeakReference<C1720hT> weakReference) {
