...
public class C1806iw implements NG {
    ...
    public final /* synthetic */ C05407g A04;
    public final /* synthetic */ C1102Tu A05;
    ...
    public static void A01() {
        A07 = new byte[]{-125, -112, -112, -115, -112, C2638Cg0.s7, C2638Cg0.x7, -65};
    }
    ...
    public C1806iw(C05407g c05407g, Runnable runnable, long j, C1102Tu c1102Tu) {
        this.A04 = c05407g;
        this.A06 = runnable;
        this.A03 = j;
        this.A05 = c1102Tu;
    ...
    public final void AEv(C1864ju c1864ju) {
        if (!this.A00) {
            this.A00 = true;
            String[] strArr = A08;
            ...
            this.A04.A05(this.A05.A03(EnumC1106Ty.A02), null);
        }
    ...
    public final void AEw(C1864ju c1864ju) {
        ...
        this.A04.A01 = c1864ju;
        this.A04.A07.A0F(c1864ju);
        if (!this.A02) {
            this.A02 = true;
            ...
            this.A04.A05(this.A05.A03(EnumC1106Ty.A04), A01);
        }
    }

    @Override // com.facebook.ads.redexgen.X.NG
    public final void AEx(C1864ju c1864ju) {
        if (!this.A01) {
            this.A01 = true;
            this.A04.A05(this.A05.A03(EnumC1106Ty.A03), null);
        }
        this.A04.A0O();
    }

    @Override // com.facebook.ads.redexgen.X.NG
    public final void AEz(C1864ju c1864ju, C1145Vm c1145Vm) {
        Map A01;
        if (c1864ju != this.A04.A00) {
            return;
        }
        this.A04.A0H().removeCallbacks(this.A06);
        this.A04.A0Q(c1864ju);
        if (!this.A02) {
            this.A02 = true;
            A01 = this.A04.A01(this.A03);
            A01.put(A00(0, 5, 14), String.valueOf(c1145Vm.A03().getErrorCode()));
            A01.put(A00(5, 3, 72), String.valueOf(c1145Vm.A04()));
            this.A04.A05(this.A05.A03(EnumC1106Ty.A04), A01);
        }
        this.A04.ADp(c1145Vm);
    }
}
