...
public final class C0843Jp {
    ...
    public static void A04() {
        A0M = new byte[]{76, 119, 124, 97, 105, 124, 122, 109, 124, 125, 57, 115, 108, 106, 109, 112, Byte.MAX_VALUE, 112, 122, QC1.w, 109, 112, 118, 119, 57, 111, QC1.w, 117, 108, 124, 35, 57};
    }
    ...
    */
    public final C0842Jo A05() {
        ...
        switch (this.A07) {
            ...
            case 3:
                ...
                return new C0842Jo(spannableStringBuilder, alignment, f4, 0, i3, f3, i, -3.4028235E38f, this.A0E != A0O, this.A0E, this.A09);
            case 1:
                ...
                if (strArr5[1].length() != strArr5[3].length()) {
                    ...
                    return new C0842Jo(spannableStringBuilder, alignment, f42, 0, i3, f32, i, -3.4028235E38f, this.A0E != A0O, this.A0E, this.A09);
                }
                throw new RuntimeException();
            case 2:
                ...
                return new C0842Jo(spannableStringBuilder, alignment, f422, 0, i3, f322, i, -3.4028235E38f, this.A0E != A0O, this.A0E, this.A09);
            default:
    ...
    public static int A01(int i, int i2, int i3, int i4) {
        int i5;
        AbstractC04543y.A00(i, 0, 4);
        AbstractC04543y.A00(i2, 0, 4);
        AbstractC04543y.A00(i3, 0, 4);
        AbstractC04543y.A00(i4, 0, 4);
        switch (i4) {
            case 0:
            case 1:
                i5 = 255;
