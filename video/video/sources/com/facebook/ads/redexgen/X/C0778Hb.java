...
public final class C0778Hb {
    ...
    public C0778Hb(int i, byte[] bArr, int i2, int i3) {
        this.A01 = i;
        this.A03 = bArr;
        this.A02 = i2;
        this.A00 = i3;
    ...
    public final boolean equals(Object obj) {
        ...
        if (strArr[6].length() != strArr[3].length()) {
            A04[1] = "oBkTGyhCOE";
            if (this.A01 == c0778Hb.A01 && this.A02 == c0778Hb.A02 && this.A00 == c0778Hb.A00 && Arrays.equals(this.A03, c0778Hb.A03)) {
                return true;
            }
            return false;
        }
