...
public abstract class AbstractC0998Pr {
    ...
    public static void A02() {
        A01 = new byte[]{-46, C2638Cg0.r7, 5, 28, C2638Cg0.r7, C8077mf.G, 8, C8077mf.y, C8077mf.u};
    }

    static {
        A02();
        A03 = new byte[]{9, 9, 9, 8, 8, 8, 7, 7, 7, 6, 6, 6, 6, 5, 5, 5, 4, 4, 4, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 0, 0, 0, 0};
        A05 = new int[]{1, 10, 100, 1000, 10000, 100000, 1000000, C3827Oh.m, 100000000, 1000000000};
        A04 = new int[]{3, 31, InterfaceC8148mw2.a.q, 3162, 31622, 316227, 3162277, 31622776, 316227766, Integer.MAX_VALUE};
        A06 = new int[]{1, 1, 2, 6, 24, 120, 720, 5040, 40320, 362880, 3628800, 39916800, 479001600};
        A00 = new int[]{Integer.MAX_VALUE, Integer.MAX_VALUE, 65536, 2345, 477, C8463oE0.u, 110, 75, 58, 49, 43, 39, 37, 35, 34, 34, 33};
    }

    public static int A00(int p, int q, RoundingMode mode) {
        AbstractC1912ki.A04(mode);
        if (q != 0) {
            int i = p / q;
            int div = q * i;
            int i2 = p - div;
            ...
            int i3 = ((p ^ q) >> 31) | 1;
            int[] iArr = C0651Cc.A00;
            int div2 = mode.ordinal();
            switch (iArr[div2]) {
                case 1:
                    AbstractC1657gS.A02(i2 == 0);
                case 2:
                    r2 = false;
                    break;
                case 3:
