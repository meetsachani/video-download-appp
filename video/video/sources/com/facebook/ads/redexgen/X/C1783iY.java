...
public final class C1783iY implements T5 {
    public long A00;
    ...
    public C1783iY(C1673gi c1673gi, InterstitialAd interstitialAd, String str) {
        this(c1673gi, interstitialAd, str, new C1793ij());
    }

    public C1783iY(C1673gi c1673gi, InterstitialAd interstitialAd, String str, U3 u3) {
        this.A0A = c1673gi;
        this.A0B = str;
    ...
    public final void A0D(InterstitialAd interstitialAd) {
        if (interstitialAd == null && !C1123Up.A0u(this.A0A)) {
            return;
        }
        this.A01 = interstitialAd;
    }
