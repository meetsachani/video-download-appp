...
public final class HJ {
    ...
    public static void A04() {
        A0C = new byte[]{C8077mf.m, 31, C8077mf.p, 3, 5, 69, C8077mf.n, 6, C8077mf.m, 9};
    }
    ...
    public final HJ A0B(List<String> list) {
        return new HJ(this.A05, this.A03, this.A06, this.A04, this.A07, this.A02, this.A00, this.A09, this.A0A, A02(AbstractC0787Hk.A02(list)));
    }
    ...
    public HJ(byte[] bArr, int i) {
        ...
        c04764u.A08(i * 8);
        this.A05 = c04764u.A04(16);
        this.A03 = c04764u.A04(16);
        this.A06 = c04764u.A04(24);
        this.A04 = c04764u.A04(24);
        this.A07 = c04764u.A04(20);
        this.A08 = A01(this.A07);
        this.A02 = c04764u.A04(3) + 1;
        this.A00 = c04764u.A04(5) + 1;
        this.A01 = A00(this.A00);
        this.A09 = c04764u.A05(36);
        this.A0A = null;
        this.A0B = null;
    }
    ...
    public final long A06() {
        return this.A09 == 0 ? C10323vs.b : (this.A09 * 1000000) / this.A07;
    }
    ...
    public final C2242qI A08(byte[] bArr, Metadata metadata) {
        bArr[4] = Byte.MIN_VALUE;
        int i = this.A04 > 0 ? this.A04 : -1;
        Metadata A02 = A02(metadata);
        C04212p A0h = new C04212p().A11(A03(0, 10, 87)).A0h(i);
        int maxInputSize = this.A02;
        C04212p A0b = A0h.A0b(maxInputSize);
