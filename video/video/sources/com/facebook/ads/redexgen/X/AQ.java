...
public abstract class AQ implements InterfaceC2178pF {
    ...
    public int A00;
    public C04905i A01;
    public final ArrayList<InterfaceC05015t> A02 = new ArrayList<>(1);
    ...
    */
    private final void A0D(C04905i c04905i, boolean z) {
        this.A01 = c04905i;
        for (int i = 0; i < i; i++) {
            this.A02.get(i).AGH(this, c04905i, this.A03, z);
        }
    }

    public final void A0E() {
        C04905i c04905i = (C04905i) C5C.A0f(this.A01);
        for (int i = 0; i < this.A00; i++) {
            this.A02.get(i).AGG(this, c04905i, this.A03);
        }
        this.A01 = null;
    }
    ...
    public final void A0F(int i) {
        ...
        for (int i2 = 0; i2 < this.A00; i2++) {
            this.A02.get(i2).ADK(this, c04905i, this.A03, i);
        }
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void A0G(C04905i c04905i) {
        for (int i = 0; i < i; i++) {
            this.A02.get(i);
    ...
    public final void A0H(C04905i c04905i) {
        A0D(c04905i, false);
    }
    ...
    public final void A43(InterfaceC05015t interfaceC05015t) {
        ...
        if (!this.A02.contains(interfaceC05015t)) {
            this.A02.add(interfaceC05015t);
            this.A00++;
        }
    }
}
