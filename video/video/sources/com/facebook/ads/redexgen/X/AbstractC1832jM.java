...
public abstract class AbstractC1832jM {
    ...
    public static void A04() {
        A00 = new byte[]{-84, -72, -83, -82, -84, -105, -86, -74, -82, 19, C8077mf.q, C8077mf.y, C8077mf.u, 3, 5};
    }

    public abstract void A06(C1829jJ c1829jJ, int i);

    public abstract void A07(EnumC1831jL enumC1831jL, int i);

    public abstract void A08(EnumC1831jL enumC1831jL, int i);

    public abstract void A09(EnumC1831jL enumC1831jL, int i);

    public abstract void A0A(boolean z, String str, EnumC1831jL enumC1831jL, int i);

    private final long A02() {
        return CF.A00().ACf();
    }

    public final C1829jJ A05(boolean z, String str, EnumC1831jL enumC1831jL) {
        C2256qY.A09(str, A03(0, 9, 21));
        C2256qY.A09(enumC1831jL, A03(9, 6, 108));
        return new C1829jJ(A02(), z, str, enumC1831jL);
    }
}
