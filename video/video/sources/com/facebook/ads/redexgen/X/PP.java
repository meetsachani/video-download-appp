...
public final class PP {
    ...
    public final void A03(int i) {
        ...
        if (A00 != null) {
            AbstractC1003Px.A02(A00, this.A04, i);
            A01(i, null);
        }
    }
    ...
    public final boolean A07(float f, float f2) {
        ...
        return AbstractC1003Px.A06(A00, this.A04, f, f2);
    }
    ...
    public final boolean A08(float f, float f2, boolean z) {
        ...
        return AbstractC1003Px.A07(A00, this.A04, f, f2, z);
    }
    ...
    public final boolean A0B(int i, int i2) {
        ...
        if (A06()) {
            ...
            for (ViewParent parent = this.A04.getParent(); parent != null; parent = parent.getParent()) {
                if (AbstractC1003Px.A08(parent, view, this.A04, i, i2)) {
                    A01(i2, parent);
                    AbstractC1003Px.A05(parent, view, this.A04, i, i2);
                    return true;
                }
    ...
    public final boolean A0D(int i, int i2, int startX, int startY, int[] iArr, int i3) {
        ...
        if (i != 0 || i2 != 0 || startX != 0 || startY != 0) {
            ...
            AbstractC1003Px.A03(A00, view, i, i2, startX, startY, i3);
            if (iArr != null) {
                this.A04.getLocationInWindow(iArr);
                iArr[0] = iArr[0] - i4;
    ...
    public final boolean A0F(int startX, int startY, int[] iArr, int[] iArr2, int i) {
        ...
        if (startX != 0 || startY != 0) {
            ...
            consumed[0] = 0;
            consumed[1] = 0;
            AbstractC1003Px.A04(parent, this.A04, startX, startY, consumed, i);
            if (iArr2 != null) {
                this.A04.getLocationInWindow(iArr2);
                iArr2[0] = iArr2[0] - i2;
                iArr2[1] = iArr2[1] - i3;
