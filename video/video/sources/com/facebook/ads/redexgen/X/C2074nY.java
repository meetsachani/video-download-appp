...
public class C2074nY<E> extends AbstractCollection<E> {
    ...
    public final InterfaceC1913kj<? super E> A00;
    ...
    public C2074nY(Collection<E> unfiltered, InterfaceC1913kj<? super E> predicate) {
        this.A01 = unfiltered;
        this.A00 = predicate;
    }
    ...
    public final boolean add(@ParametricNullness E element) {
        AbstractC1912ki.A0C(this.A00.A4C(element));
    ...
    public final void clear() {
        AbstractC2165p2.A03(this.A01, this.A00);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.nY != com.google.common.collect.Collections2$FilteredCollection<E> */
    @Override // java.util.AbstractCollection, java.util.Collection
    public final boolean contains(@CheckForNull Object element) {
        if (AbstractC2078nc.A03(this.A01, element)) {
    ...
    public final boolean containsAll(Collection<?> collection) {
        return AbstractC2078nc.A04(this, collection);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.nY != com.google.common.collect.Collections2$FilteredCollection<E> */
    @Override // java.util.AbstractCollection, java.util.Collection
    public final boolean isEmpty() {
        return !AbstractC2165p2.A02(this.A01, this.A00);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.nY != com.google.common.collect.Collections2$FilteredCollection<E> */
    @Override // java.util.AbstractCollection, java.util.Collection, java.lang.Iterable
    public final Iterator<E> iterator() {
        return AbstractC2172p9.A01(this.A01.iterator(), this.A00);
    }
    ...
    */
    ...
    public final Object[] toArray() {
        return AbstractC2193pU.A05(iterator()).toArray();
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.nY != com.google.common.collect.Collections2$FilteredCollection<E> */
    @Override // java.util.AbstractCollection, java.util.Collection
    public final <T> T[] toArray(T[] array) {
        return (T[]) AbstractC2193pU.A05(iterator()).toArray(array);
    }
}
