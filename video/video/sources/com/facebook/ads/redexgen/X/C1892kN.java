...
public final class C1892kN implements InterfaceC0916Mk {
    ...
    public static final C1892kN A03 = new C1892kN(Collections.emptyMap());
    public int A00;
    ...
    public C1892kN(Map<String, byte[]> metadata) {
        this.A01 = Collections.unmodifiableMap(metadata);
    }

    public static Map<String, byte[]> A00(Map<String, byte[]> otherMetadata, C0917Ml c0917Ml) {
        HashMap hashMap = new HashMap(otherMetadata);
        A01(hashMap, c0917Ml.A08());
        A02(hashMap, c0917Ml.A09());
        return hashMap;
    }
    ...
    */
    ...
    public static byte[] A04(Object obj) {
        ...
        if (obj instanceof String) {
            return ((String) obj).getBytes(AbstractC1879k9.A05);
        }
    ...
    public final C1892kN A05(C0917Ml c0917Ml) {
        Map<String, byte[]> A00 = A00(this.A01, c0917Ml);
        Map<String, byte[]> mutatedMetadata = this.A01;
        if (A03(mutatedMetadata, A00)) {
            return this;
        }
        return new C1892kN(A00);
    }
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC0916Mk
    ...
    public final boolean equals(Object obj) {
        ...
        return A03(this.A01, ((C1892kN) obj).A01);
    }
