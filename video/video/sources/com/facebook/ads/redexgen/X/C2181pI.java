...
public class C2181pI extends SQLiteOpenHelper implements C5O {
    ...
    public static void A01() {
        A00 = new byte[]{104, 1, C8077mf.p, 104, 13, C8077mf.r, 1, C8077mf.E, 28, C8077mf.E, 104, 80, 70, 91, 68, 52, 94, 105, 105, 116, 105, 59, 126, 99, 126, QC1.w, 110, 111, 114, 117, 124, 59, 56, 42, 47, 10, 31, 10, 9, 10, C8077mf.B, C8077mf.p, 59, C8077mf.C, 4, C8077mf.G, 2, C8077mf.q, C8077mf.p, C8077mf.C, 116, 105, 126, 97, 125, 112, 104, 116, 99, 78, QC1.w, Byte.MAX_VALUE, 101, 116, 99, Byte.MAX_VALUE, 112, 125, ED2.a, 117, 115, ED2.a, 48, 60, 52, C8077mf.C, C8077mf.E, 6, 3, C8077mf.H, C8077mf.q, 53, 7, C8077mf.m, C8077mf.C, C8077mf.H, C8077mf.q, C8077mf.B, 34, 32, C4715Xk.i, 56, C3307Iz.X, 52, C8077mf.p, 34, 52, 32, 36, 52, ED2.a, 50, 52, 64, 77, 68, 81};
    }
    ...
    public C2181pI(Context context) {
            ...
            try {
                ...
                if (!A00(88, 15, 125).equals(string2)) {
                    ...
                    try {
                        ...
                        AbstractC04624g.A08(type, A00(16, 16, 55) + str, e);
                    }
                }
            } catch (Throwable th) {
                if (query != null) {
