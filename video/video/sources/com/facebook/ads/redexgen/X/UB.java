...
public final class UB {
    ...
    public static void A05() {
        A02 = new byte[]{115, 6, 1, C8077mf.A};
    }
    ...
    public static void A07(T8 t8, boolean z) {
        ...
        try {
            ...
            String str = Build.FINGERPRINT + A02(0, 1, 19) + c1096To.A06();
            A00 = A002.getString(str, null);
            FutureTask futureTask = new FutureTask(new UA(t8, c1096To, A002, str));
    ...
    public static void A09(T8 t8, boolean z, String str) {
        ...
        A00(t8);
        C1170Wn c1170Wn = new C1170Wn(t8, str);
        try {
            c1170Wn.A06();
            FutureTask futureTask = new FutureTask(new U9(c1170Wn, str));
            Executors.newSingleThreadExecutor().submit(futureTask);
            if (z) {
                futureTask.get();
            }
