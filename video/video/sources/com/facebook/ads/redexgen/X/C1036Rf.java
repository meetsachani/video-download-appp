...
public final class C1036Rf implements AudienceNetworkActivityApi {
    ...
    public static void A01() {
        byte[] bArr = {101, 97, 98, 86, 71, 74, 70, 77, 64, 70, 109, 70, 87, 84, 76, 81, 72, 19, 40, 35, 62, 54, 35, C3307Iz.X, 50, 35, 34, 102, 35, 62, C3307Iz.X, 35, 54, 50, 47, C3307Iz.a0, 40, 104, 60, 51, 2, 60, 62, C3307Iz.a0, 52, C3307Iz.c0, 52, C3307Iz.a0, 36};
        if (A04[2].length() == 12) {
    ...
    public C1036Rf(AudienceNetworkActivity audienceNetworkActivity, AudienceNetworkActivityApi audienceNetworkActivityApi, C1035Re c1035Re) {
    ...
    private void A02(Throwable th) {
        ...
        if (logContext != null) {
            logContext.A08().ABC(A00(38, 11, 116), AbstractC1085Td.A0C, new C1086Te(th));
            return;
        }
