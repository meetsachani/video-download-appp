...
public abstract class AbstractC0868Ko {
    ...
    public static void A03() {
        A00 = new byte[]{115, 108, 48, 13, 5, C8077mf.r, C8077mf.z, 1, C8077mf.r, 17, 85, 34, 48, 55, 35, C3307Iz.V, C3307Iz.V, 91, 85, 50, C8077mf.D, 1, 85, 76, 121, 110, Byte.MAX_VALUE, 121, 114, 104, 125, 123, 121, 111, 60, 113, 105, 111, 104, 60, 121, 114, QC1.w, 60, 107, 117, 104, 116, 60, 57, 87, 69, 66, 86, 84, 84, 121, C8077mf.m, 74, 90, 91, 64, 81, 60, 79, 52, C8077mf.G, 73, 58, 62, C4715Xk.i, C3307Iz.c0, 48};
    }
    ...
    public static void A04(C04774v c04774v) throws C3K {
        int A09 = c04774v.A09();
        if (A05(c04774v)) {
            return;
        }
        c04774v.A0f(A09);
        throw C3K.A01(A02(2, 21, 114) + c04774v.A0T(), null);
    }

    public static boolean A05(C04774v c04774v) {
