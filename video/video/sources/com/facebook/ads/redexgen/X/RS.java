...
public final class RS {
    ...
    public final C1757i7<RK, RQ> A00 = new C1757i7<>();
    ...
    private C1028Qx A00(RK rk, int i) {
        RQ A0B;
        C1028Qx info;
    ...
    public final C1028Qx A03(RK rk) {
        return A00(rk, 8);
    }

    public final C1028Qx A04(RK rk) {
        return A00(rk, 4);
    }
    ...
    public final void A0D(RK rk, C1028Qx c1028Qx) {
        RQ rq = this.A00.get(rk);
        if (rq == null) {
            rq = RQ.A00();
            this.A00.put(rk, rq);
    ...
    public final void A0E(RK rk, C1028Qx c1028Qx) {
        RQ rq = this.A00.get(rk);
        if (rq == null) {
            rq = RQ.A00();
            this.A00.put(rk, rq);
    ...
    public final void A0F(RK rk, C1028Qx c1028Qx) {
        RQ rq = this.A00.get(rk);
        if (rq == null) {
            rq = RQ.A00();
            this.A00.put(rk, rq);
            ...
            if ((A0A.A00 & 3) == 3) {
                ...
                if ((index & 1) != 0) {
                    ...
                    if ((index2 & 4) != 0) {
                        ...
                        int index3 = A0A.A00;
                        if ((index3 & 8) != 0) {
                            C1028Qx c1028Qx = A0A.A02;
                            if (A03[4].charAt(6) == 'y') {
                                throw new RuntimeException();
                            }
                            A03[7] = "pRTOxDzzIVV0VuKMKqyuKOShfW9n8";
                            rr.AH9(A09, c1028Qx, A0A.A01);
                        } else {
                            continue;
                        }
                    }
