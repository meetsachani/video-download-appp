...
public final class AnonymousClass53 {
    ...
    public final synchronized long A06(long j) {
        ...
        if (this.A01 != C10323vs.b) {
            ...
            long j2 = (S9.c.M + A01) / 8589934592L;
    ...
    public final synchronized long A02() {
        long j;
        if (this.A00 != Long.MAX_VALUE && this.A00 != C10071up2.f) {
            j = this.A00;
        }
        j = C10323vs.b;
        return j;
    ...
    public final synchronized long A05(long j) {
        ...
        if (this.A02 == C10323vs.b) {
            if (this.A00 == C10071up2.f) {
                desiredSampleTimestampUs = ((Long) AbstractC04543y.A01(this.A03.get())).longValue();
            } else {
