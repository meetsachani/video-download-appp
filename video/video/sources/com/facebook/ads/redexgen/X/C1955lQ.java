...
public final class C1955lQ implements InterfaceC0875Kv {
    ...
    public long A08;
    public long A09;
    public InterfaceC0780Hd A0A;
    public InterfaceC0780Hd A0B;
    public InterfaceC0780Hd A0C;
    public String A0D;
    public boolean A0E;
    public boolean A0F;
    public boolean A0G;
    public final C04764u A0H;
    ...
    public static void A09() {
        A0L = new byte[]{99, 87, -103, -84, -85, 87, -104, -86, -86, -84, -92, -96, -91, -98, 87, QC1.w, QC1.w, 122, 87, -125, 122, 101, -98, C2638Cg0.p7, -47, -48, -81, C2638Cg0.q7, -66, C2638Cg0.p7, C2638Cg0.q7, C2638Cg0.A7, 77, 110, 125, 110, 108, 125, 110, 109, C3307Iz.a0, 106, 126, 109, 114, QC1.w, C3307Iz.a0, QC1.w, 107, 115, 110, 108, 125, C3307Iz.a0, 125, -126, 121, 110, 67, C3307Iz.a0, -47, -32, -32, -36, C2638Cg0.E7, -45, -47, -28, C2638Cg0.E7, -33, -34, -97, C2638Cg0.E7, -44, -93, -74, C2638Cg0.w7, -71, -66, -60, -124, C2638Cg0.q7, C2638Cg0.s7, -119, -74, -126, C2638Cg0.p7, -74, C2638Cg0.v7, C2638Cg0.q7};
    }
    ...
    public C1955lQ(boolean z) {
        this(z, null);
    }

    public C1955lQ(boolean z, String str) {
        this.A0H = new C04764u(new byte[7]);
        this.A0I = new C04774v(Arrays.copyOf(A0N, 10));
        A06();
        this.A03 = -1;
        this.A02 = -1;
        this.A08 = C10323vs.b;
    ...
    private void A02() throws C3K {
        ...
        if (!this.A0G) {
            ...
            if (A04 != 2) {
                AbstractC04624g.A07(A00(22, 10, 84), A00(32, 28, 0) + A04 + A00(0, 22, 46));
                A04 = 2;
            }
            this.A0H.A09(5);
            int A042 = this.A0H.A04(3);
            int audioObjectType = this.A02;
            byte[] A07 = AbstractC0764Gn.A07(A04, audioObjectType, A042);
            C0763Gm aacConfig = AbstractC0764Gn.A03(A07);
            C04212p A0w = new C04212p().A0y(this.A0D).A11(A00(75, 15, 76)).A0w(aacConfig.A02);
            int audioObjectType2 = aacConfig.A00;
            C04212p A0b = A0w.A0b(audioObjectType2);
            int audioObjectType3 = aacConfig.A01;
            C2242qI A14 = A0b.A0m(audioObjectType3).A12(Collections.singletonList(A07)).A10(this.A0J).A14();
    ...
    private void A0A(C04774v c04774v) {
        ...
        this.A0H.A00[0] = c04774v.A0l()[c04774v.A09()];
        this.A0H.A08(2);
    ...
    private void A0B(C04774v c04774v) {
        ...
        while (A09 < A0A) {
            int endOffset = A09 + 1;
            int i = A0l[A09] & 255;
            if (this.A04 == 512 && A0E((byte) -1, (byte) i) && (this.A0E || A0G(c04774v, endOffset - 2))) {
                this.A01 = (i & 8) >> 3;
                this.A0F = (i & 1) == 0;
                if (!this.A0E) {
                    A05();
    ...
    private void A0C(C04774v c04774v) {
        int min = Math.min(c04774v.A07(), this.A05 - this.A00);
        this.A0A.AIr(c04774v, min);
        int bytesToRead = this.A00;
        this.A00 = bytesToRead + min;
        int i = this.A00;
        int bytesToRead2 = this.A05;
        if (i == bytesToRead2) {
            int bytesToRead3 = (this.A09 > C10323vs.b ? 1 : (this.A09 == C10323vs.b ? 0 : -1));
            if (bytesToRead3 != 0) {
    ...
    private void A0D(InterfaceC0780Hd interfaceC0780Hd, long j, int i, int i2) {
        this.A06 = 4;
        this.A00 = i;
        this.A0A = interfaceC0780Hd;
        this.A07 = j;
        this.A05 = i2;
    }
    ...
    private boolean A0G(C04774v c04774v, int i) {
        c04774v.A0f(i + 1);
        if (A0I(c04774v, this.A0H.A00, 1)) {
            this.A0H.A08(4);
            ...
            if (currentFrameVersion3 != -1) {
                ...
                if (charAt == currentFrameVersion4) {
                    ...
                    c04774v.A0f(currentFrameVersion6);
                }
                throw new RuntimeException();
            }
            if (A0I(c04774v, this.A0H.A00, 4)) {
                this.A0H.A08(14);
    ...
    private boolean A0H(C04774v c04774v, byte[] bArr, int i) {
    ...
    private boolean A0I(C04774v c04774v, byte[] bArr, int i) {
        if (c04774v.A07() < i) {
            return false;
        }
        ...
        while (c04774v.A07() > 0) {
            switch (this.A06) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    if (!A0H(c04774v, this.A0I.A0l(), 10)) {
                        break;
                    } else {
                        A03();
                        break;
                ...
                case 3:
                    if (!A0H(c04774v, this.A0H.A00, this.A0F ? 7 : 5)) {
                        break;
                    } else {
                        A02();
                        break;
    ...
    public final void A5c(HA ha, LG lg) {
        ...
        if (this.A0K) {
            ...
            this.A0B.A6e(new C04212p().A0y(lg.A04()).A11(A00(60, 15, 103)).A14());
            return;
        }
        this.A0B = new C2034mt();
    }
