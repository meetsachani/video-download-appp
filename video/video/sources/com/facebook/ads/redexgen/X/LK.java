...
public abstract class LK extends AbstractC1336bF {
    ...
    public final C0943Nm A09;
    public final C0963Og A0A;
    public final VI A0B;
    ...
    public final AbstractC1847jd A0R;
    public final NY A0S;
    public final C0931Na A0T;
    public final C1673gi A0U;
    public final C1278aJ A0V;
    public final DZ A0W;
    ...
    public static void A0a() {
        A0c = new byte[]{58, C8077mf.u, 4, 2, C8077mf.u, 60, 108, 103, 106, 121, 125, 96, 97, 80, 122, Byte.MAX_VALUE, C8077mf.G, 28, 10, C8077mf.D, C8077mf.m, C8077mf.r, 9, 13, C8077mf.r, C8077mf.z, C8077mf.A, 126, 116, QC1.w, 121, C8077mf.H, 2, C8077mf.q, 13, C8077mf.m, 49, 6, 1, 2, 10, C8077mf.m, 28, 49, C8077mf.D, C8077mf.m, C8077mf.z, C8077mf.D, 96, 98, Byte.MAX_VALUE, 119, 98, 117, 99, 99, 79, 114, 113, 98, 99, 116, 102, 112, 99, 117, 116, 117, 78, 103, QC1.w, 117, 116, 126, 98, Byte.MAX_VALUE, 98, 122, 115, 107, 109, 126, 113, 108, 115, 126, 107, 118, 112, 113, 70};
    }
    ...
    public LK(C1673gi c1673gi, View$OnClickListenerC0871Kr view$OnClickListenerC0871Kr, int i, boolean z, C0931Na c0931Na, boolean z2, String str, VA va, InterfaceC1214Yh interfaceC1214Yh, C1618fp c1618fp, Y2 y2, AbstractC1847jd abstractC1847jd, DZ dz, VI vi, boolean z3) {
        super(c1673gi, view$OnClickListenerC0871Kr, i, c0931Na, z2, str, va, interfaceC1214Yh, c1618fp, y2, abstractC1847jd.A2A(), abstractC1847jd.A1k(), abstractC1847jd.A13());
        this.A0Y = new AtomicBoolean(true);
        this.A0Z = new AtomicBoolean(false);
        this.A0X = new RunnableC1337bG(this);
        this.A0E = new RunnableC1338bH(this);
        this.A0D = new RunnableC1339bI(this);
        this.A0B = vi;
        this.A0R = abstractC1847jd;
        this.A0A = AbstractC0964Oh.A00(c1673gi.A02());
        this.A0C = interfaceC1214Yh;
        this.A0F = abstractC1847jd.A2E();
        this.A09 = abstractC1847jd.A2C();
        this.A0T = c0931Na;
        this.A0S = abstractC1847jd.A29().A0I();
        this.A0U = c1673gi;
        this.A0a = z;
        this.A0b = z3;
        ...
        this.A0V = AbstractC1283aO.A01(this.A0U, true, this.A0R, this.A0B, this.A0C, EnumC1281aM.A03, AbstractC1280aL.A00(this.A0R));
        YB.A0K(this.A0V);
        this.A01 = -1;
        this.A03 = -16777216;
        this.A0O = A0O();
        ...
        if (this.A0b) {
            ...
            this.A0J.setOnClickListener(AbstractC1377bu.A03(super.A08, A0T(6, 10, 11)));
        } else {
        ...
        this.A0K.setOnClickListener(new View$OnClickListenerC1340bJ(this));
        A0t(8);
        setUpAdReportingInitiateView(abstractC1847jd);
        setUpCreditLineV2(abstractC1847jd);
        this.A08 = this.A0R.A29().A0H().A03();
        if (this.A0R.A10().equals(A0T(60, 14, 21)) && !abstractC1847jd.A1h() && this.A08 > 0) {
            this.A04 = A0Q();
            YB.A0K(this.A04);
        }
    ...
    public void A0W() {
        ...
        } else if (TextUtils.isEmpty(this.A09.A00())) {
        } else {
    ...
    public final void A0k() {
        super.A09.setOnClickListener(AbstractC1377bu.A03(super.A08, A0T(27, 4, 19)));
        this.A0Q.setOnClickListener(AbstractC1377bu.A03(super.A08, A0T(74, 5, 18)));
        this.A0P.setOnClickListener(AbstractC1377bu.A03(super.A08, A0T(16, 11, 125)));
        this.A0W.setOnClickListener(AbstractC1377bu.A03(super.A08, A0T(48, 12, 20)));
        if (this.A04 != null) {
            this.A04.setOnClickListener(AbstractC1377bu.A03(super.A08, A0T(31, 17, 106)));
        }
    }
    ...
    public void setPlaceHolderTextForRewardsConversion(String str) {
        if (this.A04 != null) {
            ...
            textView.setOnClickListener(AbstractC1377bu.A03(super.A08, A0T(31, 17, 106)));
        }
    }

    private void setUpAdReportingInitiateView(AbstractC1847jd abstractC1847jd) {
        if (abstractC1847jd.A2Q() || abstractC1847jd.A2U()) {
    ...
    private void setUpCreditLineV2(AbstractC1847jd abstractC1847jd) {
        if (abstractC1847jd.A2W()) {
            this.A06 = AbstractC1283aO.A02(this.A0U, EnumC1281aM.A03, abstractC1847jd);
            YB.A0K(this.A06);
        } else if (!abstractC1847jd.A2V()) {
        } else {
            this.A05 = AbstractC1283aO.A01(this.A0U, true, this.A0R, this.A0B, this.A0C, EnumC1281aM.A03, EnumC1284aP.A04);
            YB.A0K(this.A05);
        }
    }
}
