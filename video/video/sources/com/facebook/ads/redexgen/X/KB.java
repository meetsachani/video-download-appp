...
public final class KB extends AbstractC1386c3 {
    ...
    public final VI A0O;
    public final C1367bk A0P;
    public final C1369bm A0Q;
    public final C1390c7 A0R;
    ...
    public static void A0R() {
        A0W = new byte[]{-24, C8077mf.D, C3307Iz.a0, 60, 49, 54, 47, -77, -68, -65, -12};
    }
    ...
    public KB(C1390c7 c1390c7) {
        ...
        this.A0U = new E2() { // from class: com.facebook.ads.redexgen.X.6E
            ...
            public final void A03(E3 e3) {
                ...
                if (interfaceC1503dx != null) {
                    ...
                    A01[3] = "L2P2qOlVB";
                    interfaceC1503dx2 = kb.A08;
                    interfaceC1503dx2.AKE();
                }
            }
        };
        this.A0T = new EA() { // from class: com.facebook.ads.redexgen.X.6D
            ...
            public final void A03(C4K c4k) {
                C0710Ek c0710Ek;
                c0710Ek = KB.this.A0S;
                c0710Ek.A0e(EnumC1560et.A02, 20);
            }
        };
        this.A0V = new RunnableC1416cX(this);
        this.A0N = c1390c7.A06();
        this.A0R = c1390c7;
        ...
        YB.A0K(this.A0F);
        AbstractC1374br.A00(this.A0R.A06(), this, this.A0R.A05().A29().A0H().A08());
    ...
    private C1367bk A0D() {
        C1367bk c1367bk = new C1367bk(this.A0N);
        YB.A0N(c1367bk, 0);
        int i = (int) (this.A00 * 0.13f);
        new LM(c1367bk, this.A0N).A05(i, i).A07(this.A0R.A05().A2C().A01());
        return c1367bk;
    }

    private C1369bm A0E() {
        C1369bm c1369bm = new C1369bm(this.A0N, A0Y, 5, 0, -1);
        c1369bm.setRating(getRating());
        return c1369bm;
    }

    private C0710Ek A0G() {
        C0710Ek c0710Ek = new C0710Ek(this.A0R.A06());
        this.A0A = new C4L(this.A0N, getAdEventManager(), c0710Ek, this.A0R.A05().A2E(), 0, 0, true, null, null);
        if (C1123Up.A20(this.A0N)) {
            this.A09 = new C0720Eu(this.A0N, getAdEventManager(), c0710Ek, this.A0R.A05().A2E(), false, this.A0A, null);
        } else {
            String[] strArr = A0X;
            if (strArr[2].length() == strArr[4].length()) {
                throw new RuntimeException();
        ...
        c0710Ek.setRoundedCornerVideoView(44.0f);
        return c0710Ek;
    }

    private void A0K() {
        this.A0F.setOnClickListener(new View$OnClickListenerC1418cZ(this));
        if (this.A0R.A05().A1p()) {
            this.A0M.setOnClickListener(new View$OnClickListenerC1419ca(this));
        } else {
            this.A0H.setOnClickListener(new View$OnClickListenerC1420cb(this));
        }
    }

    private void A0L() {
        if (this.A0R.A05().A2M()) {
            this.A06 = A00(this.A0N, this.A0R.A05(), this.A0O, EnumC1281aM.A06, this.A0R.A0C());
            YB.A0K(this.A06);
        } else if (!this.A0R.A05().A1p()) {
        } else {
            this.A05 = AbstractC0964Oh.A00(this.A0N.A02());
            this.A04 = A03();
            YB.A0K(this.A04);
            A0O();
        }
    ...
    private void A0M() {
        if (this.A0R.A05().A2W()) {
            this.A07 = A01(this.A0N, EnumC1281aM.A06);
            YB.A0K(this.A07);
        }
    }
    ...
    private void A0O() {
        if (this.A04 != null) {
            this.A04.setOnClickListener(new View$OnClickListenerC1417cY(this));
        }
        A0T(8);
    }
