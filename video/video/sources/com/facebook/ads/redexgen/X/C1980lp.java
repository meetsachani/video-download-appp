...
public class C1980lp<V> extends AbstractCollection<V> {
    ...
    public C1980lp(@ParametricNullness final C2L this$0, @CheckForNull Object key, Collection delegate, C1980lp ancestor) {
        this.A04 = this$0;
        this.A02 = key;
        this.A00 = delegate;
        this.A01 = ancestor;
    ...
    public final boolean remove(@CheckForNull Object o2) {
        A04();
        boolean remove = this.A00.remove(o2);
        if (remove) {
            C2L.A01(this.A04);
            A05();
        }
