...
public abstract class BR<E> extends AbstractC2124oN<E> {
    ...
    public BR(int initialCapacity) {
        AbstractC2059nJ.A00(initialCapacity, A00(0, 15, 58));
    ...
    private void A02(int newElements) {
        ...
        int newCapacity = AbstractC2124oN.A03(objArr.length, this.A00 + newElements);
