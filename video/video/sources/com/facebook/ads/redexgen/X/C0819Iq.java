...
public final class C0819Iq {
    ...
    public static void A03() {
        A03 = new byte[]{79, 110, C3307Iz.V, 119, 96, 109, 104, 101, C3307Iz.V, 119, 96, 115, 104, 111, 117, C3307Iz.V, 109, 100, 111, 102, 117, 105, C3307Iz.V, 108, 96, 114, 106, C3307Iz.V, 103, 110, 116, 111, 101};
    }
    ...
    */
    public static int A00(int i) {
        for (int i2 = 0; i2 < varIntLength; i2++) {
            int varIntLength = ((A05[i2] & i) > 0L ? 1 : ((A05[i2] & i) == 0L ? 0 : -1));
            if (varIntLength != 0) {
                return i2 + 1;
            }
        }
    ...
    public final long A05(InterfaceC2033ms interfaceC2033ms, boolean z, boolean z2, int i) throws IOException {
        if (this.A01 == 0) {
            if (!interfaceC2033ms.AHR(this.A02, 0, 1, z)) {
                return -1L;
            }
        ...
        if (this.A00 != 1) {
            interfaceC2033ms.readFully(this.A02, 1, this.A00 - 1);
        }
        this.A01 = 0;
