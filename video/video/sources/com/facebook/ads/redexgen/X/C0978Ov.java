...
public final class C0978Ov extends Drawable {
    ...
    public C0978Ov(ColorStateList colorStateList, float f) {
        this.A01 = f;
        A01(colorStateList);
        this.A0A = new RectF();
        this.A09 = new Rect();
    ...
    private void A02(Rect rect) {
        ...
        this.A09.set(rect);
        if (this.A06) {
            float A01 = AbstractC0980Ox.A01(this.A00, this.A01, this.A07);
            float vInset = AbstractC0980Ox.A00(this.A00, this.A01, this.A07);
