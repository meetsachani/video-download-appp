...
public final class C3L extends ED implements View.OnClickListener {
    ...
    public final E2 A02;
    public final E0 A03;
    public final C1585fI A04;

    public C3L(C1673gi c1673gi) {
        this(c1673gi, null);
    }

    public C3L(C1673gi c1673gi, AttributeSet attributeSet) {
        this(c1673gi, attributeSet, 0);
    }

    public C3L(C1673gi c1673gi, AttributeSet attributeSet, int i) {
    ...
    public final void onClick(View view) {
        ...
        try {
            C0710Ek videoView = getVideoView();
            if (videoView == null) {
                return;
            }
            if (videoView.getState() == EnumC1615fm.A07 || videoView.getState() == EnumC1615fm.A05 || videoView.getState() == EnumC1615fm.A06) {
                videoView.A0e(EnumC1560et.A04, 11);
            } else if (videoView.getState() == EnumC1615fm.A0A) {
