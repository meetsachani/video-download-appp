, 35, 107, 108, 111, 103, 102, 113, C3307Iz.e0, 35, 90, 108, 118, 35, 112, 107, 108, 118, 111, 103, 35, 101, 106, 113, 112, 119, 35, 96, 98, 111, 111, 35, 112, 119, 108, 115, 74, 100, 109, 108, 113, 106, 109, 100, 85, 106, 102, 116, C3307Iz.c0, 117, 106, 102, 116, 42, 35, 97, 102, 101, 108, 113, 102, 35, 96, 98, 111, 111, 106, 109, 100, 35, 113, 102, 96, 122, 96, 111, 102, C3307Iz.e0, 48, 50, 35, 1, 62, 50, 32, 17, 56, C3307Iz.X, 7, 56, 36, 62, 35, 62, 56, 57, C8077mf.z, 57, 51, 3, C3307Iz.f0, C3307Iz.Z, 50, C8077mf.G, C8077mf.r, 8, C8077mf.H, 4, 5, 81, C8077mf.B, 31, C8077mf.y, C8077mf.x, 9, 81, 2, C8077mf.C, C8077mf.H, 4, C8077mf.G, C8077mf.y, 81, 31, C8077mf.H, 5, 81, 19, C8077mf.x, 81, 92, 64, 81, C8077mf.r, C8077mf.A, 5, C8077mf.x, 3, 81, 4, 31, C8077mf.C, C8077mf.B, C8077mf.y, C8077mf.B, 31, C8077mf.z, 81, C8077mf.r, 81, 7, C8077mf.B, C8077mf.x, 6, 75, 69, 68, 124, 67, 79, 93, QC1.w, 79, 73, 83, 73, 70, 79, 78};
    }
        ...
        if (this.A08.A04.A0M() && (A04 = this.A08.A00.A04(i)) > 0) {
            ...
            if (A04 < offsetPosition) {
                ...
                for (int i4 = 0; i4 < size; i4++) {
                    ...
                    if (!rk2.A0m()) {
                        int offsetPosition2 = (rk2.A0Q() > A0D ? 1 : (rk2.A0Q() == A0D ? 0 : -1));
    ...
    private final RK A03(long j, int i, boolean z) {
        ...
        for (int i2 = count - 1; i2 >= 0; i2--) {
            RK rk = this.A05.get(i2);
            int count2 = (rk.A0Q() > j ? 1 : (rk.A0Q() == j ? 0 : -1));
            if (count2 == 0 && !rk.A0m()) {
                int count3 = rk.A0N();
                if (i == count3) {
                    rk.A0Z(32);
        ...
        for (int i5 = count6 - 1; i5 >= 0; i5--) {
            ...
            int count7 = (rk2.A0Q() > j ? 1 : (rk2.A0Q() == j ? 0 : -1));
            if (count7 == 0) {
                int count8 = rk2.A0N();
                if (i == count8) {
                    if (!z) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:102:0x0261, code lost:
        r5 = (com.facebook.ads.redexgen.X.R3) r5;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:98:0x0244, code lost:
        r5 = (com.facebook.ads.redexgen.X.R3) r22.A08.generateLayoutParams(r5);
    ...
    */
        ...
        if (i >= 0 && i < this.A08.A0s.A03()) {
            ...
            if (rk == null) {
                ...
                if (A04 < 0 || A04 >= this.A08.A04.A0B()) {
                    throw new IndexOutOfBoundsException(A04(C10997yd1.v1, 46, 55) + i + A04(13, 8, 116) + A04 + A04(35, 8, 108) + this.A08.A0s.A03() + this.A08.A1J());
                }
            ...
            if (z2 && !this.A08.A0s.A07() && rk.A0o(8192)) {
                rk.A0a(0, 8192);
                if (this.A08.A0s.A0C) {
                    int changeFlags = AbstractC1029Qy.A06(rk);
                    C1028Qx info = this.A08.A05.A0F(this.A08.A0s, rk, changeFlags | 4096, rk.A0R());
            ...
            if (this.A08.A0s.A07() && rk.A0e()) {
                ...
                z4 = A0D(rk, this.A08.A00.A04(i), i, j);
            }
    ...
    public final void A0U(AbstractC1021Qq abstractC1021Qq, AbstractC1021Qq abstractC1021Qq2, boolean z) {
        A0P();
        A0H().A08(abstractC1021Qq, abstractC1021Qq2, z);
    }
    ...
    public final void A0V(R9 r9) {
        ...
        if (r9 != null) {
            R9 r92 = this.A01;
            AbstractC1021Qq adapter = this.A08.getAdapter();
            String[] strArr = A0A;
            if (strArr[2].length() != strArr[6].length()) {
                throw new RuntimeException();
            }
