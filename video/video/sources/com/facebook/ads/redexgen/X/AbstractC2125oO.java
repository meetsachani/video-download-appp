...
public abstract class AbstractC2125oO<E> extends AbstractCollection<E> implements Serializable {
    ...
    public static void A0F() {
        A00 = new byte[]{-7, C8077mf.A, 9, -60, -9, 9, C8077mf.z, 13, 5, C8077mf.r, 13, C8077mf.H, 9, 8, -22, 19, C8077mf.z, 17};
    }
    ...
    public final <T> T[] toArray(T[] other) {
        AbstractC1912ki.A04(other);
        int size = size();
        if (other.length < size) {
            Object[] A0L = A0L();
            if (A0L != null) {
                return (T[]) AbstractC2245qN.A02(A0L, A0H(), A0G(), other);
            }
            other = (T[]) AbstractC2240qG.A05(other, size);
