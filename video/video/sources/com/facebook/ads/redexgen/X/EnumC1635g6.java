...
public enum EnumC1635g6 {
    ...
    public static void A01() {
        A02 = new byte[]{C3307Iz.Z, C3307Iz.X, 52, 86, 73, 85, 82};
    }
    ...
    EnumC1635g6(boolean z, boolean z2) {
        this.A00 = z;
        this.A01 = z2;
    }
    ...
    public static EnumC1635g6[] valuesCustom() {
        EnumC1635g6[] valuesCustom = values();
        if (A03[7].charAt(2) != 'p') {
            throw new RuntimeException();
        }
        A03[7] = "eYpi2UA0ZlC7PiDY55aF0B4EyL2494ge";
        return (EnumC1635g6[]) valuesCustom.clone();
    }
}
