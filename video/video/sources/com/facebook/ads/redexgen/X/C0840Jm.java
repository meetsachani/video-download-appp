...
public final class C0840Jm {
    ...
    private SpannableString A04() {
        ...
        for (int length = 0; length < this.A06.size(); length++) {
            C0839Jl c0839Jl = this.A06.get(length);
            boolean z = c0839Jl.A02;
            int i3 = c0839Jl.A01;
            if (i3 != 8) {
                style = i3 == 7 ? 1 : 0;
                if (i3 != 7) {
    ...
    */
    public final C2192pT A08(int i) {
        float f;
        int line;
        ...
        return new C04443o().A0G(spannableStringBuilder).A0F(Layout.Alignment.ALIGN_NORMAL).A07(line, 1).A04(f).A0A(i).A0H();
    }
    ...
    public final void A09() {
        ...
        if (length > 0) {
            ...
            for (int i = length3 - 1; i >= 0; i--) {
                C0839Jl c0839Jl = this.A06.get(i);
                String[] strArr = A08;
                String str = strArr[2];
                ...
                int length5 = c0839Jl.A00;
                if (length5 == length) {
                    int length6 = c0839Jl.A00;
                    c0839Jl.A00 = length6 - 1;
                } else {
                    return;
                }
            }
    ...
    */
    ...
    public final void A0F(int i, boolean z) {
        this.A06.add(new C0839Jl(i, z, this.A05.length()));
    }
