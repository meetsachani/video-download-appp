...
public final class C1220Yn extends AdNativeComponentView {
    ...
    public C1220Yn(C1673gi c1673gi, C1137Vd c1137Vd) {
        super(c1673gi);
        this.A06 = c1137Vd;
        this.A05 = new TextView(c1673gi);
        this.A04 = new TextView(c1673gi);
        this.A03 = new TextView(c1673gi);
        this.A02 = new RelativeLayout(c1673gi);
        this.A00 = new LinearLayout(c1673gi);
        this.A01 = new RelativeLayout(c1673gi);
        this.A07 = new MR(c1673gi);
        A09();
        A0D();
        A05();
        A0A();
    ...
    private void A04() {
        ...
        GradientDrawable shape = new GradientDrawable(GradientDrawable.Orientation.BOTTOM_TOP, new int[]{com.facebook.internal.q0.s1, 0});
    ...
    public final void onMeasure(int i, int i2) {
        int A0F2 = ((int) XX.A02) * C1123Up.A0F(getContext());
