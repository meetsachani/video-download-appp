...
public abstract class CC implements InterfaceC1913kj<Character> {
    ...
    public static void A07() {
        A00 = new byte[]{-80, -79, -78, -77, -76, -75, -74, -73, -72, -71, C2638Cg0.p7, C2638Cg0.q7, C2638Cg0.r7, -60, C2638Cg0.s7, C2638Cg0.t7};
    }
    ...
    public static C1C A02(final char match) {
        return new C2S(match) { // from class: com.facebook.ads.redexgen.X.1C
            ...
            public static void A01() {
                byte[] bArr = {55, 57, C8077mf.C, 50, 59, 40, C8077mf.A, 59, C3307Iz.f0, 57, 50, ED2.a, 40, 116, 51, C3307Iz.a0, 114, 125};
                if (A02[1].length() == 27) {
                    throw new RuntimeException();
                }
                String[] strArr = A02;
