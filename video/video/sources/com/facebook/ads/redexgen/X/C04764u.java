...
public final class C04764u {
    ...
    public C04764u(byte[] bArr) {
        this(bArr, bArr.length);
    }

    public C04764u(byte[] bArr, int i) {
        this.A00 = bArr;
        this.A02 = i;
    }

    private void A00() {
        AbstractC04543y.A08(this.A03 >= 0 && (this.A03 < this.A02 || (this.A03 == this.A02 && this.A01 == 0)));
    }
    ...
    public final void A0C(C04774v c04774v) {
        A0E(c04774v.A0l(), c04774v.A0A());
        A08(c04774v.A09() * 8);
    }
