...
public final class View$OnSystemUiVisibilityChangeListenerC1204Xx implements View.OnSystemUiVisibilityChangeListener {
    ...
    public EnumC1203Xw A02 = EnumC1203Xw.A02;
    public final Runnable A04 = new QB(this);

    public View$OnSystemUiVisibilityChangeListenerC1204Xx(View view) {
        this.A03 = view;
    ...
    public void A02(boolean z) {
        if (EnumC1203Xw.A02.equals(this.A02)) {
            return;
        }
        int i = 3840;
        if (!z) {
    ...
    public final void A05(EnumC1203Xw enumC1203Xw) {
        this.A02 = enumC1203Xw;
        switch (this.A02.ordinal()) {
            case 1:
                A00(67108864, true);
                A00(C10323vs.Q0, true);
                A02(false);
                return;
            default:
                A00(67108864, false);
                A00(C10323vs.Q0, false);
