...
public final class C6H extends AbstractC0854Ka {
    ...
    public C1673gi A03;
    public XO A04;
    public AbstractC1208Yb A05;
    public AbstractC1386c3 A06;
    public C1402cJ A07;
    public C1528eM A08;
    public C1534eS A09;
    public DA A0A;
    ...
    public final InterfaceC1214Yh A0E;
    public final InterfaceC1364bh A0F;
    public final C1365bi A0G;
    public final C1390c7 A0H;
    public final C0710Ek A0I;
    public final DZ A0J;
    ...
    public static void A0D() {
        A0K = new byte[]{-23, -117, 1, -6, C8077mf.q, -2, C8077mf.B, C8077mf.n, 13, -6, C8077mf.m, 13, 2, 7, 0, C8077mf.B, -6, 7, 2, 6, -6, 13, 2, 8, 7, C8077mf.n, C8077mf.B, 9, 5, -6, C8077mf.u, -2, -3, C8077mf.D, C8077mf.G, C3307Iz.V, 19, C3307Iz.e0, 32, 19, C3307Iz.X, C8077mf.q, 32, C8077mf.u, C3307Iz.e0, C3307Iz.V, 17, 32, 19, 19, 28, C3307Iz.e0, C3307Iz.V, C8077mf.z, C8077mf.G, C3307Iz.X, 28, -7, -29, -11, 1, -25, -16, -26, 1, -27, -29, -12, -26, 1, -11, -22, -15, -7, -16, -17, -19, -33, -20, -35, -26, -29, -35, -27};
    }
    ...
    public C6H(C1390c7 c1390c7) {
        super(c1390c7, false);
        this.A0D = new Handler(Looper.getMainLooper());
        this.A0C = false;
        this.A0B = false;
        this.A03 = c1390c7.A06();
        this.A05 = c1390c7.A0B();
        this.A0H = c1390c7;
        ...
        A0A();
        this.A0E = c1390c7.A0C();
        AbstractC1374br.A00(c1390c7.A06(), this, getAdInfo().A0H().A08());
        this.A0I = A02(c1390c7);
        YB.A0K(this.A0I);
        getAdDetailsView().bringToFront();
        if (!A04()) {
            this.A0J = A03(c1390c7);
        } else {
            this.A0J = null;
        }
        ...
        A1S();
        this.A08 = new C1528eM(this.A03, c1390c7.A07(), getAdDataBundle());
        this.A0F = new KW(this);
        this.A0G = A01(c1390c7);
        XR A02 = super.A08.A02(getAdDataBundle());
        this.A03.A0H().A00(A02.A01);
        getCtaButton().setCreativeAsCtaLoggingHelper(super.A08);
        if (A02.A00) {
            this.A0I.getVideoImplView().setOnClickListener(new View$OnClickListenerC1393cA(this));
        } else if (C1123Up.A1L(getAdContextWrapper())) {
            AbstractC1333bC.A00(this.A0I.getVideoImplView(), C1123Up.A1M(getAdContextWrapper()), new View$OnClickListenerC1394cB(this));
        }
        if (c1390c7.A05().A1o()) {
            if (this.A0H.A05().A1r()) {
                this.A06 = new KB(c1390c7);
            } else {
                this.A06 = new KD(c1390c7);
            }
            View view = this.A06;
    ...
    private C1365bi A01(C1390c7 c1390c7) {
        if (this.A0J != null) {
            return new C1365bi(c1390c7, getAdDataBundle(), this.A0I, this.A0J, getAdDetailsView(), this.A0E, this.A0F);
        }
        return new C1365bi(c1390c7, getAdDataBundle(), this.A0I, this.A0E, this.A0F, getAdDetailsView());
    }

    private C0710Ek A02(C1390c7 c1390c7) {
        RelativeLayout.LayoutParams layoutParams;
        C0710Ek c0710Ek = (C0710Ek) c1390c7.A02();
        if (c0710Ek == null) {
            c0710Ek = new C0710Ek(this.A03);
        }
        RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -1);
        if (getAdDataBundle().A1u()) {
            c0710Ek.getVideoView().setPadding(c0710Ek.getVideoView().getPaddingLeft(), c0710Ek.getVideoView().getPaddingTop(), c0710Ek.getVideoView().getPaddingRight(), c0710Ek.getVideoView().getPaddingBottom() + A0Y);
        }
        layoutParams2.addRule(13);
        addView(c0710Ek, layoutParams2);
        int A1Q = A1Q(c1390c7.A0B());
        this.A02 = (ImageView) c1390c7.A03();
        if (this.A02 != null) {
            if (!A04()) {
                ImageView imageView = this.A02;
                int i = AbstractC0854Ka.A0J;
                int toolbarHeight = AbstractC0854Ka.A0J;
                imageView.setPadding(i, toolbarHeight, AbstractC0854Ka.A0J, AbstractC0854Ka.A0J);
                layoutParams = new RelativeLayout.LayoutParams(AbstractC0854Ka.A0K, AbstractC0854Ka.A0K);
                layoutParams.setMargins(0, A1Q, AbstractC0854Ka.A0I, 0);
                layoutParams.addRule(11);
            } else {
                layoutParams = new RelativeLayout.LayoutParams(AbstractC1386c3.A0A, AbstractC1386c3.A0A);
                int i2 = XV.A0b;
            ...
            c0710Ek.addView(this.A02, layoutParams);
        }
        return c0710Ek;
    }

    private DZ A03(C1390c7 c1390c7) {
        DZ A0E = c1390c7.A0E();
        if (A0E == null) {
            return null;
        }
        A0E.A08(-1, AbstractC0854Ka.A0C, false);
        A0E.setPadding(AbstractC0854Ka.A0N, AbstractC0854Ka.A0N, AbstractC0854Ka.A0N, AbstractC0854Ka.A0N);
        RelativeLayout.LayoutParams progressBarLayoutParams = new RelativeLayout.LayoutParams(-1, AbstractC0854Ka.A0M);
    ...
    private void A06() {
        this.A07 = new C1402cJ(this.A0H.A06(), getAdDataBundle(), this.A0H.A08(), this.A0D, this.A0H.A0C());
        addView(this.A07.A0C(getCtaButton()));
    }

    private void A07() {
        YB.A0d(this.A02, getCtaButton(), getAdDetailsView(), this.A01, this.A0G, this.A0H.A0B());
        for (InterfaceC1561eu interfaceC1561eu : this.A0I.getPlugins()) {
            if (interfaceC1561eu instanceof AnonymousClass34) {
                this.A0I.A0g(interfaceC1561eu);
                return;
            }
        }
    }
    ...
    private void A09() {
        ...
        View$OnClickListenerC0871Kr ctaButton = getCtaButton();
    ...
    private void A0B() {
        ...
        YB.A0L(this.A05);
        Pair<EnumC1527eL, View> A03 = this.A08.A03(getCtaButton());
        this.A00 = (View) A03.second;
        A0F((EnumC1527eL) A03.first);
    ...
    private void A0E(RelativeLayout relativeLayout) {
        ...
        layoutParams.addRule(9);
        C1367bk c1367bk = new C1367bk(this.A03);
        YB.A0N(c1367bk, 0);
        YB.A0K(c1367bk);
        new LM(c1367bk, this.A03).A05(A0Q, A0Q).A07(getAdDataBundle().A2C().A01());
        ...
        C1369bm c1369bm = new C1369bm(c1673gi, i, 5, A0V, -1);
        ...
        linearLayout.addView(c1369bm, ratingCountParams);
        ...
        iconParams.addRule(1, c1367bk.getId());
        ...
        relativeLayout.addView(c1367bk, layoutParams);
        if (TextUtils.isEmpty(getAdDataBundle().A29().A0I().A0C())) {
            linearLayout.setVisibility(8);
            return;
        }
        linearLayout.setVisibility(0);
        c1369bm.setRating(Float.parseFloat(getAdDataBundle().A29().A0I().A0C()));
        ...
        if (!getAdDataBundle().A1s()) {
            ...
            formattingRatingCount = AbstractC1187Xg.A01(Integer.parseInt(getAdDataBundle().A29().A0I().A09()));
        }
    ...
    private void A0F(EnumC1527eL enumC1527eL) {
        if (!getAdDataBundle().A29().A0K().A02().isEmpty()) {
            if (getAdDataBundle().A29().A0K().A03()) {
                this.A09 = new C1534eS(this.A03, getAdDataBundle(), this.A0E, getCtaButton(), this.A0D, this.A0H.A08());
    ...
    private void A0G(EnumC1527eL enumC1527eL) {
        if (this.A00 == null) {
            return;
        }
        this.A0I.A0h(false);
        ...
        switch (enumC1527eL) {
            ...
            case A02:
                ...
                RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -1);
                layoutParams2.setMargins(AbstractC0854Ka.A0L, AbstractC0854Ka.A0L, AbstractC0854Ka.A0L, AbstractC0854Ka.A0L);
    ...
    public final void A1I(C4K c4k) {
        super.A1I(c4k);
        if (A04()) {
            AbstractC1847jd adDataBundle = getAdDataBundle();
    ...
    public final void A1J(E1 e1) {
        ...
        if (A04()) {
            this.A03.A0F().AKh(XL.A00((float) this.A0H.A05().A0k()), getResources().getConfiguration().orientation, true, false, AbstractC0925Mt.A0C(this.A0H.A04()));
        }
    ...
    public final AbstractC1336bF A1R(C1390c7 c1390c7, NR nr, String str) {
        double A0k = c1390c7.A05().A0k();
        if (A04()) {
            return new C1375bs((float) A0k, str, c1390c7.A06(), getColors(), c1390c7.A05(), c1390c7.A0C(), getCtaButton(), AbstractC0854Ka.A0G, false, c1390c7.A07(), c1390c7.A0F(), c1390c7.A0A(), c1390c7.A0E(), c1390c7.A08(), false).A03();
        }
        return new C0857Kd(c1390c7.A06(), getCtaButton(), AbstractC0854Ka.A0H, nr.A0I().A00() == NW.A05, getColors(), nr.A0J().A06(), str, c1390c7.A07(), c1390c7.A0C(), c1390c7.A0F(), c1390c7.A0A(), c1390c7.A05());
    }
    ...
    public final void A1Z() {
        ...
        if (this.A0H.A0B() != null) {
            AbstractC1208Yb A0B = this.A0H.A0B();
            if (A0L[4].charAt(31) == 'A') {
                throw new RuntimeException();
            }
    ...
    public final void A1b(C4L c4l) {
        if (this.A06 != null) {
            ...
            this.A06.A1C();
            AbstractC1386c3 abstractC1386c3 = this.A06;
            String[] strArr = A0L;
            if (strArr[3].charAt(21) == strArr[6].charAt(21)) {
                throw new RuntimeException();
            }
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC0854Ka, com.facebook.ads.redexgen.X.AbstractC1386c3, android.view.View
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        if (this.A06 != null) {
            ...
            if (abstractC1386c3.getVisibility() == 0) {
                getAdDetailsView().setVisibility(8);
                return;
            }
        }
    ...
    public void setVideoAdViewListener(InterfaceC1503dx interfaceC1503dx) {
        if (this.A06 instanceof KB) {
            ((KB) this.A06).setVideoAdViewListener(interfaceC1503dx);
        }
        if (this.A06 instanceof KD) {
            ((KD) this.A06).setVideoAdViewListener(interfaceC1503dx);
        }
    }
}
