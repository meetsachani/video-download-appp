...
public final class S6 implements NativeAdsManagerApi {
    ...
    public final void loadAds(NativeAdBase.MediaCacheFlag mediaCacheFlag) {
        EnumC1148Vq enumC1148Vq = EnumC1148Vq.A06;
        int i = this.A07;
        C1804iu c1804iu = this.A03;
        this.A03 = new C1804iu(this.A08, this.A09, enumC1148Vq, null, i);
        if (this.A06) {
            this.A03.A06();
        }
        this.A03.A09(this.A04);
        this.A03.A08(new C1696h5(this, this.A08, mediaCacheFlag, this.A01));
        this.A03.A07();
    }
