...
public final class C1326b5 extends FrameLayout {
    public int A00;
    public int A01;
    public final ImageView A02;
    public final ImageView A03;

    public C1326b5(C1673gi c1673gi) {
        super(c1673gi);
        this.A03 = new ImageView(c1673gi);
        this.A02 = new ImageView(c1673gi);
        A00();
    }

    public C1326b5(C1673gi c1673gi, AttributeSet attributeSet) {
        super(c1673gi, attributeSet);
        this.A03 = new ImageView(c1673gi, attributeSet);
        this.A02 = new ImageView(c1673gi, attributeSet);
        A00();
    }

    public C1326b5(C1673gi c1673gi, AttributeSet attributeSet, int i) {
        super(c1673gi, attributeSet, i);
        this.A03 = new ImageView(c1673gi, attributeSet, i);
        this.A02 = new ImageView(c1673gi, attributeSet, i);
        A00();
    }

    public C1326b5(C1673gi c1673gi, AttributeSet attributeSet, int i, int i2) {
        super(c1673gi, attributeSet, i, i2);
        this.A03 = new ImageView(c1673gi, attributeSet, i, i2);
        this.A02 = new ImageView(c1673gi, attributeSet, i, i2);
        A00();
    }
