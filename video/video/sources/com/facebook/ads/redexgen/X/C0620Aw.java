...
public class C0620Aw<E> extends AbstractC2263qh<E> {
    public final /* synthetic */ Set A00;
    public final /* synthetic */ Set A01;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0620Aw(final Set val$set1, final Set val$set2) {
        super(null);
        this.A00 = val$set1;
        this.A01 = val$set2;
    }
    ...
    public final C4C<E> iterator() {
        return new AbstractC0645Bv<E>() { // from class: com.facebook.ads.redexgen.X.27
            public final Iterator<E> A00;

            {
                this.A00 = C0620Aw.this.A00.iterator();
            }
            ...
            public final E A02() {
                while (this.A00.hasNext()) {
                    ...
                    if (C0620Aw.this.A01.contains(next)) {
                        return next;
                    }
                }
                E e = A01();
