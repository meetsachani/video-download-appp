...
public abstract class LI {
    ...
    public static long A01(C04774v c04774v, int i, int i2) {
        c04774v.A0f(i);
        if (c04774v.A07() < 5) {
            return C10323vs.b;
        }
        ...
        int tsPacketHeader5 = c04774v.A0I();
        if (tsPacketHeader5 >= 7) {
            int tsPacketHeader6 = c04774v.A07();
            if (tsPacketHeader6 >= 7) {
                int tsPacketHeader7 = c04774v.A0I();
                if ((tsPacketHeader7 & 16) == 16) {
                    byte[] bArr = new byte[6];
                    int tsPacketHeader8 = bArr.length;
                    c04774v.A0k(bArr, 0, tsPacketHeader8);
                    long A02 = A02(bArr);
                    String[] strArr = A00;
                    String str = strArr[4];
