...
public abstract class OS {
    ...
    public static void A03() {
        byte[] bArr = {99, 102, 93, 103, 122, 114, 103, 112, 107, 103, 108, 97, 103, 93, 97, 109, 108, 100, 107, 101, 93, 107, 108, 118, 103, 112, 113, 118, 107, 118, 107, 99, 110, 32, C3307Iz.X, C8077mf.H, 36, 57, 49, 36, 51, 40, 36, 47, 34, 36, C8077mf.H, 34, C3307Iz.f0, 47, C3307Iz.Z, 40, C3307Iz.Y, C8077mf.H, 51, 36, 54, 32, 51, C3307Iz.X, 36, C3307Iz.X, C8077mf.H, 40, 47, 53, 36, 51, 50, 53, 40, 53, 40, 32, C3307Iz.e0};
        String[] strArr = A01;
        if (strArr[0].length() != strArr[2].length()) {
            throw new RuntimeException();
        }
