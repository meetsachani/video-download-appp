...
public final class C0856Kc extends AbstractC1386c3 implements XQ {
    ...
    public C0856Kc(C1390c7 c1390c7) {
        super(c1390c7, true);
        this.A04 = new Handler(Looper.getMainLooper());
        this.A0D = false;
        this.A0C = new AtomicBoolean(false);
        this.A03 = true;
        this.A0A = c1390c7.A0C();
        this.A09 = c1390c7.A0B();
        this.A08 = c1390c7.A05();
        this.A0E = XS.A00(c1390c7.A06(), this.A08, this);
        this.A07 = new RelativeLayout(c1390c7.A06());
        this.A0B = A00(c1390c7, this.A08.A29(), this.A08.A0w());
        this.A06 = new RelativeLayout(c1390c7.A06());
        YB.A0K(this.A06);
        YB.A0K(this.A07);
        this.A05 = c1390c7.A02();
        A04();
        this.A07.addView(this.A06, new RelativeLayout.LayoutParams(-2, -2));
        addView(this.A07, new RelativeLayout.LayoutParams(-1, -1));
        AbstractC1374br.A00(c1390c7.A06(), this.A07, this.A08.A29().A0H().A08());
        this.A0B.setInfo(this.A08.A29().A0I(), this.A08.A29().A0J(), this.A08.A2E(), this.A08.A2C().A01(), null, null);
        A03();
        super.A07.A06().A0F().AKh(XL.A00(this.A00), getResources().getConfiguration().orientation, false, true, AbstractC0925Mt.A0C(super.A07.A04()));
    }

    private LK A00(C1390c7 c1390c7, NR nr, String str) {
        this.A00 = new C1079Sx(c1390c7.A06()).A0M(nr.A0H().A08());
        LK adDetailsView = new C1375bs(this.A00, str, c1390c7.A06(), getColors(), c1390c7.A05(), c1390c7.A0C(), getCtaButton(), A0G, false, c1390c7.A07(), c1390c7.A0F(), c1390c7.A0A(), c1390c7.A0E(), c1390c7.A08(), false).A03();
        if (c1390c7.A0G() != null) {
            adDetailsView.setChainedAdInfo(c1390c7.A0G());
        }
        return adDetailsView;
    }

    private void A01() {
        this.A01 = new C1402cJ(super.A07.A06(), this.A08, super.A07.A08(), this.A04, super.A07.A0C());
        this.A01.A0I(false);
    ...
    private void A02() {
        ...
        if (!this.A08.A29().A0K().A02().isEmpty()) {
            this.A02 = new C1534eS(super.A07.A06(), this.A08, this.A0A, getCtaButton(), this.A04, super.A07.A08());
            this.A02.A0f(false);
    ...
    private void A04() {
        ...
        if (A02.A00) {
            this.A05.setOnClickListener(new View$OnClickListenerC1378bv(this));
        } else if (!C1123Up.A1J(getAdContextWrapper())) {
        } else {
            AbstractC1333bC.A00(this.A05, C1123Up.A1K(getAdContextWrapper()), new View$OnClickListenerC1379bw(this));
        }
    }
    ...
    public final void A1Q() {
        ...
        if (super.A07.A0D() != null) {
            ...
            if (this.A09 != null && this.A08.A29().A0K().A00() > 0) {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new RunnableC1380bx(this), this.A08.A29().A0K().A00());
            }
        }
    }
