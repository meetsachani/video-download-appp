...
public abstract class AbstractC1977lm<T> implements Iterator<T> {
    ...
    public AbstractC1977lm(final C2L this$0) {
        Map map;
        this.A04 = this$0;
        map = this$0.A01;
    ...
    public final T next() {
        ...
        return A00(AbstractC2239qF.A01(this.A00), this.A02.next());
    }
