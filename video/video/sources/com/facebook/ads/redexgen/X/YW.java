...
public final class YW {
    ...
    public static void A02() {
        A00 = new byte[]{79, 119, 122, 71, 92, 90, 79, 75, 86, 80, 81, 31, 86, 81, 31, 72, 86, 81, 91, 80, 72, 31, 86, 81, 89, 80, 31, 92, 87, 90, 92, 84, 98, 108, 112, 110, 124, 104, 123, 109, 91, 87, 66, C8077mf.q, C8077mf.x, C8077mf.p, C8077mf.z, 4, 96, 113, 115, 124, 112, 117, 100, 113, 117, 110, 96, 99};
    }
    ...
    public static Map<String, String> A01(@Nullable C1673gi c1673gi) {
        Window window;
        ...
        try {
            hashMap.put(A00(40, 3, 0), String.valueOf(A04(c1673gi)));
            ...
            InterfaceC1084Tc A08 = c1673gi.A08();
            int type3 = AbstractC1085Td.A2T;
            A08.ABC(A00(43, 5, 77), type3, new C1086Te(e));
        }
        return hashMap;
    }

    public static boolean A03(C1673gi c1673gi) {
        return !YC.A04(A01(c1673gi));
    }

    public static boolean A04(C1673gi c1673gi) {
        KeyguardManager keyguardManager = (KeyguardManager) c1673gi.getSystemService(A00(32, 8, 57));
