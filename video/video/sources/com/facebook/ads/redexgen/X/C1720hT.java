...
public final class C1720hT extends C1043Rm implements AdOptionsViewApi, InterfaceC1279aK {
    ...
    public C1720hT(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView.Orientation orientation, int i, AdOptionsView adOptionsView) {
        this.A05 = false;
        this.A04 = false;
        this.A03 = false;
        ...
        this.A0A.A1e(this);
        C1864ju A12 = this.A0A.A12();
        if (A12 != null && A12.A0R() && !A12.A0P()) {
            this.A07.setVisibility(8);
            return;
        }
        EnumC1183Xc.A04(this.A08, EnumC1183Xc.A0C);
        if (A0C()) {
            A05();
            return;
        }
    ...
    public C1720hT(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView adOptionsView) {
    ...
    public static YM A01(AbstractC1847jd abstractC1847jd) {
        if (AbstractC1280aL.A00(abstractC1847jd) == EnumC1284aP.A02) {
            return YM.AD_CHOICE_COLLAPSED_PILL;
        }
        return YM.CREDIT_LINE_COLLAPSED_PILL;
    }

    public static YM A02(AbstractC1847jd abstractC1847jd) {
        if (AbstractC1280aL.A00(abstractC1847jd) == EnumC1284aP.A02) {
    ...
    private void A04() {
        this.A07.setOnClickListener(new View.OnClickListener() { // from class: com.facebook.ads.redexgen.X.Rb
            ...
            public final void onClick(View view) {
                C1720hT.this.A0D(view);
            }
        });
    }

    private void A05() {
        C1282aN A02 = AbstractC1283aO.A02(this.A0A.A15(), EnumC1281aM.A05, this.A0A.A13());
    ...
    private void A06() {
        ...
        if (this.A00 != null && this.A09 != null && this.A0A.A13() != null) {
            this.A02 = AbstractC1283aO.A03(this.A0A.A15(), EnumC1281aM.A05, this.A0A.A13(), this.A00, A02(this.A0A.A13()), this.A09, this);
            if (this.A0A.A13().A2Q()) {
                this.A02.A0A();
            }
        }
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC1279aK
