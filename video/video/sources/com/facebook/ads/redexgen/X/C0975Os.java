...
public class C0975Os extends FrameLayout {
    public int A00;
    public int A01;
    public boolean A02;
    public boolean A03;
    ...
    public final InterfaceC0976Ot A06;
    ...
    public static final InterfaceC0977Ou A0A = new C1759i9();
     ...
     */
    public C0975Os(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        this.A04 = new Rect();
        this.A05 = new Rect();
        this.A06 = new C1760iA(this);
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(A0B);
        int color = obtainStyledAttributes.getColor(0, 0);
        obtainStyledAttributes.recycle();
        Color.colorToHSV(color, new float[3]);
        ColorStateList valueOf = ColorStateList.valueOf(C9432sC.b1);
        this.A02 = false;
        this.A03 = true;
        this.A04.left = 0;
        this.A04.top = 0;
    ...
    public C0975Os(Context context) {
        this(context, null);
    }

    public C0975Os(Context context, AttributeSet attributeSet) {
