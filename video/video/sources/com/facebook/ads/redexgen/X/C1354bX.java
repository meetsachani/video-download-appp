...
public final class C1354bX extends View {
    ...
    public C1354bX(C1673gi c1673gi, boolean z) {
        super(c1673gi);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.A02 >= 0) {
            ...
            float f4 = this.A0C.top;
            float sweepAngle3 = A0H;
            float f5 = f4 + sweepAngle3;
            float f6 = this.A0C.bottom;
            float sweepAngle4 = this.A0C.top;
            canvas.drawText(str, f3, f5 + ((f6 - sweepAngle4) / 2.0f), this.A0B);
        }
    }
