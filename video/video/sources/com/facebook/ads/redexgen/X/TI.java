...
public final class TI extends SQLiteOpenHelper {
    ...
    public static void A02() {
        A01 = new byte[]{-105, 101, -119, -118, -117, -122, -102, -111, -103, 101, 117, 0, C8077mf.m, 19, 4, 17, -33, 19, 0, 1, C8077mf.m, 4, -33, 36, 53, 36, C3307Iz.e0, 51, 50, -33, 0, 3, 3, -33, 2, C8077mf.p, C8077mf.m, C8077mf.x, C8077mf.n, 13, -33, -122, -87, -119, -90, -71, -90, -89, -90, -72, -86, -115, -86, -79, -75, -86, -73, 101, -88, -90, -77, 101, -77, -76, -71, 101, -89, -86, 101, -77, -70, -79, -79, -16, -2, -5, -4, -52, 0, -19, -18, -8, -15, -52, -11, -14, -52, -15, 4, -11, -1, 0, -1, -52, C8077mf.q, C8077mf.H, 13, 31, C8077mf.x, 17, 31, -10, -8, -25, -19, -13, -25, C2638Cg0.t7, C8077mf.n, C8077mf.y, C8077mf.B, C8077mf.m, C8077mf.q, 13, C8077mf.x, 5, 17, C8077mf.m, 31, C8077mf.C, C2638Cg0.t7, -29, C2638Cg0.t7, -11, -12, C2638Cg0.C7, C2638Cg0.y7, -48, -33, -111, -33, -102, -48, C2638Cg0.z7};
        if (A02[7].length() == 23) {
    ...
    public TI(C1669ge c1669ge, TH th) {
        super(c1669ge, A01(c1669ge), (SQLiteDatabase.CursorFactory) null, 4);
        if (th != null) {
            this.A00 = th;
            return;
        }
    ...
    public static String A01(C1669ge c1669ge) {
        ...
        if (!C1123Up.A2k(c1669ge)) {
            return format;
        }
        String defaultDbName = c1669ge.getPackageName();
        String processName = ProcessUtils.getProcessName(c1669ge);
