...
public final class C0857Kd extends AbstractC1336bF {
    public static byte[] A0J;
    public static String[] A0K = {"U1MfpI1C6bH5E6SUUi1isARh9jp", "U", "Ubu5RVHkDHh3GnMyAX4EkYenDqWvQs6J", "Crj7vvGLMnYJtX1VpNFn8xcnVkyg9fPV", "3oNG9AhO9bk5LTGV0GcEQxoD", C10901yE.i, "kfjfnNCZtD", "orAcnrCTNYiJWv2aZLW"};
    ...
    private void A04() {
        ...
        YB.A0K(this.A05);
        this.A05.setLayoutParams(AbstractC1336bF.A0B);
    ...
    static {
        ...
        A0R = (int) (C0975Os.A08 * 21.0f);
        A0S = (int) (C0975Os.A08 * 12.0f);
        A0T = (int) (C0975Os.A08 * 10.0f);
    }

    public C0857Kd(C1673gi c1673gi, View$OnClickListenerC0871Kr view$OnClickListenerC0871Kr, int i, boolean z, C0931Na c0931Na, boolean z2, String str, VA va, InterfaceC1214Yh interfaceC1214Yh, C1618fp c1618fp, Y2 y2, C0937Ng c0937Ng, boolean z3, String str2, boolean z4) {
        super(c1673gi, view$OnClickListenerC0871Kr, i, c0931Na, z2, str, va, interfaceC1214Yh, c1618fp, y2, c0937Ng, z3, str2);
        this.A0C = false;
        this.A00 = 0;
        this.A01 = 0;
        this.A0A = true;
        ...
        this.A09 = new C1369bm(this.A0H, A0V, 5, A0U, -1);
        ...
        this.A07 = c0931Na;
        this.A0I = C1123Up.A17(c1673gi);
        YB.A0U(this, c1673gi);
        this.A0B = C1123Up.A2c(this.A0H);
        A0A();
        if (z4) {
    ...
    public C0857Kd(C1673gi c1673gi, View$OnClickListenerC0871Kr view$OnClickListenerC0871Kr, int i, boolean z, C0931Na c0931Na, boolean z2, String str, VA va, InterfaceC1214Yh interfaceC1214Yh, C1618fp c1618fp, Y2 y2, AbstractC1847jd abstractC1847jd) {
        this(c1673gi, view$OnClickListenerC0871Kr, i, z, c0931Na, false, str, va, interfaceC1214Yh, c1618fp, y2, abstractC1847jd.A2A(), abstractC1847jd.A1k(), abstractC1847jd.A13(), abstractC1847jd.A1t());
    }
    ...
    private final void A0C() {
        super.A06.setLayoutParams(AbstractC1336bF.A0B);
        A04();
        A03();
        if (!super.A03) {
            A02();
        ...
        YB.A0J(super.A06);
        if (!super.A03) {
            View$OnClickListenerC0871Kr view$OnClickListenerC0871Kr = super.A08;
            if (A0K[5].length() == 26) {
                throw new RuntimeException();
            }
            A0K[5] = "AjTT";
        ...
        addView(super.A06);
        if (!super.A03) {
            View$OnClickListenerC0871Kr view$OnClickListenerC0871Kr2 = super.A08;
            if (A0K[4].length() != 24) {
                addView(view$OnClickListenerC0871Kr2);
            } else {
    ...
    public void setInfo(NY ny, C0933Nc c0933Nc, String str, String str2, InterfaceC1188Xh interfaceC1188Xh, InterfaceC1351bU interfaceC1351bU) {
        super.setInfo(ny, c0933Nc, str, str2, interfaceC1188Xh, interfaceC1351bU);
        this.A06 = ny;
        this.A08 = c0933Nc;
        A08();
    }
