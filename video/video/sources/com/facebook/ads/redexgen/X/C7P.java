...
public final class C7P extends AbstractC1727ha {
    ...
    public ArrayList<C1006Qa> A09 = new ArrayList<>();
    public ArrayList<QZ> A08 = new ArrayList<>();
    public ArrayList<ArrayList<RK>> A01 = new ArrayList<>();
    public ArrayList<ArrayList<C1006Qa>> A05 = new ArrayList<>();
    ...
    public final void A0H() {
        ...
        for (int size2 = this.A09.size() - 1; size2 >= 0; size2--) {
            C1006Qa c1006Qa = this.A09.get(size2);
            View view = c1006Qa.A04.A0H;
        ...
        if (A0M()) {
            for (int size6 = this.A05.size() - 1; size6 >= 0; size6--) {
                ArrayList<C1006Qa> arrayList2 = this.A05.get(size6);
                for (int size7 = arrayList2.size() - 1; size7 >= 0; size7--) {
                    C1006Qa c1006Qa2 = arrayList2.get(size7);
                    View view2 = c1006Qa2.A04.A0H;
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 17 out of bounds for length 14
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    @Override // com.facebook.ads.redexgen.X.AbstractC1727ha
    public final boolean A0Z(RK rk, int i, int i2, int i3, int i4) {
        ...
        this.A09.add(new C1006Qa(rk, translationX, translationY, i3, i4));
        return true;
    }
    ...
    */
    public final void A0I() {
        ...
        this.A0A.clear();
        if (z2) {
            ArrayList<C1006Qa> arrayList = new ArrayList<>();
    ...
    public final void A0L(RK rk) {
        ...
        for (int size = this.A05.size() - 1; size >= 0; size--) {
            ArrayList<C1006Qa> arrayList2 = this.A05.get(size);
            int i3 = arrayList2.size() - 1;
            while (true) {
                if (i3 < 0) {
                    break;
                } else if (arrayList2.get(i3).A04 == rk) {
                    view.setTranslationY(0.0f);
                    view.setTranslationX(0.0f);
                    A0U(rk);
