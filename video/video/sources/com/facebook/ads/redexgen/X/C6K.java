...
public final class C6K extends AbstractC0854Ka {
    ...
    public final AbstractC1208Yb A07;
    ...
    public static void A06() {
        A09 = new byte[]{112, 116, QC1.w, 126, 124};
    }

    public C6K(C1390c7 c1390c7) {
        super(c1390c7, true);
        this.A03 = new Handler(Looper.getMainLooper());
        this.A02 = false;
        this.A08 = c1390c7.A0C();
        this.A07 = c1390c7.A0B();
        this.A06 = new RelativeLayout(c1390c7.A06());
        this.A05 = new RelativeLayout(c1390c7.A06());
        YB.A0K(this.A05);
        YB.A0K(this.A06);
        this.A04 = c1390c7.A02();
        A04();
        this.A06.addView(this.A05, new RelativeLayout.LayoutParams(-2, -2));
        addView(this.A06, new RelativeLayout.LayoutParams(-1, -1));
        AbstractC1374br.A00(c1390c7.A06(), this.A06, getAdInfo().A0H().A08());
        A03();
        ((AbstractC1386c3) this).A07.A06().A0F().AKh(XL.A00(this.A00), getResources().getConfiguration().orientation, false, false, AbstractC0925Mt.A0C(((AbstractC1386c3) this).A07.A04()));
    }

    private void A02() {
        YB.A0d(this.A07, getAdDetailsView(), getCtaButton());
        this.A01 = new C1534eS(((AbstractC1386c3) this).A07.A06(), getAdDataBundle(), this.A08, getCtaButton(), this.A03, ((AbstractC1386c3) this).A07.A08());
    ...
    private void A04() {
        ...
        ((AbstractC1386c3) this).A07.A06().A0H().A00(A02.A01);
        ...
        if (A02.A00) {
            ...
            AbstractC1333bC.A00(this.A04, C1123Up.A1K(getAdContextWrapper()), new View$OnClickListenerC1385c2(this));
        }
    }
    ...
    private void A05() {
        ...
        if (getAdInfo().A0K().A00() >= 0) {
            this.A02 = true;
            if (this.A07 != null) {
                AbstractC1208Yb abstractC1208Yb = this.A07;
                if (getAdDataBundle().A2P()) {
                    i = 8;
                }
                abstractC1208Yb.setToolbarActionMode(i);
    ...
    public final AbstractC1336bF A1R(C1390c7 c1390c7, NR nr, String str) {
        ...
        return new C1375bs(this.A00, str, c1390c7.A06(), getColors(), c1390c7.A05(), c1390c7.A0C(), getCtaButton(), AbstractC0854Ka.A0G, false, c1390c7.A07(), c1390c7.A0F(), c1390c7.A0A(), c1390c7.A0E(), c1390c7.A08(), false).A03();
    }
