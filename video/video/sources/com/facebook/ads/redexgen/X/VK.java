...
public abstract class VK {
    ...
    public static void A03() {
        A00 = new byte[]{C3307Iz.V, 50, -25, -28, -9, -28, C8077mf.x, 35, 28, 28, 19, C8077mf.D, 7, 10, -4, -1, -6, C8077mf.q, 4, 8, 0, -6, 8, C8077mf.p, 9, -4, 8, C8077mf.n, -4, 10, C8077mf.m, -10, C8077mf.m, 0, 4, -4, -10, 4, 10, C8077mf.y, C8077mf.B, -1, 6, C8077mf.y, C8077mf.p, C8077mf.p, 5, C8077mf.n, -1, C8077mf.n, C8077mf.q, 7, 7, 9, C8077mf.p, 7};
    }
    ...
    public static List<String> A02(C1673gi c1673gi, JSONArray jSONArray) {
        ArrayList arrayList = new ArrayList();
        for (int eventIndex = 0; eventIndex < jSONArray.length(); eventIndex++) {
            try {
                arrayList.add(jSONArray.getString(eventIndex));
            } catch (JSONException e) {
                c1673gi.A08().ABC(A00(39, 17, 76), AbstractC1085Td.A1C, new C1086Te(e));
            }
        }
        return arrayList;
    }
    ...
    public static void A05(C1673gi c1673gi, String str, long j) {
        VA adEventManager = c1673gi.A0A();
    ...
    public static void A06(C1673gi c1673gi, JSONObject jSONObject, long j, String str) {
        ...
        if (TextUtils.isEmpty(str) && optJSONArray != null) {
            A07(c1673gi, optJSONObject, A02(c1673gi, optJSONArray), j, null);
            ...
            A07(c1673gi, optJSONObject, A03.get(str), j, str);
        }
    }

    public static void A07(C1673gi c1673gi, JSONObject jSONObject, List<String> list, long j, String str) {
        String A002 = A00(0, 2, 106);
        if (jSONObject.has(A002)) {
            String clientToken = jSONObject.optString(A002);
            A08(clientToken, str);
            A09(clientToken, list);
            A05(c1673gi, clientToken, j);
        }
    }
