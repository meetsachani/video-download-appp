...
public final class C1546ef extends LinearLayout {
    public static final int A00 = (int) (XX.A02 * 32.0f);
    public static final int A01 = (int) (XX.A02 * 8.0f);

    public C1546ef(C1673gi c1673gi, NativeAd nativeAd, C1137Vd c1137Vd, C1367bk c1367bk, AdOptionsView adOptionsView) {
        super(c1673gi);
        setOrientation(0);
        ...
        addView(c1367bk, iconViewParams);
        TextView textView = new TextView(c1673gi);
        c1137Vd.A08(textView);
        textView.setMaxLines(1);
        textView.setText(nativeAd.getAdvertiserName());
        TextView sponsoredTextView = new TextView(c1673gi);
        c1137Vd.A06(sponsoredTextView);
