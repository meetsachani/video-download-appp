...
public final class KD extends AbstractC1386c3 {
    public RelativeLayout A00;
    public RelativeLayout A01;
    public InterfaceC1503dx A02;
    public C0720Eu A03;
    public C0710Ek A04;
    public C4L A05;
    ...
    public KD(C1390c7 c1390c7) {
        ...
        this.A0E = new E2() { // from class: com.facebook.ads.redexgen.X.6G
            ...
            public final void A03(E3 e3) {
                ...
                interfaceC1503dx = KD.this.A02;
                if (interfaceC1503dx == null) {
                    return;
                }
                interfaceC1503dx2 = KD.this.A02;
    ...
    private LinearLayout A00() {
        ...
        if (!TextUtils.isEmpty(A0C)) {
            YM ym = YM.RATINGS;
            AbstractC1847jd A052 = this.A0C.A05();
            String[] strArr = A0F;
    ...
    private LinearLayout A01(YM ym, String str) {
        ...
        C1361be c1361be = new C1361be(this.A0C.A06(), 0, -1, ym);
        LinearLayout.LayoutParams layoutParams2 = new LinearLayout.LayoutParams(A0P, A0P);
        layoutParams2.gravity = 16;
        c1361be.setLayoutParams(layoutParams2);
    ...
    private final RelativeLayout A02(String str, int i, YM ym) {
        ...
        C1361be iconView = new C1361be(this.A0C.A06(), 0, -1, ym);
    ...
    private C0710Ek A05() {
        C0710Ek c0710Ek = new C0710Ek(this.A0C.A06());
        YB.A0V(c0710Ek, YB.A06(436207616, A0Q));
        c0710Ek.setLayoutParams(new RelativeLayout.LayoutParams(-1, -1));
        this.A05 = new C4L(this.A0B, getAdEventManager(), c0710Ek, this.A0C.A05().A2E(), 0, 0, true, null, null);
        if (C1123Up.A20(this.A0B)) {
            this.A03 = new C0720Eu(this.A0B, getAdEventManager(), c0710Ek, this.A0C.A05().A2E(), false, this.A05, null);
        } else {
            this.A03 = null;
        }
        return c0710Ek;
    ...
    private void A07() {
        ...
        this.A00.setOnClickListener(new View$OnClickListenerC1414cV(this));
        this.A01.setOnClickListener(new View$OnClickListenerC1415cW(this));
    }

    private void A08() {
        new VI(this.A0C.A05().A2E(), getAdEventManager()).A04(VH.A0f, null);
        AbstractC1374br.A00(this.A0C.A06(), this, this.A0C.A05().A29().A0H().A08());
        ...
        this.A04.A0e(EnumC1560et.A02, 20);
