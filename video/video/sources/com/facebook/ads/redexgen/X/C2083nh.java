...
public class C2083nh<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public int A07(@CheckForNull Object key) {
        ...
        int A02 = AbstractC2119oI.A02(key);
        int A00 = A00();
        int A05 = AbstractC2086nk.A05(A0C(), A02 & A00);
        if (A05 == 0) {
            return -1;
        }
        int A022 = AbstractC2086nk.A02(A02, A00);
        do {
            int i = A05 - 1;
            int A01 = A01(i);
            if (AbstractC2086nk.A02(A01, A00) == A022 && CB.A01(key, A0E(i))) {
                return i;
            }
            A05 = AbstractC2086nk.A03(A01, A00);
        } while (A05 != 0);
        return -1;
    }
    ...
    public static void A0M() {
        A09 = new byte[]{-18, 31, 31, C8077mf.p, C3307Iz.Y, 32, C2638Cg0.y7, C8077mf.p, C8077mf.C, 31, C8077mf.u, C8077mf.p, 17, C3307Iz.Y, C2638Cg0.y7, C8077mf.p, C8077mf.C, C8077mf.C, 28, C8077mf.r, C8077mf.p, C3307Iz.V, C8077mf.u, 17, -119, -68, -76, -87, -89, -72, -87, -88, 100, -73, -83, -66, -87, 100, -79, -71, -73, -72, 100, -90, -87, 100, -126, -127, 100, 116, -108, -71, C2638Cg0.p7, -84, -73, -76, -81, 107, -66, -76, C2638Cg0.s7, -80, -123, 107};
        String[] strArr = A0A;
    ...
    public final Iterator<Map.Entry<K, V>> A0d() {
        Map<K, V> A0h = A0h();
        return A0h != null ? A0h.entrySet().iterator() : new C0635Bl(this);
    }
    ...
    public final Iterator<V> A0f() {
        Map<K, V> A0h = A0h();
        return A0h != null ? A0h.values().iterator() : new C0633Bj(this);
    }
    ...
    public void A0n(int dstIndex, int mask) {
        ...
        A0T[size] = 0;
        int A02 = AbstractC2119oI.A02(obj) & mask;
        int A05 = AbstractC2086nk.A05(A0C, A02);
        int i3 = size + 1;
        if (A05 == i3) {
            AbstractC2086nk.A0B(A0C, A02, dstIndex + 1);
            return;
        }
        do {
            i = A05 - 1;
            i2 = A0T[i];
            A05 = AbstractC2086nk.A03(i2, mask);
        } while (A05 != i3);
        int A04 = AbstractC2086nk.A04(i2, dstIndex + 1, mask);
    ...
    public final V put(@ParametricNullness K key, @ParametricNullness V value) {
        ...
        int A00 = A00();
        int i5 = A02 & A00;
        int A05 = AbstractC2086nk.A05(A0C(), i5);
        if (A05 != 0) {
            int A022 = AbstractC2086nk.A02(A02, A00);
            int i6 = 0;
            do {
                i = A05 - 1;
                i2 = A0T[i];
                if (AbstractC2086nk.A02(i2, A00) == A022 && CB.A01(key, A0V[i])) {
                    V v = (V) A0W[i];
                    A0W[i] = value;
                    A0k(i);
                    return v;
                }
                A05 = AbstractC2086nk.A03(i2, A00);
                i6++;
            } while (A05 != 0);
            if (i6 >= 9) {
            ...
            if (i4 > A00) {
                A00 = A02(A00, AbstractC2086nk.A00(A00), A02, i3);
            } else {
                A0T[i] = AbstractC2086nk.A04(i2, i3 + 1, A00);
            }
        } else if (i4 <= A00) {
            AbstractC2086nk.A0B(A0C(), i5, i3 + 1);
            String[] strArr = A0A;
            if (strArr[0].length() != strArr[1].length()) {
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.nh != com.google.common.collect.CompactHashMap<K, V> */
    public C2083nh(int expectedSize) {
        A0l(expectedSize);
    }
    ...
    private int A02(int oldMask, int newCapacity, int targetHash, int targetEntryIndex) {
        Object A07 = AbstractC2086nk.A07(newCapacity);
        int hash = newCapacity - 1;
        if (targetEntryIndex != 0) {
            AbstractC2086nk.A0B(A07, targetHash & hash, targetEntryIndex + 1);
        }
        Object A0C = A0C();
        int[] A0T = A0T();
        for (int oldTableIndex = 0; oldTableIndex <= oldMask; oldTableIndex++) {
            int A05 = AbstractC2086nk.A05(A0C, oldTableIndex);
            while (A05 != 0) {
                int i = A05 - 1;
                int newMask = A0T[i];
                int A02 = AbstractC2086nk.A02(newMask, oldMask) | oldTableIndex;
                int i2 = A02 & hash;
                int A052 = AbstractC2086nk.A05(A07, i2);
                AbstractC2086nk.A0B(A07, i2, A05);
                A0T[i] = AbstractC2086nk.A04(A02, A052, hash);
                A05 = AbstractC2086nk.A03(newMask, oldMask);
            }
        }
        this.A05 = A07;
        A0O(hash);
    ...
    public static /* synthetic */ int A04(C2083nh c2083nh) {
        int i = c2083nh.A04;
        c2083nh.A04 = i - 1;
        return i;
    }
    ...
    private final Set<Map.Entry<K, V>> A08() {
        return new C2079nd(this);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.nh != com.google.common.collect.CompactHashMap<K, V> */
    private final Set<K> A09() {
        return new C2081nf(this);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.nh != com.google.common.collect.CompactHashMap<K, V> */
    private final Collection<V> A0A() {
        return new C2082ng(this);
    }

    public static <K, V> C2083nh<K, V> A0B(int expectedSize) {
        return new C2083nh<>(expectedSize);
    }
    ...
    public Object A0K(@CheckForNull Object key) {
        ...
        int A00 = A00();
        int A06 = AbstractC2086nk.A06(key, null, A00, A0C(), A0T(), A0V(), null);
        if (A06 == -1) {
            Object obj = A0B;
            String[] strArr = A0A;
            String str = strArr[7];
    ...
    private void A0O(int mask) {
        int hashTableBits = AbstractC2086nk.A04(this.A03, 32 - Integer.numberOfLeadingZeros(mask), 31);
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.nh != com.google.common.collect.CompactHashMap<K, V> */
    public int A0Z() {
        AbstractC1912ki.A0F(A0p(), A0L(0, 24, 121));
        int i = this.A03;
        int buckets = AbstractC2086nk.A01(i);
        this.A05 = AbstractC2086nk.A07(buckets);
    ...
    public void A0l(int expectedSize) {
        AbstractC1912ki.A0E(expectedSize >= 0, A0L(24, 26, 16));
        this.A03 = AbstractC0616As.A01(expectedSize, 1, 1073741823);
    }
    ...
    public void A0o(@ParametricNullness int entryIndex, @ParametricNullness K key, V value, int hash, int mask) {
        A0P(entryIndex, AbstractC2086nk.A04(hash, 0, mask));
        A0Q(entryIndex, key);
    ...
    public void clear() {
        ...
        this.A03 = AbstractC0616As.A01(size(), 3, 1073741823);
        A0h.clear();
        this.A05 = null;
        this.A04 = 0;
    }
