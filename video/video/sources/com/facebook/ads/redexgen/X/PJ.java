...
public abstract class PJ extends RelativeLayout implements InterfaceC1215Yi {
    ...
    public abstract AbstractC1208Yb A0b();
    ...
    public PJ(C1673gi c1673gi, VA va, InterfaceC1214Yh interfaceC1214Yh, AbstractC1847jd abstractC1847jd) {
        super(c1673gi);
        this.A09 = false;
        this.A06 = false;
        this.A05 = false;
    ...
    private void A0R() {
        this.A02 = AbstractC1283aO.A01(this.A0E, true, this.A0D, this.A0G, this.A0C, EnumC1281aM.A03, AbstractC1280aL.A00(this.A0D));
        YB.A0K(this.A02);
    }

    private void A0S() {
        this.A03 = AbstractC1283aO.A02(this.A0E, EnumC1281aM.A03, this.A0D);
    ...
    private void A0Y(C0931Na c0931Na, boolean z) {
        ...
        if (this.A0D.A1a()) {
            ...
            this.A0H.A0D(c0931Na, View$OnClickListenerC0871Kr.A05(this.A0D));
        }
    ...
    public final void A0c() {
        if (this.A00 == null || !(this.A00 instanceof AbstractC1386c3)) {
            return;
        }
        if (A0j()) {
            ((AbstractC1386c3) this.A00).A1G();
        } else {
            ((AbstractC1386c3) this.A00).A1F();
        }
    }
    ...
    public final void A0f(View view, boolean z, int i) {
        ...
        if (this.A0C != null) {
            ...
            if (z) {
                this.A0B.A05(EnumC1203Xw.A03);
            }
        }
    }

    public final void A0g(C1035Re c1035Re) {
        this.A0B.A04(c1035Re.A05().getWindow());
        ...
        this.A0H.setToolbarListener(new PT(this, c1035Re));
    }

    public final void A0h(C1035Re c1035Re) {
        AlphaAnimation alphaAnimation = new AlphaAnimation(1.0f, 0.0f);
        alphaAnimation.setDuration(200L);
        alphaAnimation.setAnimationListener(new animation.Animation$AnimationListenerC1227Yu(this, this, c1035Re));
    ...
    public InterfaceC1214Yh getAudienceNetworkListener() {
        return this.A0C;
    }
