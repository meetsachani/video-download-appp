...
public abstract class AbstractC0771Gu {
     ...
     */
    public static C0770Gt A04(C04764u c04764u) {
        ...
        int A044 = c04764u.A04(10);
        if (c04764u.A0H() && c04764u.A04(3) > 0) {
            c04764u.A09(2);
        }
        ...
        if (A01[5].length() != 0) {
            ...
            return new C0770Gt(A043, 2, i3, i2, i4);
        }
        throw new RuntimeException();
    }
    ...
    static {
        A06();
        A02 = new int[]{2002, 2000, 1920, 1601, 1600, 1001, 1000, 960, 800, 800, com.facebook.internal.q0.n1, 400, 400, 2048};
    }

    public static int A00(C04764u c04764u, int i) {
        int i2 = 0;
        while (true) {
            int value = c04764u.A04(i);
            int i3 = i2 + value;
            if (!c04764u.A0H()) {
                return i3;
            }
    ...
    public static int A01(ByteBuffer byteBuffer) {
        ...
        return A04(new C04764u(bArr)).A03;
    }
    ...
    public static C2242qI A03(C04774v c04774v, String str, String str2, DrmInitData drmInitData) {
        c04774v.A0g(1);
        return new C04212p().A0y(str).A11(A05(0, 9, 31)).A0b(2).A0m(((c04774v.A0I() & 32) >> 5) == 1 ? 48000 : 44100).A0u(drmInitData).A10(str2).A14();
    }

    public static void A07(int i, C04774v c04774v) {
        c04774v.A0d(7);
