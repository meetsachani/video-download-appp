...
public final class C3B extends ED {
    ...
    public C3B(C1673gi c1673gi) {
        this(c1673gi, null);
    }

    public C3B(C1673gi c1673gi, AttributeSet attributeSet) {
        this(c1673gi, attributeSet, 0);
    }

    public C3B(C1673gi c1673gi, AttributeSet attributeSet, int i) {
        super(c1673gi, attributeSet, i);
        this.A00 = new C0674Da(this);
