...
public final class Z3 extends RelativeLayout {
    ...
    public Z3(C1673gi c1673gi, int i, int i2, String str, String str2, String str3, String str4, Bitmap bitmap) {
        super(c1673gi);
        this.A05 = new TextView(c1673gi);
        this.A02 = new Button(c1673gi);
        this.A01 = new Button(c1673gi);
