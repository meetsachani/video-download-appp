...
public final class KE extends AbstractC1386c3 {
    ...
    public TextView A0D;
    public AbstractC1847jd A0E;
    public AbstractRunnableC1160Wc A0F;
    public M6 A0G;
    public C1302ah A0H;
    public M3 A0I;
    public C1390c7 A0J;
    ...
    public final AbstractC0925Mt A0b;
    public final VI A0c;
    public final InterfaceC1351bU A0d;
    public final InterfaceC1364bh A0e;
    public final C1365bi A0f;
    public final DZ A0g;
    ...
    public static void A0W() {
        A0k = new byte[]{75, 68, 65, 75, 67, 119, 91, 71, 93, 90, 75, 77, 86, 81, 79, 74, 75, 96, 82, 90, 75, 87, 80, 91, 107, 109, 123, 108, 125, 114, 119, 125, 117, 65, QC1.w, 119, 114, 106, 123, 108, 123, 122, 98, 124, 123, 113, 122, 98, 65};
    }
    ...
    public KE(C1390c7 c1390c7) {
        ...
        this.A0h = new RunnableC1407cO(this);
        this.A0N = false;
        this.A08 = new Handler(Looper.getMainLooper());
        this.A0A = (InputMethodManager) c1390c7.A06().getSystemService(A0I(12, 12, 29));
        this.A0J = c1390c7;
        this.A0E = this.A0J.A05();
        this.A0c = new VI(c1390c7.A05().A2E(), c1390c7.A07());
        this.A0g = this.A0J.A0E();
        if (this.A0g != null) {
            YB.A0K(this.A0g);
        }
        this.A0a = this.A0J.A03();
        this.A0b = C0926Mu.A01(c1390c7.A06(), c1390c7.A07(), c1390c7.A05().A2E(), XB.A00(c1390c7.A05().A29().A0J().A05()), new HashMap(), false, true, this.A0E.A2A());
        ...
        C0710Ek c0710Ek = this.A0J.A02() instanceof C0710Ek ? (C0710Ek) this.A0J.A02() : null;
        this.A0f = new C1365bi(c1390c7, this.A0E, c0710Ek, this.A0J.A0C(), this.A0e, this.A0D, this.A0K, this.A0g, this.A0a);
        if (c0710Ek != null && C1123Up.A1L(getAdContextWrapper())) {
            AbstractC1333bC.A00(c0710Ek.getVideoImplView(), C1123Up.A1M(getAdContextWrapper()), new View$OnClickListenerC1408cP(this));
        } else if (c0710Ek == null && this.A09 != null && C1123Up.A1J(getAdContextWrapper())) {
            AbstractC1333bC.A00(this.A09, C1123Up.A1K(getAdContextWrapper()), new View$OnClickListenerC1409cQ(this));
        }
        this.A0i = c1390c7.A05().A1m();
        this.A0j = c1390c7.A05().A1z();
        getAdContextWrapper().A0F().ACI(this.A0i, this.A0j, c1390c7.A05().A2L());
    }
    ...
    private void A0O() {
        if (this.A0a != null) {
            YB.A0J(this.A0a);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(AbstractC1386c3.A09, AbstractC1386c3.A09);
            layoutParams.addRule(10);
            layoutParams.addRule(11);
            layoutParams.setMargins(AbstractC1386c3.A08, this.A06, AbstractC1386c3.A08, AbstractC1386c3.A08);
    ...
    private void A0Q() {
        AbstractC1208Yb A0B = this.A0J.A0B();
        if (A0B == null) {
            return;
        }
    ...
    private void A0R() {
        ...
        if (this.A09 != null) {
            if (this.A0E.A1e()) {
                this.A09.setOnClickListener(new View$OnClickListenerC1410cR(this));
            }
            YB.A0J(this.A09);
            YB.A0K(this.A09);
        ...
        YB.A0K(this.A0D);
        this.A0K = new C1422cd(this.A0J.A06(), getCtaButton(), this.A0J.A05(), this.A0J.A07(), this.A0J.A0C(), this.A0J.A0F(), this.A0J.A0A(), getColors(), this.A0d);
        this.A0K.setAutoClickTime(this.A0J.A05(), this.A0J.A0B());
        YB.A0G(1010, this.A0K);
        addView(this.A0K);
        A0U();
        A0J();
        if (C1123Up.A17(this.A0J.A06())) {
            View.OnClickListener onClickListener = new View$OnClickListenerC1411cS(this);
            this.A0C.setOnClickListener(onClickListener);
            if (this.A0J.A0B() != null) {
                View.OnClickListener onClickListener2 = new View$OnClickListenerC1412cT(this);
    ...
    private void A0S() {
        ...
        if (this.A09 instanceof C0710Ek) {
            C0710Ek c0710Ek = (C0710Ek) this.A09;
        ...
        addView(new C1402cJ(this.A0J.A06(), this.A0E, this.A0c, this.A0Z, this.A0J.A0C()).A0C(getRegularCtaForEndCard()));
    }
    ...
    public void A0f(String str) {
        ...
        if (AbstractC1124Uq.A02(this.A0J.A06()) || this.A0J.A06().A0E() == null) {
            m3 = new M3(this.A0J.A06(), kr);
        } else {
            m3 = new M3(this.A0J.A06(), this.A0J.A06().A0E(), kr);
        }
        this.A0I = m3;
        this.A0I.setOnTouchListener(new View$OnTouchListenerC1404cL(this));
    ...
    public void A0i(boolean z) {
        ...
        if (this.A09 != null) {
            ...
            duration.addUpdateListener(new C1405cM(this));
            ...
            animatorSet.addListener(new C1406cN(this, z));
            if (this.A0j) {
                boolean z2 = this.A09 instanceof C0710Ek;
                String[] strArr = A0l;
                if (strArr[6].charAt(18) != strArr[5].charAt(18)) {
                    throw new RuntimeException();
                }
                ...
                strArr2[1] = "o2de";
                if (z2) {
                    ((C0710Ek) this.A09).A0c(animatorSet, z);
                }
            }
            animatorSet.start();
        }
    ...
    private void A0j(boolean z) {
        ...
        if (z2) {
            ...
            if (C1123Up.A1J(getAdContextWrapper()) && getResources().getConfiguration().orientation == 2 && !(this.A09 instanceof C0710Ek)) {
    ...
    */
    ...
    public final boolean A1P(boolean z) {
        if (A1Q()) {
            ...
            this.A0f.A07(this);
            return true;
        } else if (this.A0E.A29().A0K().A04()) {
            getAdContextWrapper().A0F().ACK();
            if (this.A09 instanceof C0710Ek) {
                C0710Ek simpleVideoView = (C0710Ek) this.A09;
    ...
    public int getCloseButtonStyle() {
        if (A1Q()) {
            return A0m() ? 2 : 3;
        } else if (this.A0E.A29().A0H().A02() >= 0 && A1N() && (this.A0V || this.A0X)) {
            return 8;
        } else {
            if (this.A0V) {
                return 2;
    ...
    private View$OnClickListenerC0871Kr getRegularCtaForEndCard() {
        View$OnClickListenerC0871Kr view$OnClickListenerC0871Kr = new View$OnClickListenerC0871Kr(getAdContextWrapper(), this.A0J.A05().A0w(), this.A0E.A28().A01(), getAdEventManager(), this.A0J.A0C(), (C1618fp) null, this.A0J.A0A(), this.A0E.A2A());
        view$OnClickListenerC0871Kr.setViewShowsOverMedia(true);
        YB.A0K(view$OnClickListenerC0871Kr);
        view$OnClickListenerC0871Kr.setText(this.A0E.A29().A0J().A04());
        YB.A0G(1001, view$OnClickListenerC0871Kr);
        view$OnClickListenerC0871Kr.setCta(this.A0E.A29().A0J(), this.A0E.A2E(), new HashMap(), null);
    ...
    private void setUpBrowserControls(M3 m3) {
        ...
        this.A0G.setOnTouchListener(new View$OnTouchListenerC1403cK(this));
        this.A0B.addView(this.A0G, layoutParams);
        YB.A0J(this.A0H);
        this.A0H = new C1302ah(this.A0J.A06(), null, 16842872);
