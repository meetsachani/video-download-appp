...
public final class LF extends C0975Os {
    ...
    private void A02() {
        ...
        new LM(c1367bk, this.A03).A05(A0D, A0D).A07(this.A02.A2C().A01());
        ...
        layoutParams2.addRule(3, c1367bk.getId());
        ...
        C1369bm c1369bm = new C1369bm(this.A03, A0B, 5, A0A, -1);
        c1369bm.setGravity(16);
        linearLayout.addView(c1369bm, new LinearLayout.LayoutParams(-2, -1));
        ...
        if (TextUtils.isEmpty(this.A02.A29().A0I().A0C())) {
            ...
            c1369bm.setRating(Float.parseFloat(this.A02.A29().A0I().A0C()));
    ...
    public static void A03() {
        A07 = new byte[]{C8077mf.G, 105};
    }

    static {
        A03();
        A0C = (int) (C0975Os.A08 * 12.0f);
        A0D = (int) (C0975Os.A08 * 84.0f);
        A0B = (int) (C0975Os.A08 * 14.0f);
        A09 = XV.A0v;
        A0A = P3.A02(-1, 77);
    }

    public LF(C1673gi c1673gi, AbstractC1847jd abstractC1847jd, VA va, InterfaceC1214Yh interfaceC1214Yh) {
        super(c1673gi);
        this.A05 = new Y2();
        this.A03 = c1673gi;
        ...
        AbstractC1374br.A00(c1673gi, this.A01, abstractC1847jd.A29().A0H().A08());
    ...
    private void A01() {
        View$OnClickListenerC0871Kr view$OnClickListenerC0871Kr = new View$OnClickListenerC0871Kr(this.A03, EnumC1566ez.A04.A03(), this.A02.A28().A01(), this.A02.A29().A0J().A06(), this.A04, this.A06, null, this.A05, this.A02.A2A());
        view$OnClickListenerC0871Kr.setViewShowsOverMedia(true);
        YB.A0G(1001, view$OnClickListenerC0871Kr);
        view$OnClickListenerC0871Kr.setCta(this.A02.A29().A0J(), this.A02.A2E(), new HashMap(), null);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, -2);
        view$OnClickListenerC0871Kr.setPadding(A0C, A0C, A0C, A0C);
        layoutParams.setMargins(A0C, A0C, A0C, A0C * 2);
        this.A00.addView(view$OnClickListenerC0871Kr, layoutParams);
    }
}
