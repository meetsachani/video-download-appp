...
public abstract class H7 {
    ...
    public static void A06() {
        A00 = new byte[]{7, 19, 2, C8077mf.q, 9, 73, C8077mf.r, 8, 2, 72, 2, C8077mf.u, C8077mf.y};
    }

    static {
        A06();
        A02 = new int[]{1, 2, 2, 2, 2, 3, 3, 4, 4, 5, 6, 6, 6, 7, 8, 8};
        A03 = new int[]{-1, 8000, 16000, C9948uJ1.h, -1, -1, 11025, 22050, 44100, -1, -1, 12000, 24000, 48000, -1, -1};
        A04 = new int[]{64, 112, 128, CK1.x, 224, 256, 384, 448, 512, 640, 768, 896, 1024, 1152, com.facebook.internal.q0.q1, o.I3.g, 1920, 2048, 2304, 2560, 2688, OZ1.i, 2823, 2944, 3072, 3840, 4096, 6144, 7680};
    }
    ...
    public static int A02(byte[] bArr) {
        ...
        switch (bArr[0]) {
            case -2:
                int nblks = bArr[5];
                i = ((nblks & 1) << 6) | ((bArr[4] & C3307Iz.T) >> 2);
                break;
            case -1:
            ...
            case 31:
                ...
                break;
            default:
                i = ((bArr[4] & 1) << 6) | ((bArr[5] & C3307Iz.T) >> 2);
                break;
        }
        int nblks2 = i + 1;
        return nblks2 * 32;
    ...
    public static C2242qI A03(byte[] bArr, String str, String str2, DrmInitData drmInitData) {
        int i;
        C04764u A042 = A04(bArr);
        A042.A09(60);
        ...
        return new C04212p().A0y(str).A11(A05(0, 13, 27)).A0a(i).A0b(bitrate + amode5).A0m(rate).A0u(drmInitData).A10(str2).A14();
    }

    public static C04764u A04(byte[] bArr) {
        if (bArr[0] == Byte.MAX_VALUE) {
            return new C04764u(bArr);
        }
        ...
        if (copyOf[0] == 31) {
            C04764u c04764u2 = new C04764u(copyOf);
            while (c04764u2.A01() >= 16) {
                c04764u2.A09(2);
                int A042 = c04764u2.A04(14);
                if (A01[4].length() == 13) {
                    throw new RuntimeException();
                }
                String[] strArr = A01;
