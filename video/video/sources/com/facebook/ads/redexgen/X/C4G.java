...
public final class C4G implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public static void A05() {
        A06 = new byte[]{72, 74, 79, C3307Iz.Y, 75, 82, 82, 86, 72, C3307Iz.Y, 82, 81, 73, 76, 74, 3, 73, 68, 76, 79, 72, 71, C8077mf.G, 3, 86, 88, 70, 70, 72, 86, 86, 32, 8, 69, C8077mf.q, 3, 81, 88, 80, C3307Iz.Y, 82, 81, 73, 76, 74, 86, 62, 19, 64, 32, 8, 71, C8077mf.q, 3, 70, 82, 81, 73, 76, 74, 86, 62, 19, 64, 32, 8, 86, -27, -25, -20, C2638Cg0.r7, -14, -27, C2638Cg0.C7, -12, -27, C2638Cg0.r7, -17, -18, -12, -27, -8, -12, -96, -26, C2638Cg0.C7, -23, -20, -27, -28, C8077mf.x, C8077mf.z, C8077mf.E, -14, C3307Iz.V, C8077mf.x, C8077mf.r, 35, C8077mf.x, -1, 17, 36, C8077mf.y, C8077mf.y, C8077mf.x, C3307Iz.V, 2, 36, C3307Iz.V, C8077mf.y, C8077mf.r, C8077mf.u, C8077mf.x, C2638Cg0.A7, C8077mf.y, C8077mf.r, C8077mf.B, C8077mf.E, C8077mf.x, 19, -6, -4, 1, -36, -6, 9, C2638Cg0.E7, -2, 8, 5, 1, -10, C8077mf.p, -75, -5, -10, -2, 1, -6, -7, 67, 69, 74, C3307Iz.Z, 76, 71, 82, 71, ED2.a, 74, 71, 88, 67, -2, 68, ED2.a, 71, 74, 67, 66, 2, 4, 9, -22, -2, 8, 2, -32, C8077mf.u, C8077mf.q, C8077mf.q, 2, C8077mf.m, 17, -67, 3, -2, 6, 9, 2, 1, 13, C8077mf.u, -19, C8077mf.m, C8077mf.x, -6, C8077mf.m, C8077mf.H, C8077mf.D, C8077mf.E, C8077mf.B, C8077mf.m, C8077mf.C, C2638Cg0.t7, C8077mf.n, 7, C8077mf.q, C8077mf.u, C8077mf.m, 10, -44, C2638Cg0.t7, -21, C8077mf.B, C8077mf.B, C8077mf.y, C8077mf.B, -32, C2638Cg0.t7};
    }
    ...
    public static EGLContext A01(EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i) {
        int[] iArr;
        if (i != 0) {
            iArr = new int[]{12440, 2, RunnableC6482g90.i1, 1, 12344};
        } else {
    ...
    public static EGLDisplay A02() {
        ...
        if (!eglInitialized) {
            throw new C4E(A04(C3503Kz.d0, 20, 106));
        }
    ...
    public static EGLSurface A03(EGLDisplay eGLDisplay, EGLConfig eGLConfig, EGLContext eGLContext, int i) {
        ...
        if (i == 1) {
            ...
            if (i == 2) {
                pbufferAttributes = new int[]{12375, 1, 12374, 1, RunnableC6482g90.i1, 1, 12344};
            } else {
    ...
    public final SurfaceTexture A07() {
        return (SurfaceTexture) AbstractC04543y.A01(this.A00);
    }
