...
public final class C1840jW {
    public static byte[] A00;
    public static final C1840jW A01;
    ...
    public static final <T> List<T> A01() {
        return AbstractC0603Af.A06();
    }

    @JvmStatic
    public static final <T> List<T> A02(T... tArr) {
        C2256qY.A09(tArr, A00(0, 8, 96));
        Object[] copyOf = Arrays.copyOf(tArr, tArr.length);
        return new ArrayList(AbstractC0603Af.A07(Arrays.copyOf(copyOf, copyOf.length)));
    }

    @JvmStatic
    public static final <T> List<T> A03(T... tArr) {
        C2256qY.A09(tArr, A00(0, 8, 96));
        return new ArrayList(AbstractC0603Af.A07(Arrays.copyOf(tArr, tArr.length)));
    }
    ...
    public static final <T> Set<T> A05(T... tArr) {
        C2256qY.A09(tArr, A00(0, 8, 96));
        return new HashSet(AbstractC0603Af.A07(Arrays.copyOf(tArr, tArr.length)));
    }
}
