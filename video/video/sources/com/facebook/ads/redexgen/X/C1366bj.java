...
public final class C1366bj extends LinearLayout {
    public int A00;
    ...
    public C1366bj(C1673gi c1673gi, C0931Na c0931Na, int i) {
        super(c1673gi);
        this.A00 = -1;
        setOrientation(0);
        setGravity(17);
    ...
    */
    public final void A00(int i) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            int i4 = this.A02;
            this.A01.get(i3).setStroke(i4, borderColor);
