...
public final class C0853Jz {
    ...
    public C0853Jz(int i, boolean z, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, SparseArray<K0> sparseArray) {
        this.A03 = i;
        this.A0A = z;
        this.A08 = i2;
        this.A02 = i3;
    ...
    public final void A00(C0853Jz c0853Jz) {
        SparseArray<K0> sparseArray = c0853Jz.A09;
