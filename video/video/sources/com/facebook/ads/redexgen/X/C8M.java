...
public abstract class C8M implements InterfaceC1981lq {
    ...
    public C8M() {
        ...
        for (int i2 = 0; i2 < 2; i2++) {
            this.A04.add(new C8P(new AnonymousClass64() { // from class: com.facebook.ads.redexgen.X.li
                @Override // com.facebook.ads.redexgen.X.AnonymousClass64
                public final void AHj(AbstractC2162oz abstractC2162oz) {
                    C8M.this.A0c((C1U) abstractC2162oz);
                }
            }) { // from class: com.facebook.ads.redexgen.X.1U
    ...
    /* renamed from: A0W */
    public C8S A5r() throws C1974lj {
        AbstractC04543y.A08(this.A02 == null);
        if (this.A03.isEmpty()) {
            return null;
        }
    ...
    */
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass60
    /* renamed from: A0a */
    public void AHJ(C8S c8s) throws C1974lj {
        AbstractC04543y.A07(c8s == this.A02);
        C1V c1v = (C1V) c8s;
        if (c1v.A04()) {
            A0U(c1v);
        } else {
