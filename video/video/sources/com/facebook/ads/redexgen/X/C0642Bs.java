...
public class C0642Bs<V> extends C2L<K, V>.WrappedCollection.WrappedIterator implements ListIterator<V> {
    public final /* synthetic */ C0641Br A00;
    ...
    public C0642Bs(final C0641Br this$1) {
        super(this$1);
        this.A00 = this$1;
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Bs != com.google.common.collect.AbstractMapBasedMultimap<K, V>$WrappedList$WrappedListIterator */
    public C0642Bs(final C0641Br this$1, int index) {
