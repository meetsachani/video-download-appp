...
public final class C5 {
    ...
    public final C2 A0C;
    public final InterfaceC2098nw A0D;
    public final CT A0E;
    ...
    public static void A03() {
        A0G = new byte[]{34, 31, 8, 55, C8077mf.m, 6, C8077mf.H, 2, C8077mf.y, 93, 35, 8, C8077mf.r, 9, C8077mf.m, 8, 6, 3, 42, 6, 9, 6, 0, 2, C8077mf.y};
    }
    ...
    public C5(Context context, C5O c5o, MP mp, C5Y c5y, Executor executor) {
        this(context, new C9w(c5o), new C2104o3(new C1898kT().A06(mp).A05(c5y), executor));
    }

    public C5(Context context, InterfaceC2098nw interfaceC2098nw, CJ cj) {
        this.A0A = context.getApplicationContext();
        this.A0D = interfaceC2098nw;
        this.A01 = 3;
        this.A02 = 5;
        this.A07 = true;
        ...
        handlerThread.start();
        this.A0C = new C2(handlerThread, interfaceC2098nw, cj, A0b, this.A01, this.A02, this.A07);
    ...
    public static C0634Bk A00(C0634Bk c0634Bk, DownloadRequest downloadRequest, int i, long j) {
        long j2;
        int i2;
        int i3 = c0634Bk.A02;
        if (i3 == 5 || c0634Bk.A02()) {
        ...
        return new C0634Bk(c0634Bk.A07.A02(downloadRequest), i2, j2, j, -1L, i, 0);
    }
    ...
    private void A05(C0 c0) {
        ...
        C0634Bk c0634Bk = c0.A00;
        boolean A0A = A0A();
        if (c0.A03) {
            Iterator<C4> it = this.A0F.iterator();
            while (it.hasNext()) {
                it.next().ADi(this, c0634Bk);
            }
        } else {
            ...
            while (true) {
                ...
                it2.next().ADh(this, c0634Bk, c0.A01);
            }
        }
        if (A0A) {
            A02();
    ...
    */
    private void A08(List<C0634Bk> list) {
        this.A08 = true;
