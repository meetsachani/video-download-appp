...
public class C2079nd<K, V> extends AbstractSet<Map.Entry<K, V>> {
    ...
    public C2079nd(final C2083nh this$0) {
        this.A00 = this$0;
    }
    ...
    public final boolean contains(@CheckForNull Object o2) {
        ...
        boolean z = o2 instanceof Map.Entry;
        if (A01[5].charAt(2) != '2') {
    ...
    public final boolean remove(@CheckForNull Object o2) {
        ...
        if (o2 instanceof Map.Entry) {
            ...
            A0V = this.A00.A0V();
            A0W = this.A00.A0W();
            int A06 = AbstractC2086nk.A06(key, value, A00, A0C, A0T, A0V, A0W);
            if (A06 == -1) {
                return false;
            }
