...
public class C0641Br<V> extends C2L<K, V>.WrappedCollection implements List<V> {
    ...
    public C0641Br(@ParametricNullness final C2L this$0, @CheckForNull Object key, List delegate, C1980lp ancestor) {
