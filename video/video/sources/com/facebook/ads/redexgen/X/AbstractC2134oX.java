...
public abstract class AbstractC2134oX<K, V> implements Map<K, V>, Serializable {
    ...
    @CheckForNull
    @LazyInit
    public transient AbstractC2125oO<V> A00;
    @CheckForNull
    @LazyInit
     ...
     */
    public static <K, V> AbstractC2134oX<K, V> A05(Iterable<? extends Map.Entry<? extends K, ? extends V>> entries) {
        C2132oV c2132oV = new C2132oV(entries instanceof Collection ? ((Collection) entries).size() : 4);
        c2132oV.A04(entries);
        return c2132oV.A07();
    }
    ...
    public abstract AbstractC2125oO<V> A0A();
    ...
    public static <K, V> C2132oV<K, V> A03() {
        return new C2132oV<>();
    }

    public static <K, V> AbstractC2134oX<K, V> A04() {
        AbstractC2134oX<K, V> abstractC2134oX = (AbstractC2134oX<K, V>) B9.A04;
        if (A04[4].charAt(3) != 'V') {
    ...
    public static <K, V> AbstractC2134oX<K, V> A06(Map<? extends K, ? extends V> map) {
        if ((map instanceof AbstractC2134oX) && !(map instanceof SortedMap)) {
            AbstractC2134oX<K, V> abstractC2134oX = (AbstractC2134oX) map;
            if (!abstractC2134oX.A0F()) {
                return abstractC2134oX;
            }
        }
    ...
    @Override // java.util.Map
    /* renamed from: A09 */
    public AbstractC2125oO<V> values() {
        AbstractC2125oO<V> abstractC2125oO = this.A00;
        if (abstractC2125oO == null) {
            abstractC2125oO = A0A();
            if (A04[3].length() == 23) {
                throw new RuntimeException();
            }
            A04[6] = "23ujWmcydF5ICCpn56C";
            this.A00 = abstractC2125oO;
        }
        return abstractC2125oO;
    }
    ...
    public final String toString() {
        return AbstractC2212po.A08(this);
    }
}
