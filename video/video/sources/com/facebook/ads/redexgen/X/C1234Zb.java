...
public final class C1234Zb extends RelativeLayout {
    public final int A00;
    public final int A01;
    public final C0963Og A02;
    public final C1673gi A03;
    public final InterfaceC1238Zf A04;
    ...
    public C1234Zb(C1233Za c1233Za) {
        super(C1233Za.A01(c1233Za));
        this.A03 = C1233Za.A01(c1233Za);
        this.A02 = AbstractC0964Oh.A00(this.A03.A02());
        this.A04 = C1233Za.A03(c1233Za);
        this.A01 = C1233Za.A09(c1233Za) ? A0E : A0F;
        this.A00 = C1233Za.A09(c1233Za) ? A0B : A0C;
        this.A05 = C1233Za.A0A(c1233Za);
        setFocusable(true);
        View A01 = A01(c1233Za);
        View A00 = A00(c1233Za);
    ...
    public /* synthetic */ C1234Zb(C1233Za c1233Za, ZY zy) {
        this(c1233Za);
    }

    private View A00(C1233Za c1233Za) {
        ImageView imageView = new ImageView(getContext());
        imageView.setPadding(this.A00, this.A00, this.A00, this.A00);
        imageView.setImageBitmap(YN.A01(C1233Za.A02(c1233Za)));
        imageView.setColorFilter(-1);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(this.A01, this.A01);
        GradientDrawable gradientDrawable = new GradientDrawable();
        gradientDrawable.setShape(1);
        gradientDrawable.setColor(C1233Za.A00(c1233Za));
        ...
        subtitleView.setText(C1233Za.A07(c1233Za));
        ...
        titleView.setText(C1233Za.A04(c1233Za));
        ...
        if (C1233Za.A08(c1233Za)) {
            LinearLayout linearLayout2 = new LinearLayout(getContext());
            linearLayout2.setOrientation(0);
            linearLayout2.setGravity(17);
            if (!TextUtils.isEmpty(C1233Za.A05(c1233Za))) {
                ...
                c1367bk.setFullCircleCorners(true);
                new LM(c1367bk, this.A03).A05(A0F, A0F).A07(C1233Za.A05(c1233Za));
                linearLayout2.addView(c1367bk, iconParams);
            }
            C1240Zh c1240Zh = new C1240Zh(this.A03);
            c1240Zh.setData(C1233Za.A06(c1233Za), YM.CHECKMARK);
            c1240Zh.setSelected(true);
            linearLayout2.addView(c1240Zh, new LinearLayout.LayoutParams(-2, -2));
            linearLayout.addView(linearLayout2);
        }
        return linearLayout;
    }

    private View A01(C1233Za c1233Za) {
        LinearLayout linearLayout = new LinearLayout(getContext());
        linearLayout.setOrientation(0);
        if (C1233Za.A0B(c1233Za)) {
            ImageView imageView = new ImageView(getContext());
