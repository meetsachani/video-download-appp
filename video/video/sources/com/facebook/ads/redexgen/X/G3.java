...
public final class G3 {
    ...
    public static void A01() {
        byte[] bArr = {C8077mf.x, 51, 59, 62, 55, 54, 114, C3307Iz.Y, C4715Xk.i, 114, 49, 51, 62, 62, 114, 1, C3307Iz.Z, 32, 52, 51, 49, 55, 124, C3307Iz.V, 55, C3307Iz.Y, C8077mf.x, 32, 51, ED2.a, 55, 0, 51, C3307Iz.Y, 55, 77, 114, Byte.MAX_VALUE, 126, 116, 93, 105, 122, 118, 126, 73, 126, 119, 126, 122, 104, 126, 83, 126, 119, 107, 126, 105};
        if (A01[2].length() != 7) {
            throw new RuntimeException();
        }
    ...
    public static void A02(Surface surface, float f) {
        ...
        try {
            ...
            AbstractC04624g.A08(A00(35, 23, 69), A00(0, 35, 12), e);
        }
    }
}
