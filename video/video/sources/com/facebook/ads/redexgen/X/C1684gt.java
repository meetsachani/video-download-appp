...
public final class C1684gt implements SR {
    ...
    public final InterfaceC1649gK A01;
    ...
    public static void A02() {
        A03 = new byte[]{75, 75, 78, C8077mf.B, 81, 75, 78, C8077mf.B, C3307Iz.Z, 53, 53, 35, 50, 53};
    }
    ...
    public C1684gt(CY cy) {
        this.A01 = cy.A5U(EnumC1650gL.A0B);
        this.A01.A41(new C1685gu(this));
        A03();
    }
    ...
    public static Set<SU> A01(JSONObject jSONObject) {
        ...
        while (true) {
            ...
            if (i < i2) {
                ...
                if (optJSONObject == null || (A00 = C1683gs.A00(optJSONObject)) == null) {
                    return null;
                }
                hashSet.add(A00);
                i++;
