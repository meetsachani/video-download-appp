...
public class C0643Bt<K, V> extends AbstractC2211pn<K, Collection<V>> {
    ...
    public C0643Bt(final C2L this$0, Map<K, Collection<V>> submap) {
        this.A01 = this$0;
        this.A00 = submap;
    }
    ...
    public final Collection<V> get(@CheckForNull Object key) {
        Collection<V> collection = (Collection) AbstractC2212po.A05(this.A00, key);
        if (collection == null) {
            return null;
        }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Bt != com.google.common.collect.AbstractMapBasedMultimap<K, V>$AsMap */
    @Override // com.facebook.ads.redexgen.X.AbstractC2211pn
    public final Set<Map.Entry<K, Collection<V>>> A09() {
        return new BI<K, Collection<V>>() { // from class: com.facebook.ads.redexgen.X.2P
            ...
            public final boolean contains(@CheckForNull Object o2) {
                return AbstractC2078nc.A03(C0643Bt.this.A00.entrySet(), o2);
            }

            /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2P != com.google.common.collect.AbstractMapBasedMultimap<K, V>$AsMap$AsMapEntries */
            @Override // java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, java.util.Set
            public final Iterator<Map.Entry<K, Collection<V>>> iterator() {
                return new C1976ll(C0643Bt.this);
            }
            ...
            public final boolean remove(@CheckForNull Object o2) {
                ...
                C0643Bt c0643Bt = C0643Bt.this;
                if (A01[2].length() != 19) {
                    A01[3] = "G2qcJwlII5HIikaXRsYLysr3qmkTj7oM";
                    c0643Bt.A01.A0A(entry.getKey());
                    return true;
                }
    ...
    public final Map.Entry<K, Collection<V>> A0A(Map.Entry<K, Collection<V>> entry) {
        K key = entry.getKey();
        return AbstractC2212po.A01(key, this.A01.A0F(key, entry.getValue()));
    }
    ...
    public final void clear() {
        ...
        if (map2 == map) {
            ...
            AbstractC2172p9.A09(new C1976ll(this));
        }
    }
    ...
    public final boolean containsKey(@CheckForNull Object key) {
        return AbstractC2212po.A0C(this.A00, key);
    }
