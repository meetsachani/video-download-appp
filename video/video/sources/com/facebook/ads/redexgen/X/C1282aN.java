...
public final class C1282aN extends LinearLayout {
    ...
    public static void A03() {
        A05 = new byte[]{-34, -19, -32, -33, -28, -17, C2638Cg0.B7, -25, -28, -23, -32};
    }
    ...
    public C1282aN(C1673gi c1673gi, EnumC1281aM enumC1281aM, AbstractC1847jd abstractC1847jd) {
        super(c1673gi);
        this.A02 = YN.A01(YM.CREDIT_LINE_DETAIL_ICON);
        this.A04 = c1673gi;
        this.A03 = abstractC1847jd;
        AbstractC1280aL.A03(c1673gi, enumC1281aM);
        A02();
    }
    ...
    private void A01() {
        ...
        int i2 = -2;
        if (this.A00 != null) {
            AbstractC1847jd abstractC1847jd = this.A03;
            String[] strArr = A06;
            String str = strArr[4];
            ...
            if (abstractC1847jd != null && this.A03.A0t() != null) {
    ...
    public final void A04() {
        ...
        A06[3] = "jEdvzIR";
        if (abstractC1847jd != null && this.A03.A0t() != null && this.A03.A0t().A04() > 0) {
    ...
    private void getDownloadedBitmap() {
        if (this.A03 != null && this.A03.A0t() != null && this.A03.A0t().A05() != null && this.A03.A0t().A04() > 0 && this.A03.A0t().A03() > 0) {
            try {
                this.A00 = new C1079Sx(this.A04).A0O(this.A03.A0t().A05(), (int) (this.A03.A0t().A03() * XX.A02), (int) (this.A03.A0t().A04() * XX.A02));
            } catch (Exception e) {
                this.A04.A08().ABC(A00(0, 11, 27), 3900, new C1086Te(e));
            }
        }
    }
