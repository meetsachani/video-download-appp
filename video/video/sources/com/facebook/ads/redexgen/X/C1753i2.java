...
public class C1753i2 implements PR {
    ...
    public C1753i2(Pv pv) {
        this.A01 = pv;
    }

    @Override // com.facebook.ads.redexgen.X.PR
    public final C1004Py ACw(View view, C1004Py c1004Py) {
        C1004Py A06 = Ph.A06(view, c1004Py);
        if (A06.A07()) {
            return A06;
        }
        Rect rect = this.A00;
        ...
        for (int i = 0; i < count; i++) {
            C1004Py A05 = Ph.A05(this.A01.getChildAt(i), A06);
        ...
        C1004Py applied = A06.A06(i2, i3, i4, i5);
        return applied;
    }
}
