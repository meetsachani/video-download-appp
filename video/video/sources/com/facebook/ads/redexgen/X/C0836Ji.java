...
public final class C0836Ji extends AbstractC1386c3 {
    ...
    public final AbstractC0925Mt A0W;
    public final AbstractC1847jd A0X;
    public final VI A0Y;
    public final LK A0Z;
    public final InterfaceC1351bU A0a;
    public final C1390c7 A0b;
    ...
    public static void A0Y() {
        A0e = new byte[]{35, C3307Iz.d0, C3307Iz.a0, 35, C3307Iz.c0, 31, 51, 47, 53, 50, 35, C3307Iz.X, C8077mf.B, 31, 1, 4, 5, C3307Iz.f0, 28, C8077mf.x, 5, C8077mf.C, C8077mf.H, C8077mf.y, 75, 77, 91, 76, 93, 82, 87, 93, 85, 97, 88, 87, 82, 74, 91, 76, 91, 90, C3307Iz.Y};
    }
    ...
    public C0836Ji(C1390c7 c1390c7) {
        super(c1390c7, true);
        this.A0K = false;
        this.A0M = false;
        this.A0N = false;
        ...
        this.A0C = true;
        this.A0c = new RunnableC1427ci(this);
        this.A0a = new C0847Jt(this);
        this.A0R = new Handler(Looper.getMainLooper());
        this.A0V = (InputMethodManager) c1390c7.A06().getSystemService(A0L(12, 12, 46));
        this.A0b = c1390c7;
        this.A0X = this.A0b.A05();
        this.A0Y = new VI(c1390c7.A05().A2E(), c1390c7.A07());
        this.A0Q = A00(c1390c7);
        this.A0U = this.A0b.A03();
        this.A0W = C0926Mu.A01(c1390c7.A06(), c1390c7.A07(), c1390c7.A05().A2E(), XB.A00(c1390c7.A05().A29().A0J().A05()), new HashMap(), false, true, this.A0X.A2A());
        AbstractC1374br.A00(c1390c7.A06(), this, c1390c7.A05().A29().A0H().A08());
        this.A0D = false;
        ...
        if (this.A0T != null && A0w()) {
            this.A0A = A0I((C0710Ek) this.A0T);
        }
        this.A0d = c1390c7.A05().A1m();
        getAdContextWrapper().A0F().ACI(this.A0d, true, c1390c7.A05().A2L());
        if (!(this.A0T instanceof C0710Ek)) {
            A0P();
        }
        A0O();
    }

    private float A00(C1390c7 c1390c7) {
        if (this.A0b.A02() instanceof C0710Ek) {
        ...
        float mAspectRatio2 = new C1079Sx(c1390c7.A06()).A0M(this.A0X.A29().A0H().A08());
        return mAspectRatio2;
    }

    public static /* synthetic */ int A02(C0836Ji c0836Ji) {
        int i = c0836Ji.A00;
        c0836Ji.A00 = i + 1;
        return i;
    }

    public static /* synthetic */ int A04(C0836Ji c0836Ji) {
        int i = c0836Ji.A01;
        c0836Ji.A01 = i + 1;
        return i;
    }

    private LK A0F(C1390c7 c1390c7) {
        LK A03 = new C1375bs(this.A0Q, c1390c7.A05().A0w(), c1390c7.A06(), getColors(), c1390c7.A05(), c1390c7.A0C(), getCtaButton(), AbstractC0854Ka.A0G, true, c1390c7.A07(), c1390c7.A0F(), c1390c7.A0A(), c1390c7.A0E(), c1390c7.A08(), true).A03();
    ...
    private C1365bi A0I(C0710Ek c0710Ek) {
        return new C1365bi(this.A0b, this.A0X, c0710Ek, this.A0b.A0C(), new K4(this), this.A0U, this.A0Z, this.A03);
    }
    ...
    private void A0P() {
        this.A0b.A06().A0F().AKh(XL.A00(this.A0Q), getResources().getConfiguration().orientation, false, this.A0b.A0G() != null, AbstractC0925Mt.A0A());
    ...
    private void A0S() {
        if (this.A0b.A05().A1X() && this.A0W != null && XL.A03(this.A0Q)) {
            this.A09 = new C1350bT(this.A0b.A06(), this.A0b.A0C(), this.A0b.A05().A0l(), this.A0W, this.A0Z.getCTAButton(), this.A0Z);
            addView(this.A09.getBrowserPeekView());
            this.A0S.postDelayed(new RunnableC1426ch(this), 5900L);
        }
    }

    private void A0T() {
        if (this.A0T != null && this.A0X.A1e()) {
            this.A0T.setOnClickListener(new View$OnClickListenerC1429ck(this));
        }
        YB.A0J(this.A0T);
        ...
        if (C1123Up.A17(this.A0b.A06())) {
            View.OnClickListener onClickListener = new View$OnClickListenerC1430cl(this);
            this.A0Z.setCTAClickListener(onClickListener);
            if (this.A0b.A0B() != null) {
                View.OnClickListener onClickListener2 = new View$OnClickListenerC1431cm(this);
                this.A0b.A0B().setCTAClickListener(onClickListener2);
            }
        }
        if (this.A0T != null) {
            if (C1123Up.A1L(getAdContextWrapper())) {
                AbstractC1333bC.A00(this.A0T, C1123Up.A1M(getAdContextWrapper()), new View$OnClickListenerC1432cn(this));
                return;
            }
            C1673gi adContextWrapper = getAdContextWrapper();
            if (A0f[6].length() == 10) {
                throw new RuntimeException();
            }
            A0f[7] = "Oiyftodkn5sp5o8TW1yBI7W6XQQ10Nb7";
            if (!C1123Up.A1J(adContextWrapper)) {
                return;
            }
            AbstractC1333bC.A00(this.A0T, C1123Up.A1K(getAdContextWrapper()), new View$OnClickListenerC1433co(this));
        }
    }
    ...
    private void A0U() {
        if (this.A0U != null) {
            YB.A0J(this.A0U);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(AbstractC1386c3.A0A, AbstractC1386c3.A0A);
    ...
    private void A0V() {
        AbstractC1208Yb A0B = this.A0b.A0B();
        if (A0B == null) {
            return;
        }
    ...
    private void A0X() {
        ...
        int videoDuration = this.A0T != null ? ((C0710Ek) this.A0T).getDuration() : 0;
    ...
    private void A0Z(int i) {
        ...
        if (A0w()) {
            ...
            adjacentView = (RelativeLayout) ((C0710Ek) this.A0T).getVideoView();
            ((C0710Ek) this.A0T).A0Z(i);
        } else {
            A0a(i);
            viewGroup = this.A05;
    ...
    private void A0e(ViewGroup viewGroup, View view, AbstractC1208Yb abstractC1208Yb, int i) {
        YB.A0d(this.A03);
    ...
    private void A0f(ViewGroup viewGroup, View view, AbstractC1208Yb abstractC1208Yb, int i) {
        YB.A0J(this.A03);
        YB.A0J(abstractC1208Yb);
        YB.A0J(this.A0Z);
    ...
    public void A0m(String str) {
        ...
        if (AbstractC1124Uq.A02(this.A0b.A06()) || this.A0b.A06().A0E() == null) {
            m3 = new M3(this.A0b.A06(), ka);
        } else {
            m3 = new M3(this.A0b.A06(), this.A0b.A06().A0E(), ka);
        }
        this.A08 = m3;
        this.A08.setOnTouchListener(new View$OnTouchListenerC1423ce(this));
    ...
    public void A0q(boolean z) {
        ...
        if (this.A0T != null) {
            ...
            duration.addUpdateListener(new C1424cf(this));
            AnimatorSet animatorSet = new AnimatorSet();
            animatorSet.setInterpolator(new AccelerateDecelerateInterpolator());
            animatorSet.playTogether(ofFloat, ofFloat2, duration);
            animatorSet.addListener(new C1425cg(this, z));
            if (this.A0T instanceof C0710Ek) {
                ((C0710Ek) this.A0T).A0c(animatorSet, z);
            }
        }
        A0t(this.A0D, true);
        String[] strArr2 = A0f;
    ...
    private void A0r(boolean z) {
        ...
        strArr[1] = "MPMP";
        if (view2 != null && A0w()) {
            C0710Ek c0710Ek = (C0710Ek) this.A0T;
            Iterator<InterfaceC1561eu> it = c0710Ek.getPlugins().iterator();
            while (true) {
                if (!it.hasNext()) {
                    break;
                }
                InterfaceC1561eu next = it.next();
        ...
        this.A0B = new C1402cJ(this.A0b.A06(), this.A0X, this.A0Y, this.A0S, this.A0b.A0C());
        this.A0B.A0I(z);
        ...
        if (!z) {
            ...
            if (this.A0b.A0D() != null) {
                ...
                if (this.A0b.A0B() != null && this.A0b.A05().A29().A0K().A00() > 0) {
                    ...
                    new Handler(Looper.getMainLooper()).postDelayed(new RunnableC1428cj(this), this.A0b.A05().A29().A0K().A00());
                }
            }
        }
    }
    ...
    private boolean A0w() {
        return this.A0T != null && (this.A0T instanceof C0710Ek);
    }
    ...
    public final EnumC0922Mq A1B(String str) {
        EnumC0922Mq enumC0922Mq = EnumC0922Mq.A09;
        if (!A1R()) {
            C1402cJ c1402cJ = this.A0B;
            String[] strArr = A0f;
            if (strArr[0].length() != strArr[4].length()) {
                throw new RuntimeException();
            }
            ...
            strArr2[1] = "9M0w";
            if (c1402cJ != null && this.A0B.A0E() != null) {
    ...
    public final void A1J(E1 e1) {
        super.A1J(e1);
        this.A0b.A06().A0F().AKh(XL.A00(this.A0Q), getResources().getConfiguration().orientation, true, false, AbstractC0925Mt.A0A());
        this.A0P = true;
        A0Z(getResources().getConfiguration().orientation);
        this.A0Z.setVisibility(0);
        A0t(this.A0D, false);
    ...
    public final void A1K(C4A c4a, int i) {
        super.A1K(c4a, i);
        int duration = this.A0T != null ? ((C0710Ek) this.A0T).getDuration() : 0;
    ...
    public final boolean A1P(boolean z) {
        if (A0u()) {
            ...
            if (this.A0T instanceof C0710Ek) {
                C0710Ek simpleVideoView = (C0710Ek) this.A0T;
    ...
    private View getContainerView() {
        if (this.A0T != null && A0w()) {
            return ((C0710Ek) this.A0T).getVideoView();
        }
        return this.A04;
    }
    ...
    private View$OnClickListenerC0871Kr getRegularCtaForEndCard() {
        View$OnClickListenerC0871Kr view$OnClickListenerC0871Kr = new View$OnClickListenerC0871Kr(getAdContextWrapper(), this.A0b.A05().A0w(), this.A0X.A28().A01(), getAdEventManager(), this.A0b.A0C(), (C1618fp) null, this.A0b.A0A(), this.A0X.A2A());
        view$OnClickListenerC0871Kr.setViewShowsOverMedia(true);
        YB.A0K(view$OnClickListenerC0871Kr);
        view$OnClickListenerC0871Kr.setText(this.A0X.A29().A0J().A04());
        YB.A0G(1001, view$OnClickListenerC0871Kr);
        view$OnClickListenerC0871Kr.setCta(this.A0X.A29().A0J(), this.A0X.A2E(), new HashMap(), null);
    ...
    private void setUpBrowserControls(M3 m3) {
        ...
        this.A06.setListener(new C0838Jk(this));
        this.A03.addView(this.A06, layoutParams);
        YB.A0J(this.A07);
        this.A07 = new C1302ah(this.A0b.A06(), null, 16842872);
