...
public abstract class T2 {
    ...
    public static void A04() {
        A00 = new byte[]{2, 6, 10, C8077mf.n, C8077mf.p};
    }
    ...
    public static Bitmap A01(InputStream inputStream, int i, int i2) throws IOException {
        C0894Lo c0894Lo = new C0894Lo(inputStream);
        c0894Lo.mark(8192);
        BitmapFactory.Options options = new BitmapFactory.Options();
        options.inJustDecodeBounds = true;
        BitmapFactory.decodeStream(c0894Lo, null, options);
        c0894Lo.reset();
        if (!c0894Lo.A00()) {
            options.inSampleSize = A00(options, i2, i);
            options.inJustDecodeBounds = false;
            return BitmapFactory.decodeStream(c0894Lo, null, options);
        }
        return BitmapFactory.decodeStream(c0894Lo);
    }
    ...
    public static Bitmap A02(String str, int i, int i2, T8 t8) {
        try {
            ...
            t8.A08().ABC(A03(0, 5, 116), AbstractC1085Td.A1h, new C1086Te(t));
            return null;
        }
    }
}
