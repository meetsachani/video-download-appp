...
public abstract class AbstractC1903kY<T> implements M0<T> {
    ...
    public AbstractC1903kY(String str) {
        this.A00 = str;
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.kY != com.facebook.ads.funnel.FunnelParamType$AbstractFunnelParamType<T> */
    public C0905Lz A04(T t) {
        return new C0905Lz(this, t == null ? A02(0, 4, 35) : t.toString());
    }
