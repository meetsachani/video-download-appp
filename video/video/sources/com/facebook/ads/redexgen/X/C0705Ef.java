...
public class C0705Ef {
    ...
    public static void A02() {
        A04 = new byte[]{101, 113, 96, 109, 107, 88, 76, 93, 80, 86, C8077mf.z, 92, 88, 90, 10, C8077mf.x, 83, 86, 90};
    }
    ...
    public C0705Ef(Spatializer spatializer) {
        this.A02 = spatializer;
        this.A03 = spatializer.getImmersiveAudioLevel() != 0;
    }

    public static C0705Ef A00(Context context) {
        AudioManager audioManager = (AudioManager) context.getSystemService(A01(0, 5, 33));
        if (audioManager == null) {
            return null;
        }
        return new C0705Ef(audioManager.getSpatializer());
    }

    public final void A03(C05879h c05879h, Looper looper) {
        if (this.A00 != null || this.A01 != null) {
            return;
        }
        this.A00 = new C0704Ee(this, c05879h);
    ...
    public final boolean A07(C2248qQ c2248qQ, C2242qI c2242qI) {
        int i;
        if (A01(5, 14, 28).equals(c2242qI.A0W) && c2242qI.A06 == 16) {
            i = 12;
        } else {
            i = c2242qI.A06;
        }
        ...
        if (c2242qI.A0G != -1) {
            int linearChannelCount2 = c2242qI.A0G;
            channelMask.setSampleRate(linearChannelCount2);
        }
        Spatializer spatializer = this.A02;
        AudioAttributes audioAttributes = c2248qQ.A01().A00;
