...
public final class LV extends AbstractC1319ay {
    ...
    public final WeakReference<InterfaceC1322b1> A0A;
    ...
    public LV(C1673gi c1673gi, WeakReference<InterfaceC1322b1> weakReference, int i, String str) {
        this(c1673gi, weakReference, i, false);
        if (C1123Up.A1z(c1673gi)) {
            c1673gi.A02().A0B().AKo(this, str == null ? A02(0, 0, 91) : str, false, true);
            this.A06 = true;
        }
    }

    public LV(C1673gi c1673gi, WeakReference<InterfaceC1322b1> weakReference, int i, boolean z) {
        super(c1673gi);
        ...
        this.A02 = new C0896Lq(this);
        this.A03 = new C1618fp(this, i, new WeakReference(this.A02), this.A09);
        setWebChromeClient(A0G());
        setWebViewClient(A0H());
        getSettings().setSupportZoom(false);
        getSettings().setCacheMode(1);
        addJavascriptInterface(new C1321b0(this, weakReference.get(), this.A03, this.A0B, this.A0C, this.A09), A02(0, 9, 46));
    }
    ...
    public final WebViewClient A0H() {
        return new C1324b3(this.A09, this.A0A, new WeakReference(this.A03), new WeakReference(this.A01), new WeakReference(this.A0C), new WeakReference(this), this.A0D, this.A0E, this.A04);
    }

    public final void A0K() {
        this.A09.A0F().AKq();
        this.A0B.set(true);
        new Handler(Looper.getMainLooper()).post(new C0887Lh(this.A03));
    }
