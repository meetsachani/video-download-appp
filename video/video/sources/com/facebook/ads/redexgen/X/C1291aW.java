...
public final class C1291aW extends ImageView {
    ...
    public final YM A09;
    public final InterfaceC1279aK A0A;

    public C1291aW(C1673gi c1673gi, EnumC1281aM enumC1281aM, AbstractC1847jd abstractC1847jd, View view, YM ym, NativeAdLayout nativeAdLayout, InterfaceC1279aK interfaceC1279aK) {
        super(c1673gi);
        this.A05 = view;
        this.A09 = ym;
        this.A08 = c1673gi;
        this.A06 = nativeAdLayout;
        this.A0A = interfaceC1279aK;
        this.A07 = abstractC1847jd;
        AbstractC1280aL.A02(c1673gi, enumC1281aM);
        A02();
    }
    ...
    private void A02() {
        ...
        this.A01 = new View.OnLayoutChangeListener() { // from class: com.facebook.ads.redexgen.X.aS
            ...
            public final void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                C1291aW.this.A0D(view, i, i2, i3, i4, i5, i6, i7, i8);
            }
        };
        ...
        this.A03.addOnAttachStateChangeListener(new View$OnAttachStateChangeListenerC1290aV(this));
    }
