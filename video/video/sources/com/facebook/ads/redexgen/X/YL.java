...
public abstract class YL {
    ...
    public static Bitmap A00(C1673gi c1673gi, Bitmap bitmap, int i) throws RSRuntimeException {
        RenderScript renderScript = null;
        Allocation allocation = null;
        Allocation output = null;
        ScriptIntrinsicBlur scriptIntrinsicBlur = null;
        try {
            renderScript = RenderScript.create(c1673gi);
    ...
    public static Bitmap A01(C1673gi c1673gi, Bitmap bitmap, int i, int i2) {
        ...
        if (width != 0 && height != 0) {
            ...
            try {
                createBitmap = A00(c1673gi, createBitmap, i);
                if (i2 != 1) {
