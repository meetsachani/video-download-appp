...
public final class DZ extends RelativeLayout implements InterfaceC1561eu {
    ...
    public DZ(C1673gi c1673gi, int i) {
        this(c1673gi, A0E, -12549889, 0, i);
    }

    public DZ(C1673gi c1673gi, int i, int i2) {
        this(c1673gi, i2, -12549889, 0, i);
    }

    public DZ(C1673gi c1673gi, int i, int i2, int i3, int i4) {
        super(c1673gi);
        this.A04 = false;
        this.A01 = -1;
        this.A05 = true;
        this.A0A = new AbstractC0699Dz() { // from class: com.facebook.ads.redexgen.X.33
        ...
        this.A00 = i4;
        this.A06 = new ProgressBar(c1673gi, null, 16842872);
        A08(i2, i3, false);
    ...
    public final void A08(int i, int i2, boolean z) {
        ...
        LayerDrawable layerDrawable = new LayerDrawable(new Drawable[]{gradientDrawable, gradientDrawable3, new ScaleDrawable(gradientDrawable2, JE0.b, 1.0f, -1.0f)});
    ...
    public final void AAv(C0710Ek c0710Ek) {
        this.A03 = c0710Ek;
        c0710Ek.getEventBus().A03(this.A08, this.A09, this.A0A, this.A07);
    }

    @Override // com.facebook.ads.redexgen.X.InterfaceC1561eu
    public final void AKV(C0710Ek c0710Ek) {
        c0710Ek.getEventBus().A04(this.A0A, this.A09, this.A08, this.A07);
        this.A03 = null;
    }
