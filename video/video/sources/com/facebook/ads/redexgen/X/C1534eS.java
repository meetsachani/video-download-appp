...
public final class C1534eS {
    ...
    public final AbstractC1847jd A0d;
    public final NN A0e;
    public final NY A0f;
    public final C0934Nd A0g;
    public final C0943Nm A0h;
    public final C1673gi A0i;
    public final VI A0j;
    public final InterfaceC1214Yh A0k;
    public final View$OnClickListenerC0871Kr A0l;
    public int A06 = 160;
    public int A07 = 130;
    public int A03 = 56;
    public int A04 = 430;
    ...
    public static void A0M() {
        A0n = new byte[]{13, 31, 111, 31, 111, 31, 111, C3307Iz.d0, 55, ED2.a, ED2.a, ED2.a, ED2.a, ED2.a, ED2.a, ED2.a, 91, 84, 101, 91, 89, 78, 83, 76, 83, 78, 67, 117, 121, 123, 56, 112, 119, 117, 115, 116, 121, 121, 125, 56, 119, 114, 101, 56, Byte.MAX_VALUE, QC1.w, 98, 115, 100, 101, 98, Byte.MAX_VALUE, 98, Byte.MAX_VALUE, 119, 122, 56, 112, Byte.MAX_VALUE, QC1.w, Byte.MAX_VALUE, 101, 126, 73, 119, 117, 98, Byte.MAX_VALUE, 96, Byte.MAX_VALUE, 98, 111, 88, 83, 89, 126, 92, 79, 89, 107, C8077mf.q, 110, 94, 79, 88, 88, 83, 78, 85, 82, 73, 111, 88, 94, 68, 94, 81, 88, 79, 124, 89, 92, 77, 73, 88, 79, C8077mf.G, 84, 78, C8077mf.G, 83, 72, 81, 81, C8077mf.y, 13, C8077mf.q, C8077mf.z};
    }
    ...
    public C1534eS(final C1673gi c1673gi, AbstractC1847jd abstractC1847jd, InterfaceC1214Yh interfaceC1214Yh, View$OnClickListenerC0871Kr view$OnClickListenerC0871Kr, Handler handler, VI vi) {
        this.A0i = c1673gi;
        this.A0d = abstractC1847jd;
        this.A0j = vi;
        this.A0h = abstractC1847jd.A2C();
        this.A0g = abstractC1847jd.A29().A0K();
        this.A0k = interfaceC1214Yh;
        this.A0b = handler;
        this.A0f = abstractC1847jd.A29().A0I();
        this.A0e = abstractC1847jd.A28();
        this.A0l = view$OnClickListenerC0871Kr;
        this.A0S = new C7M(c1673gi) { // from class: com.facebook.ads.redexgen.X.1E
            @Override // com.facebook.ads.redexgen.X.C7M, android.view.ViewGroup
            public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
                return false;
            }

            @Override // com.facebook.ads.redexgen.X.C7M, android.view.View
            public final boolean onTouchEvent(MotionEvent motionEvent) {
                return false;
            }
        };
        this.A0P = new RelativeLayout(c1673gi);
        this.A0W = new C1367bk(c1673gi);
        this.A0R = new TextView(c1673gi);
        this.A0M = new ImageView(c1673gi);
    ...
    private ImageView A03() {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: com.facebook.ads.redexgen.X.eO
            ...
            public final void onClick(View view) {
                C1534eS.this.A0b(view);
            }
        });
        if (this.A0l != null && this.A0l.getCtaActionHelper().A06() == null) {
            this.A0l.getCtaActionHelper().A07(new InterfaceC0923Mr() { // from class: com.facebook.ads.redexgen.X.FQ
    ...
    private LinearLayout A06() {
        ...
        arrayList.add(new C1537eV(this.A0i).A02(new C1356bZ(this.A0i, -1, -1, YM.RATINGS)).A04(this.A0f.A0C()).A03(this.A0f.A0B()));
        if (!this.A0f.A09().isEmpty()) {
            try {
                A09 = AbstractC1187Xg.A01(Integer.parseInt(this.A0f.A09()));
            } catch (NumberFormatException unused) {
                A09 = this.A0f.A09();
            }
            arrayList.add(new C1537eV(this.A0i).A02(new C1356bZ(this.A0i, -1, -1, YM.NUCLEUS_GROUP)).A04(A09).A03(this.A0f.A0A()));
        }
        if (!this.A0f.A05().isEmpty()) {
            arrayList.add(new C1537eV(this.A0i).A02(new C1356bZ(this.A0i, -1, -1, YM.DOWNLOAD)).A04(this.A0f.A05()).A03(this.A0f.A06()));
        }
        NY ny = this.A0f;
        if (A0o[2].length() != 29) {
            A0o[2] = "3vpsIj";
            if (!ny.A01().isEmpty()) {
                arrayList.add(new C1537eV(this.A0i).A02(new C1356bZ(this.A0i, -1, -1, YM.NUCLEUS_DURATION)).A04(this.A0f.A01()).A03(this.A0f.A0D()));
            }
            if (!this.A0f.A02().isEmpty()) {
                arrayList.add(new C1537eV(this.A0i).A02(new C1356bZ(this.A0i, -1, -1, YM.GRID_4)).A04(this.A0f.A02()).A03(this.A0f.A03()));
            }
    ...
    private LinearLayout A07(RelativeLayout relativeLayout, View$OnClickListenerC0871Kr view$OnClickListenerC0871Kr) {
        LinearLayout linearLayout = new LinearLayout(this.A0i);
        linearLayout.setOrientation(0);
        linearLayout.setGravity(17);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(3, view$OnClickListenerC0871Kr.getId());
        ...
        linearLayout.setId(View.generateViewId());
        C1356bZ iconView = new C1356bZ(this.A0i, -1, -1, YM.GOOGLE_PLAY_STORE);
    ...
    private RelativeLayout.LayoutParams A0B(C1367bk c1367bk) {
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(14);
        layoutParams.addRule(3, c1367bk.getId());
    ...
    private TextView A0E(RelativeLayout relativeLayout, C1367bk c1367bk) {
        TextView textView = new TextView(this.A0i);
        ...
        textView.setLayoutParams(A0B(c1367bk));
        relativeLayout.addView(textView);
        textView.setId(View.generateViewId());
        return textView;
    }

    private C1367bk A0G(LinearLayout linearLayout) {
        C1367bk c1367bk = new C1367bk(this.A0i);
        c1367bk.setRadius(30);
        YB.A0N(c1367bk, 0);
        LM downloadImageTask = new LM(c1367bk, this.A0i).A04();
        downloadImageTask.A07(this.A0h.A01());
        c1367bk.setLayoutParams(A08(linearLayout));
        c1367bk.setId(View.generateViewId());
        return c1367bk;
    }
    ...
    private void A0I() {
        ...
        if (shouldShowThirdEndCard2 && this.A0g.A00() > 0) {
            ...
            AbstractC1536eU.A01(this.A0i, this.A0M, this.A0g.A00(), this.A0N);
        }
    }
    ...
    private void A0L() {
        ...
        if (parent2 instanceof ViewGroup) {
            this.A0m.set(true);
            this.A0X = new C1402cJ(this.A0i, this.A0d, this.A0j, this.A0b, this.A0k);
    ...
    private void A0Q(RelativeLayout relativeLayout, LinearLayout linearLayout, View$OnClickListenerC0871Kr view$OnClickListenerC0871Kr) {
        this.A0T = AbstractC1283aO.A01(this.A0i, false, this.A0d, this.A0j, this.A0k, EnumC1281aM.A02, AbstractC1280aL.A00(this.A0d));
        YB.A0K(this.A0T);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.setMargins(0, this.A0B, 0, this.A0B);
        layoutParams.addRule(7, view$OnClickListenerC0871Kr.getId());
        layoutParams.addRule(3, linearLayout.getId());
        this.A0T.setLayoutParams(layoutParams);
        relativeLayout.addView(this.A0T);
    }

    private void A0R(RelativeLayout relativeLayout, LinearLayout linearLayout, View$OnClickListenerC0871Kr view$OnClickListenerC0871Kr) {
        this.A0U = AbstractC1283aO.A01(this.A0i, false, this.A0d, this.A0j, this.A0k, EnumC1281aM.A02, EnumC1284aP.A04);
        YB.A0K(this.A0U);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.setMargins(0, this.A0H, 0, this.A0B);
        layoutParams.addRule(5, view$OnClickListenerC0871Kr.getId());
        layoutParams.addRule(3, linearLayout.getId());
        this.A0U.setLayoutParams(layoutParams);
        relativeLayout.addView(this.A0U);
    }

    private void A0S(RelativeLayout relativeLayout, LinearLayout linearLayout, View$OnClickListenerC0871Kr view$OnClickListenerC0871Kr) {
        this.A0V = AbstractC1283aO.A02(this.A0i, EnumC1281aM.A02, this.A0d);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.setMargins(0, this.A0B, 0, this.A0B);
        layoutParams.addRule(5, view$OnClickListenerC0871Kr.getId());
        layoutParams.addRule(3, linearLayout.getId());
    ...
    private void A0T(RelativeLayout relativeLayout, View$OnClickListenerC0871Kr view$OnClickListenerC0871Kr, LinearLayout linearLayout, TextView textView) {
        RelativeLayout.LayoutParams A09 = A09(linearLayout, textView);
        view$OnClickListenerC0871Kr.setIncludeFontPadding(false);
        view$OnClickListenerC0871Kr.setLayoutParams(A09);
        view$OnClickListenerC0871Kr.A0D();
        view$OnClickListenerC0871Kr.setHeight(this.A03);
        view$OnClickListenerC0871Kr.setTextSize(18.0f);
        view$OnClickListenerC0871Kr.setCornerRadiusPx(40);
        view$OnClickListenerC0871Kr.setTextColor(A00(this.A0e.A01().A04()));
        YB.A0V(view$OnClickListenerC0871Kr, YB.A06(this.A0e.A01().A04(), 40));
        ...
        relativeLayout.addView(view$OnClickListenerC0871Kr);
        String[] strArr = A0o;
        if (strArr[7].length() == strArr[5].length()) {
            throw new RuntimeException();
        }
    ...
    private void A0U(View$OnClickListenerC0871Kr view$OnClickListenerC0871Kr) {
        this.A0S.setLayoutManager(new C1743hr(this.A0i, 0, false));
        ...
        this.A0S.setAdapter(new FO(this.A0i, this.A0g.A02(), this.A0H, this.A0S, view$OnClickListenerC0871Kr, i));
    }

    private void A0V(final InterfaceC1533eR interfaceC1533eR) {
        final ImageView imageView = new ImageView(this.A0i);
        imageView.setAdjustViewBounds(true);
        LM lm = new LM(imageView, this.A0i);
        if (!this.A0g.A02().isEmpty()) {
            lm.A06(new InterfaceC1329b8() { // from class: com.facebook.ads.redexgen.X.FR
                @Override // com.facebook.ads.redexgen.X.InterfaceC1329b8
                public final void AE7(C1328b7 c1328b7) {
                    C1534eS.this.A0c(imageView, interfaceC1533eR, c1328b7);
                }
            });
            lm.A07(this.A0g.A02().get(0));
            return;
        }
        interfaceC1533eR.AE9();
    }
    ...
    public final FrameLayout A0W() {
        ...
        this.A0P = A0C();
        if (C1123Up.A1D(this.A0i)) {
            this.A0P.setOnClickListener(new View$OnClickListenerC1531eP(this));
        }
        A0P(this.A0P);
        this.A0O = A06();
        ...
        if (this.A0d.A2T()) {
            ...
            blackBackgroundView.setOnClickListener(new View$OnClickListenerC1532eQ(this));
        ...
        A0V(new InterfaceC1533eR() { // from class: com.facebook.ads.redexgen.X.FX
            @Override // com.facebook.ads.redexgen.X.InterfaceC1533eR
            public final void AE9() {
                C1534eS.this.A0d(linearLayout);
            }
        });
        if (this.A0j != null) {
    ...
    public final void A0a(int i) {
        if (!this.A0m.get()) {
            ...
            if (fo == null) {
                this.A0i.A08().ABC(A0H(16, 11, 8), AbstractC1085Td.A0A, new C1086Te(A0H(72, 42, 15)));
            }
            if (this.A0l != null) {
    ...
    public final /* synthetic */ void A0b(View view) {
        if (this.A0l != null) {
            EnumC0922Mq A0E = this.A0l.A0E(A0H(114, 4, 84));
            if (this.A0d.A2N()) {
                return;
            }
    ...
    public final /* synthetic */ void A0c(ImageView imageView, InterfaceC1533eR interfaceC1533eR, C1328b7 c1328b7) {
