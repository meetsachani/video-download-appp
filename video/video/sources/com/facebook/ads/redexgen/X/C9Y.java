...
public final class C9Y {
    ...
    private int A01(short[] sArr, int i) {
        int minP;
        int maxP;
        int i2 = this.A0H > 4000 ? this.A0H / S92.y : 1;
        int i3 = this.A0G;
        if (A0M[4].length() != 9) {
    ...
    */
    private void A06() {
        int originalOutputFrameCount;
        int i = this.A05;
        float f = this.A0F / this.A0D;
        float f2 = this.A0E * this.A0D;
        int originalOutputFrameCount2 = (f > 1.00001d ? 1 : (f == 1.00001d ? 0 : -1));
        if (originalOutputFrameCount2 <= 0) {
            int originalOutputFrameCount3 = (f > 0.99999d ? 1 : (f == 0.99999d ? 0 : -1));
            if (originalOutputFrameCount3 >= 0) {
                A0D(this.A0A, 0, this.A00);
                this.A00 = 0;
                originalOutputFrameCount = (f2 > 1.0f ? 1 : (f2 == 1.0f ? 0 : -1));
                if (originalOutputFrameCount == 0) {
                    A08(f2, i);
                    return;
                }
                return;
                        ...
                        if (newSampleRate2 < oldSampleRate3 - 1) {
                            while (true) {
                                ...
                                for (int i4 = 0; i4 < oldSampleRate; i4++) {
                                    ...
                                    sArr2[(i5 * oldSampleRate6) + i4] = A05(sArr3, (oldSampleRate7 * newSampleRate2) + i4, i3, i2);
                                }
                            ...
                            if (oldSampleRate11 == i3) {
                                ...
                                AbstractC04543y.A08(oldSampleRate12 == i2);
                                this.A03 = 0;
                            }
                            newSampleRate2++;
                        } else {
