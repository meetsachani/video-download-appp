...
public final class V3 implements AudienceNetworkExportedActivityApi {
    ...
    public static void A01() {
        A01 = new byte[]{-17, -12, -6, 5, -8, -4, 5, -25, -10, -10, 5, -11, -8, -17, -21, -12, -6, -25, -6, -17, -11, -12, 5, -15, -21, -1, -44, -43, -45, -32, C2638Cg0.q7, C2638Cg0.s7, -32, C2638Cg0.w7, C2638Cg0.s7, -32, -52, C2638Cg0.t7, C2638Cg0.B7};
    }
    ...
    private boolean A03(V2 v2) {
        ...
        A02(12);
        if (v2.A00 instanceof C1788id) {
            ((C1788id) v2.A00).A0F().A0F().AHu();
        }
        if (v2.A00 instanceof C1784iZ) {
            InterfaceC0899Lt A0F = ((C1784iZ) v2.A00).A0H().A0F();
            if (A02[6].charAt(24) != 'N') {
                String[] strArr3 = A02;
    ...
    public final void onCreate(Bundle bundle) {
        C1673gi A05 = C1046Rp.A05(this.A00, UUID.randomUUID().toString());
        ...
        if (A04 != null && (og instanceof C1784iZ)) {
            boolean A03 = A03(A04);
            String[] strArr2 = A02;
            ...
            C1784iZ c1784iZ = (C1784iZ) og;
            c1784iZ.A0G().A01().A0J(this.A00);
            c1784iZ.A0M(this.A00.getIntent().getIntExtra(A00(0, 26, 101), -1), 0L);
        } else if (A04 != null && (og instanceof C1788id)) {
            if (!A03(A04)) {
                return;
            }
            C1788id c1788id = (C1788id) og;
            c1788id.A0E().A05().A0J(this.A00);
            c1788id.A0J();
        } else {
            A05.A0F().AII();
            A02(13);
