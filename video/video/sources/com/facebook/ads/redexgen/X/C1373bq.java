...
public final class C1373bq extends LinearLayout {
    ...
    public static void A01() {
        A04 = new byte[]{31, C8077mf.D, C8077mf.D, C8077mf.E, 10, 31, C8077mf.A, C8077mf.u, 13};
    }
    ...
    public C1373bq(C1673gi c1673gi, C0931Na c0931Na, boolean z, int i, int i2, int i3) {
        super(c1673gi);
        setOrientation(1);
    ...
    */
    public C1373bq(C1673gi c1673gi, C0931Na c0931Na, boolean z, boolean z2, boolean z3) {
        this(c1673gi, c0931Na, z, r4, r5, z3 ? r6 / 2 : r6);
        int i = z2 ? 18 : 22;
        int i2 = z2 ? 14 : 16;
        int i3 = A07;
    }
    ...
    public final void A03(C0931Na c0931Na, boolean z) {
        this.A02.setTextColor(c0931Na.A07(z));
        this.A01.setTextColor(c0931Na.A05(z));
        this.A00.setTextColor(c0931Na.A06(z));
    }
    ...
    public void setCTAClickListener(View$OnClickListenerC0871Kr view$OnClickListenerC0871Kr) {
        View$OnClickListenerC1376bt A03 = AbstractC1377bu.A03(view$OnClickListenerC0871Kr, A00(0, 9, 20));
