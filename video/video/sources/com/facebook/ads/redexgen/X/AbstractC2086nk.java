...
public abstract class AbstractC2086nk {
    ...
    public static void A09() {
        A00 = new byte[]{65, 89, 95, 88, C8077mf.n, 78, 73, C8077mf.n, 92, 67, 91, 73, 94, C8077mf.n, 67, 74, C8077mf.n, C8077mf.H, C8077mf.n, 78, 73, 88, 91, 73, 73, 66, C8077mf.n, C8077mf.H, 114, C8077mf.G, C8077mf.n, 77, 66, 72, C8077mf.n, C8077mf.H, 114, 31, 28, C8077mf.z, C8077mf.n};
    }
    ...
    public static int A01(int expectedSize) {
        return Math.max(4, AbstractC2119oI.A01(expectedSize + 1, 1.0d));
    }
    ...
    public static int A05(Object table, int index) {
        if (table instanceof byte[]) {
            ...
            return ((short[]) table)[index] & Xx2.Y0;
        } else {
    ...
    public static int A06(@CheckForNull Object key, @CheckForNull Object value, @CheckForNull int mask, Object table, int[] entries, Object[] keys, Object[] values) {
        int tableIndex = AbstractC2119oI.A02(key);
