...
public abstract class AbstractC2258qa {
    ...
    public static void A01() {
        A00 = new byte[]{108, 96, 99, 99, 106, 108, 123, 102, 96, 97, C8077mf.D, C8077mf.z, 9, 0, 54, 31, 81, 87, 87, 87, 80, 123, 96, 121, 121, 53, 118, 116, 123, 123, 122, 97, 53, 119, 112, 53, 118, 116, 102, 97, 53, 97, 122, 53, 123, 122, 123, 56, 123, 96, 121, 121, 53, 97, 108, 101, 112, 53, 126, 122, 97, 121, 124, 123, 59, 84, 103, 103, 116, 108, C3307Iz.a0, 126, 122, 97, 121, 124, 123, 59, 84, 123, 108, 42, C3307Iz.c0};
    }
    ...
    public static final Object[] A02(Collection<?> collection) {
        C2256qY.A09(collection, A00(0, 10, 17));
        ...
        while (true) {
            ...
            if (i2 >= objArr.length) {
                ...
                C2256qY.A08(copyOf, A00(10, 11, 103));
                return copyOf;
            } else {
                i = i2;
            }
            ...
            if (size == 0) {
                ...
                if (!it.hasNext()) {
                    ...
                    if (size <= length) {
                        ...
                        C2256qY.A07(newInstance, A00(21, 62, 11));
