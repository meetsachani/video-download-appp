...
public class C2C<K, V> extends BO<Map.Entry<K, V>> {
    ...
    public final transient AbstractC2134oX<K, V> A02;
    ...
    public C2C(AbstractC2134oX<K, V> map, Object[] alternatingKeysAndValues, int keyOffset, int size) {
        this.A02 = map;
