...
public final class C1490dj extends RelativeLayout {
    ...
    public C1490dj(C1673gi c1673gi, C0943Nm c0943Nm, NY ny, View$OnClickListenerC0871Kr view$OnClickListenerC0871Kr, String str, View.OnClickListener onClickListener) {
        super(c1673gi);
        this.A04 = c1673gi;
        this.A03 = c0943Nm;
        this.A02 = ny;
        ...
        this.A06 = new C1373bq(this.A04, C0931Na.A01(null), true, false, true);
        A00();
    }

    private void A00() {
        AbstractC1374br.A00(this.A04, this, this.A03.A01());
