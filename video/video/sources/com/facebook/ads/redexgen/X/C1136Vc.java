...
public final class C1136Vc implements NativeAdRatingApi {
    ...
    public static void A02() {
        byte[] bArr = {C8077mf.x, 4, 2, 13, 6, -68, -89, -78, -69, -85};
        if (A03[0].length() == 23) {
    ...
    public C1136Vc(double d, double d2) {
        this.A01 = d;
        this.A00 = d2;
    }

    public static C1136Vc A00(JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        ...
        return new C1136Vc(optDouble, optDouble2);
    }
