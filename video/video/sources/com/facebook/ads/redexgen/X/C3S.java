...
public final class C3S extends ED {
    ...
    public C3S(C1673gi c1673gi) {
        this(c1673gi, false);
    }

    public C3S(C1673gi c1673gi, boolean z) {
        super(c1673gi);
        ImageView.ScaleType scaleType;
        int color;
        this.A03 = new C0676Dc(this);
        this.A02 = new C0675Db(this);
        this.A01 = c1673gi;
    ...
    public void setImage(String str, InterfaceC1329b8 interfaceC1329b8) {
        if (str == null) {
            setVisibility(8);
            return;
        }
        ...
        if (interfaceC1329b8 != null) {
            downloadImageTask.A06(interfaceC1329b8);
        }
