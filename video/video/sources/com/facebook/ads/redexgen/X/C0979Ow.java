...
public final class C0979Ow extends AbstractC1336bF {
    ...
    public C0979Ow(C1673gi c1673gi, int i, C0931Na c0931Na, boolean z, String str, VA va, InterfaceC1214Yh interfaceC1214Yh, C1618fp c1618fp, Y2 y2, C0937Ng c0937Ng) {
        super(c1673gi, null, i, c0931Na, z, str, va, interfaceC1214Yh, c1618fp, y2, c0937Ng, false, "");
        setOrientation(0);
    ...
    private LinearLayout A00(int i) {
        ...
        linearLayout.addView(this.A01, AbstractC1336bF.A0B);
        linearLayout.addView(this.A00, AbstractC1336bF.A0B);
    ...
    public void setInfo(NY ny, C0933Nc c0933Nc, String str, String str2, InterfaceC1188Xh interfaceC1188Xh, InterfaceC1351bU interfaceC1351bU) {
        ...
        if (TextUtils.isEmpty(c0933Nc.A04())) {
            YB.A0H(this.A08);
        }
    }
}
