...
public final class C04182m {
    ...
    public final C04182m A00(int i) {
        AbstractC04543y.A08(!this.A00);
        this.A01.append(i, true);
        return this;
    }

    public final C04182m A01(int i, boolean z) {
        if (z) {
            C04182m A00 = A00(i);
            if (A02[6].length() != 11) {
    ...
    */
    public final C04182m A02(C04192n c04192n) {
        for (int i = 0; i < i; i++) {
            int i2 = c04192n.A01(i);
            A00(i2);
        }
        return this;
    }

    public final C04182m A03(int... iArr) {
        for (int i : iArr) {
            A00(i);
        }
        return this;
    ...
    public final C04192n A04() {
        AbstractC04543y.A08(!this.A00);
        this.A00 = true;
        return new C04192n(this.A01);
    }
}
