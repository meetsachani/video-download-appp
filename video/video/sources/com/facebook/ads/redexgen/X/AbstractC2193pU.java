...
public abstract class AbstractC2193pU {
    ...
    public static <E> ArrayList<E> A05(Iterator<? extends E> elements) {
        ...
        AbstractC2172p9.A0A(list, elements);
        return list;
    }

    public static boolean A06(@CheckForNull List<?> thisList, Object other) {
        if (other == AbstractC1912ki.A04(thisList)) {
            return true;
        }
        if (other instanceof List) {
            ...
            if (A00[7].charAt(4) != 'F') {
                ...
                return AbstractC2172p9.A0F(thisList.iterator(), list.iterator());
            }
            throw new RuntimeException();
        }
        return false;
