...
public class C1701hA extends PS {
    ...
    public final Object A04(ViewGroup viewGroup, int i) {
        ...
        if (adViewProvider != null) {
            ...
            type = this.A01.A02;
            if (type != null) {
                c1673gi2 = this.A01.A06;
                type2 = this.A01.A02;
                nativeAdViewAttributes2 = this.A01.A03;
                adView = NativeAdView.render(c1673gi2, this.A00.get(i), type2, nativeAdViewAttributes2);
            } else {
                c1673gi = this.A01.A06;
                nativeAdViewAttributes = this.A01.A03;
                adView = NativeAdView.render(c1673gi, this.A00.get(i), nativeAdViewAttributes);
            }
        }
