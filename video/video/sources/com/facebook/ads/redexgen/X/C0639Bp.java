...
public final class C0639Bp<F, T> extends AbstractC2244qK<F> implements Serializable {
    ...
    public final InterfaceC1893kO<F, ? extends T> A00;
    public final AbstractC2244qK<T> A01;
    ...
    public static void A01() {
        A02 = new byte[]{78, 122, 59, 58, 6, 49, C3307Iz.Z, C3307Iz.V, 56, 32, C8077mf.E, 50, 124};
    }
    ...
    public final boolean equals(@CheckForNull Object object) {
        ...
        if (object instanceof C0639Bp) {
            C0639Bp c0639Bp = (C0639Bp) object;
            return this.A00.equals(c0639Bp.A00) && this.A01.equals(c0639Bp.A01);
        }
        return false;
    }
    ...
    public C0639Bp(InterfaceC1893kO<F, ? extends T> function, AbstractC2244qK<T> ordering) {
        this.A00 = (InterfaceC1893kO) AbstractC1912ki.A04(function);
        this.A01 = (AbstractC2244qK) AbstractC1912ki.A04(ordering);
    }
    ...
    public final int compare(@ParametricNullness F left, @ParametricNullness F right) {
        return this.A01.compare(this.A00.A4B(left), this.A00.A4B(right));
    }
