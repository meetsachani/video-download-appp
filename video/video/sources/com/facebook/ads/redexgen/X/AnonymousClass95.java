...
public final class AnonymousClass95 {
    ...
    public AnonymousClass95(AnonymousClass93 anonymousClass93) {
        this.A0V = (AnonymousClass93) AbstractC04543y.A01(anonymousClass93);
        if (C5C.A02 >= 18) {
            try {
    ...
    private void A07(long j) {
        AnonymousClass92 anonymousClass92 = (AnonymousClass92) AbstractC04543y.A01(this.A0O);
    ...
    private void A08(long j) {
        if (this.A0R && this.A0P != null && j - this.A09 >= C6118ei0.r2) {
            try {
                this.A0E = (((Integer) C5C.A0f((Integer) this.A0P.invoke(AbstractC04543y.A01(this.A0N), new Object[0]))).intValue() * 1000) - this.A06;
    ...
    private void A09(long j) {
        ...
        int playState = ((AudioTrack) AbstractC04543y.A01(this.A0N)).getPlayState();
        if (playState == 1) {
            return;
        }
    ...
    private boolean A0A() {
        return this.A0T && ((AudioTrack) AbstractC04543y.A01(this.A0N)).getPlayState() == 2 && A00() == 0;
    }
    ...
    public final long A0D(boolean z) {
        long A0Q;
        if (((AudioTrack) AbstractC04543y.A01(this.A0N)).getPlayState() == 3) {
            A04();
        }
    ...
    public final void A0F() {
        ((AnonymousClass92) AbstractC04543y.A01(this.A0O)).A05();
    }
    ...
    public final boolean A0J() {
        return ((AudioTrack) AbstractC04543y.A01(this.A0N)).getPlayState() == 3;
    }
    ...
    public final boolean A0M(long j) {
        return this.A08 != C10323vs.b && j > 0 && SystemClock.elapsedRealtime() - this.A08 >= 200;
    }
