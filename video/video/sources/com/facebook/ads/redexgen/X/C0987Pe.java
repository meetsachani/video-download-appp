...
public final class C0987Pe extends AbstractC1208Yb {
    ...
    public int A00;
    public InterfaceC1212Yf A01;
    public float A02;
    public InterfaceC1207Ya A03;
    public boolean A04;
    public final C1673gi A05;
    public final C1211Ye A06;
    public final EnumC1213Yg A07;
    ...
    public C0987Pe(C1673gi c1673gi, EnumC1213Yg enumC1213Yg, AbstractC1847jd abstractC1847jd, int i, InterfaceC1212Yf interfaceC1212Yf) {
        super(c1673gi);
        this.A00 = 0;
        this.A04 = true;
        this.A05 = c1673gi;
        this.A07 = enumC1213Yg;
        this.A01 = interfaceC1212Yf;
        A04();
        this.A06 = new C1211Ye(this.A05, abstractC1847jd, this.A07, i);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-2, -2);
        layoutParams.gravity = 48;
        this.A06.setContentDescription(A03(0, 8, 81));
        this.A06.setOnClickListener(new View$OnClickListenerC1210Yd(this));
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: com.facebook.ads.redexgen.X.Yc
                ...
                public final WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
                    return C0987Pe.this.A0F(view, windowInsets);
                }
            });
        }
    }
    ...
    public final void A0G() {
        if (this.A03 != null && this.A04) {
            InterfaceC1207Ya interfaceC1207Ya = this.A03;
    ...
    private void setClickable(float f) {
        boolean z;
        if (f > 0.0f) {
            boolean A19 = C1123Up.A19(this.A05);
            if (A09[4].charAt(19) != 'Q') {
                throw new RuntimeException();
            }
