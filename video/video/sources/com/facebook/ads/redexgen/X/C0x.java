...
public final class C0x extends C1F implements InterfaceC1508e2 {
    ...
    public int A02;
    public int A03;
    public InterfaceC1225Ys A04;
    public boolean A05;
    public final C05296v A06;
    ...
    public C0x(C1673gi c1673gi) {
        ...
        this.A00 = 0;
        this.A05 = false;
        this.A06 = new C05296v(c1673gi, new C1506e0(), new C1505dz());
        A02();
    }

    public C0x(C1673gi c1673gi, AttributeSet attributeSet) {
    ...
    public C0x(C1673gi c1673gi, AttributeSet attributeSet, int i) {
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC1508e2
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (this.A05) {
            int i3 = (int) XX.A02;
            int verticalPadding = C1123Up.A0F(getContext());
        ...
        if (this.A05) {
            int verticalPadding5 = C1220Yn.A09;
    ...
    public void setAdapter(AbstractC1021Qq abstractC1021Qq) {
        this.A06.A2J(abstractC1021Qq == null ? -1 : abstractC1021Qq.hashCode());
        super.setAdapter(abstractC1021Qq);
    }
    ...
    public void setChildWidth(int i) {
        ...
        C05296v c05296v = this.A06;
        int pageWidth3 = this.A01;
        c05296v.A2K((i3 - pageWidth3) / 2);
        C05296v c05296v2 = this.A06;
        int pageWidth4 = this.A01;
        c05296v2.A2I(pageWidth4 / measuredWidth);
    }
    ...
    public void setOnPageChangedListener(InterfaceC1225Ys interfaceC1225Ys) {
        this.A04 = interfaceC1225Ys;
    }
