...
public final class C0930My {
     ...
     */
    @Nullable
    public static C0930My A00(@Nullable JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        ...
        return new C0930My(optString, optString2, optString3, arrayList, jSONObject.optString(A01(40, 10, 127)), jSONObject.optString(A01(18, 12, 5)));
    }
    ...
    public static void A02() {
        byte[] bArr = {-118, -103, -103, -100, -110, -99, -114, -24, -9, -9, -6, -16, -5, -20, -26, -4, -7, -13, -113, -118, -107, -107, -117, -118, -116, -108, -120, -98, -101, -107, -89, -95, -75, -101, -92, -99, -81, -92, -95, -81, C8077mf.r, 4, C8077mf.y, C8077mf.p, 8, C8077mf.A, 2, C8077mf.B, C8077mf.y, C8077mf.n, 6, -9, -7, 1, -9, -3, -5};
        if (A07[3].length() != 8) {
            throw new RuntimeException();
        }
    ...
    public C0930My(String str, String str2, String str3, List<String> mKeyHashes, String str4, String str5) {
        this.A04 = str;
        this.A01 = str2;
        this.A00 = str3;
        this.A05 = mKeyHashes;
