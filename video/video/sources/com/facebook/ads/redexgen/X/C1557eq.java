...
public final class C1557eq extends RelativeLayout {
    ...
    public int A00;
    public C3S A01;
    public WeakReference<InterfaceC1556ep> A02;
    public final InterfaceC1613fk A03;

    public C1557eq(C1673gi c1673gi, InterfaceC1613fk interfaceC1613fk) {
        super(c1673gi);
        this.A00 = 0;
        this.A03 = interfaceC1613fk;
    ...
    private void A00(AnimatorSet animatorSet, final int i, final boolean z) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.facebook.ads.redexgen.X.em
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                C1557eq.this.A04(z, i, valueAnimator);
            }
        });
    ...
    public final void A01(AnimatorSet animatorSet, boolean z) {
        if (z) {
            ...
            C1554en c1554en = new C1554en(this);
            this.A03.getView().setOutlineProvider(c1554en);
            if (this.A01 != null) {
                this.A01.setClipToOutline(true);
                this.A01.setOutlineProvider(c1554en);
            }
    ...
    public final void onMeasure(int i, int i2) {
        ...
        WeakReference<InterfaceC1556ep> weakReference = this.A02;
    ...
    public void setRoundedCornersVideoStyle(float f) {
        this.A03.getView().setClipToOutline(true);
        this.A03.getView().setOutlineProvider(new C1555eo(this, f));
    }

    public void setViewImplInflationListener(InterfaceC1556ep interfaceC1556ep) {
        this.A02 = new WeakReference<>(interfaceC1556ep);
    }
}
