...
public abstract class AdComponentFrameLayout extends FrameLayout implements AdComponentView {
    ...
    public AdComponentFrameLayout(Context context, @InterfaceC11300zs1 AttributeSet attributeSet) {
    ...
    public AdComponentFrameLayout(Context context, @InterfaceC11300zs1 AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        this.mAdComponentViewParentApi = new a();
    }

    @ES1(api = 21)
    public AdComponentFrameLayout(Context context, @InterfaceC11300zs1 AttributeSet attributeSet, int i, int i2) {
