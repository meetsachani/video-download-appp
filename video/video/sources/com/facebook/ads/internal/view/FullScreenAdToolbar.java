...
import com.facebook.ads.redexgen.X.AbstractC1208Yb;
import com.facebook.ads.redexgen.X.AbstractC1377bu;
import com.facebook.ads.redexgen.X.C0931Na;
import com.facebook.ads.redexgen.X.C0943Nm;
import com.facebook.ads.redexgen.X.C0949Ns;
import com.facebook.ads.redexgen.X.C1510e4;
import com.facebook.ads.redexgen.X.C1673gi;
import com.facebook.ads.redexgen.X.InterfaceC1207Ya;
import com.facebook.ads.redexgen.X.InterfaceC1214Yh;
import com.facebook.ads.redexgen.X.VI;
import com.facebook.ads.redexgen.X.View$OnClickListenerC0871Kr;
import com.facebook.ads.redexgen.X.View$OnClickListenerC1223Yq;
...
import com.facebook.ads.redexgen.X.ZC;
import com.facebook.ads.redexgen.X.ZK;
import java.util.Arrays;

/* loaded from: assets/audience_network/classes2.dex */
public final class FullScreenAdToolbar extends AbstractC1208Yb {
    ...
    public FullScreenAdToolbar(C1673gi c1673gi, InterfaceC1214Yh interfaceC1214Yh, VI vi, int i, int i2, boolean z) {
        super(c1673gi);
        this.A01 = null;
        this.A04 = true;
        this.A05 = z;
        ...
        this.A07 = vi;
        setGravity(16);
        this.A09 = new ZK(c1673gi, i, z);
        this.A09.setContentDescription(A02(0, 8, 24));
        this.A09.setActionClickListener(new View$OnClickListenerC1223Yq(this));
        if (!this.A05) {
    ...
    public final void A0D(C0931Na c0931Na, boolean z) {
        boolean z2 = this.A04;
        int A05 = c0931Na.A05(z2);
        this.A0A.A02(c0931Na.A0B(z2), A05);
        boolean z3 = this.A05;
    ...
    public final void A0F(C0943Nm c0943Nm, String str, int i) {
        this.A09.setInitialUnskippableSeconds(i);
        if (this.A05) {
            if (this.A03 != null) {
                this.A03.setAdDetails(c0943Nm, str, this.A07, this.A08);
            }
        } else if (this.A00 == null) {
        } else {
            this.A00.setAdDetails(c0943Nm, str, this.A07, this.A08);
        }
    }

    public final void A0G(C1673gi c1673gi, int i) {
        if (this.A00 != null) {
            YB.A0J(this.A00);
        ...
        if (!this.A05) {
            this.A00 = new YZ(c1673gi, i);
            layoutParams.setMargins(0, A0H / 2, A0H / 2, A0H / 2);
            addView(this.A00, layoutParams);
            return;
        }
        this.A03 = new ZC(c1673gi);
        layoutParams.setMargins(A0F, A0F, A0G, A0F);
    ...
    public void setCTAClickListener(View$OnClickListenerC0871Kr view$OnClickListenerC0871Kr) {
        this.A0A.setOnClickListener(AbstractC1377bu.A03(view$OnClickListenerC0871Kr, A02(17, 7, 47)));
    }
    ...
    public void setOnlyPageDetails(C0943Nm c0943Nm) {
        if (c0943Nm != null) {
            this.A0A.setPageDetails(c0943Nm);
        } else {
            this.A0A.A01();
        }
    }
