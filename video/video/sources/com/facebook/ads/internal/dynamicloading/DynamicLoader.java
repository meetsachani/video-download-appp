...
public interface DynamicLoader {
    AdOptionsViewApi createAdOptionsView(Context context, NativeAdBase nativeAdBase, @InterfaceC11300zs1 NativeAdLayout nativeAdLayout, AdOptionsView.Orientation orientation, int i, AdOptionsView adOptionsView);

    AdOptionsViewApi createAdOptionsView(Context context, NativeAdBase nativeAdBase, @InterfaceC11300zs1 NativeAdLayout nativeAdLayout, AdOptionsView adOptionsView);
    ...
    NativeAdScrollViewApi createNativeAdScrollViewApi(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, @InterfaceC11300zs1 NativeAdScrollView.AdViewProvider adViewProvider, int i, @InterfaceC11300zs1 NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes, int i2);
