...
public class NativeAdView {
    ...
    public static View render(Context context, NativeAd nativeAd, @InterfaceC11300zs1 NativeAdViewAttributes nativeAdViewAttributes) {
        Preconditions.checkNotNull(context, "context must be not null");
        Preconditions.checkNotNull(nativeAd, "nativeAd must be not null");
    ...
    @Deprecated
    public static View render(Context context, NativeAd nativeAd, Type type, @InterfaceC11300zs1 NativeAdViewAttributes nativeAdViewAttributes) {
        Preconditions.checkNotNull(context, "context must be not null");
        Preconditions.checkNotNull(nativeAd, "nativeAd must be not null");
