...
public final class TextInformationFrame extends Id3Frame {
    ...
    public static void A01() {
        byte[] bArr = {-99, -125, C2638Cg0.u7, -56, -42, C2638Cg0.t7, -43, -52, -45, -41, -52, -46, -47, -96, -33, C2638Cg0.s7, C8077mf.E, 6, 17, C8077mf.D, 10, C8077mf.B, -30};
        String[] strArr = A04;
    ...
    public TextInformationFrame(Parcel parcel) {
        this((String) AbstractC04543y.A01(parcel.readString()), parcel.readString(), C1840jW.A02((String[]) AbstractC04543y.A01(parcel.createStringArray())));
    }
    ...
    public TextInformationFrame(String str, String str2, List<String> values) {
        super(str);
        AbstractC04543y.A07(!values.isEmpty());
        this.A00 = str2;
        this.A02 = C1840jW.A02((String[]) values.toArray(new String[0]));
