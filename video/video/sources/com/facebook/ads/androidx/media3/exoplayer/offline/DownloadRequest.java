...
import com.facebook.ads.redexgen.X.C7;
...
public final class DownloadRequest implements Parcelable {
    ...
    public static void A01() {
        A07 = new byte[]{-37, 36, 54, 52, 53, 48, C3307Iz.f0, 4, 34, 36, C3307Iz.a0, C3307Iz.Y, C8077mf.n, C3307Iz.Y, 58, C2638Cg0.C7, C3307Iz.f0, 54, 52, 53, C2638Cg0.C7, 35, C3307Iz.Y, C2638Cg0.C7, 47, 54, C3307Iz.e0, C3307Iz.e0, C2638Cg0.C7, C3307Iz.Z, 48, 51, C2638Cg0.C7, 53, 58, 49, C3307Iz.Y, -5, C2638Cg0.C7};
    }
    ...
    public DownloadRequest(String str, Uri uri, String str2, List<StreamKey> list, byte[] bArr, String str3, byte[] bArr2) {
        ...
        if (A0B == 0 || A0B == 2 || A0B == 1) {
            AbstractC04543y.A09(str3 == null, A00(1, 38, 126) + A0B);
        }
        this.A02 = str;
        this.A00 = uri;
        this.A03 = str2;
    ...
    */
    public final DownloadRequest A02(DownloadRequest downloadRequest) {
        List emptyList;
        AbstractC04543y.A07(this.A02.equals(downloadRequest.A02));
