...
import com.facebook.ads.redexgen.X.C04082a;
...
public final class ColorInfo implements AnonymousClass24, Parcelable {
    ...
    public static void A08() {
        A05 = new byte[]{49, 97, 109, 59, C3307Iz.e0, 75, 73, 75, 73, 59, C3307Iz.e0, 79, 73, 72, 62, 40, 75, 76, 69, 32, C8077mf.n, C8077mf.q, C8077mf.n, 17, 42, 13, 5, C8077mf.n, 75, 13, 62, C3307Iz.Z, C3307Iz.Z, 107, 57, 42, C3307Iz.X, C3307Iz.d0, C3307Iz.f0, 71, 97, 109, 109, 97, 32, 50, C3307Iz.f0, 50, 42, C3307Iz.f0, C3307Iz.X, 122, 95, 91, 95, 66, 83, 82, C8077mf.z, 68, 87, 88, 81, 83, 92, 121, 126, 117, 113, 98, 83, 68, 82, 32, 83, 77, 80, 84, 69, 32, 49, 55, 48, 77, C3307Iz.Z, 32, 70, 68, 76, 64, 84, 36, C3307Iz.X, 74, 113, 123, 122, 121, 118, 113, 122, 123, ED2.a, 124, 112, 115, 112, 109, ED2.a, 109, 126, 113, QC1.w, 122, 121, 66, 72, 73, 74, 69, 66, 73, 72, C8077mf.n, 79, 67, 64, 67, 94, C8077mf.n, 95, 92, 77, 79, 73, 47, C8077mf.x, C8077mf.H, 31, 28, 19, C8077mf.x, 31, C8077mf.H, 90, C8077mf.C, C8077mf.y, C8077mf.z, C8077mf.y, 8, 90, C8077mf.p, 8, C8077mf.E, C8077mf.x, 9, 28, 31, 8, 9, 50, 47, 57, 40, 124, ED2.a, 51, 48, 51, C3307Iz.f0, 124, C3307Iz.f0, C4715Xk.i, 50, 59, 57, 90, 97, 124, 106, 123, 47, 108, 96, 99, 96, 125, 47, 124, Byte.MAX_VALUE, 110, 108, 106, 58, 1, 28, 10, C8077mf.E, 79, C8077mf.n, 0, 3, 0, C8077mf.G, 79, C8077mf.E, C8077mf.G, C8077mf.p, 1, 28, 9, 10, C8077mf.G, 1, 32, 53, 48};
    }

    static {
        A08();
        A09 = new ColorInfo(1, 2, 3, null);
        A0A = new C04082a().A01(1).A00(1).A02(2).A03();
    ...
    public final C04082a A0A() {
        return new C04082a(this);
    }
