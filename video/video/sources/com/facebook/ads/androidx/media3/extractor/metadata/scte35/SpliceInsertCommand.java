...
import com.facebook.ads.redexgen.X.IW;
import com.facebook.ads.redexgen.X.IX;
...
public final class SpliceInsertCommand extends SpliceCommand {
    ...
    public static SpliceInsertCommand A00(C04774v c04774v, long j, AnonymousClass53 anonymousClass53) {
        ...
        if (A0D[6].length() != 19) {
            ...
            if (!z) {
                ...
                if (outOfNetworkIndicator && !z3) {
                    j2 = TimeSignalCommand.A00(c04774v, j);
                }
                if (!outOfNetworkIndicator) {
                    int componentCount = c04774v.A0I();
                    emptyList = new ArrayList(componentCount);
                    for (int i4 = 0; i4 < componentCount; i4++) {
                        int componentTag = c04774v.A0I();
                        long j4 = C10323vs.b;
                        if (!z3) {
                            j4 = TimeSignalCommand.A00(c04774v, j);
                        }
                        emptyList.add(new IX(componentTag, j4, anonymousClass53.A06(j4), null));
                    }
                }
                if (autoReturn) {
                    long A0I2 = c04774v.A0I();
                    z4 = (A0I2 & 128) != 0;
                    j3 = (1000 * (((A0I2 & 1) << 32) | c04774v.A0Q())) / 90;
                }
                i = c04774v.A0M();
                i2 = c04774v.A0I();
                i3 = c04774v.A0I();
