...
import com.facebook.ads.redexgen.X.AbstractC2094ns;
import com.facebook.ads.redexgen.X.C2242qI;
import com.facebook.ads.redexgen.X.C3E;
import com.facebook.ads.redexgen.X.C5C;
import com.facebook.ads.redexgen.X.CB;
import com.facebook.ads.redexgen.X.IO;
...
public final class SlowMotionData implements Metadata.Entry {
    ...
    public static final class Segment implements Parcelable {
        ...
        public static void A02() {
            A03 = new byte[]{-28, -10, -8, -2, -10, -1, 5, C2638Cg0.x7, -79, 4, 5, -14, 3, 5, -27, -6, -2, -10, -34, 4, C2638Cg0.z7, -74, -11, -67, -79, -10, -1, -11, -27, -6, -2, -10, -34, 4, C2638Cg0.z7, -74, -11, -67, -79, 4, 1, -10, -10, -11, -43, -6, 7, -6, 4, 0, 3, C2638Cg0.z7, -74, -11};
            if (A04[1].charAt(1) == '9') {
                throw new RuntimeException();
            }
        ...
        static {
            ...
            A05 = new Comparator() { // from class: com.facebook.ads.redexgen.X.IP
                ...
                public final int compare(Object obj, Object obj2) {
                    return SlowMotionData.Segment.A00((SlowMotionData.Segment) obj, (SlowMotionData.Segment) obj2);
                }
            };
            CREATOR = new IQ();
        }
        ...
        public Segment(long j, long j2, int i) {
            AbstractC04543y.A07(j < j2);
            this.A02 = j;
            this.A01 = j2;
            this.A00 = i;
        }

        public static /* synthetic */ int A00(Segment segment, Segment segment2) {
            return AbstractC2094ns.A01().A07(segment.A02, segment2.A02).A07(segment.A01, segment2.A01).A06(segment.A00, segment2.A00).A05();
        }
    ...
    public SlowMotionData(List<Segment> segments) {
        this.A00 = segments;
        AbstractC04543y.A07(!A02(segments));
    }
