...
public class LicenseClient implements ServiceConnection {
    ...
    protected static String licensePubKey = "";
    protected static boolean localCheckEnabled = true;
    protected static ImmediateTaskExecutor mainThreadRunner = null;
    protected static String packageName = "com.hdhub.xdownload.anyvideo.bestdownloader";
    ...
    /* renamed from: $r8$lambda$GS82Fij7VQePgSFog-s63-Rcyb0 */
    public static /* synthetic */ void m8$r8$lambda$GS82Fij7VQePgSFogs63Rcyb0(LicenseClient licenseClient) {
        licenseClient.lambda$initializeLicenseCheck$0();
    }

    /* renamed from: $r8$lambda$gb-vmUiJUmqdCloCudVdY-igh7I */
    public static /* synthetic */ void m9$r8$lambda$gbvmUiJUmqdCloCudVdYigh7I(LicenseClient licenseClient, IBinder iBinder) {
        licenseClient.lambda$onServiceConnected$1(iBinder);
    }

    public static /* synthetic */ void $r8$lambda$heJ2Stw6wCNVkkwCytXyCvBISDM(LicenseClient licenseClient) {
        licenseClient.lambda$scheduleRepeatedLicenseCheck$0();
    }

    /* renamed from: $r8$lambda$ot_XkRbEJeEFG1Hy-d3H6N4DX_I */
    public static /* synthetic */ void m10$r8$lambda$ot_XkRbEJeEFG1Hyd3H6N4DX_I(LicenseClient licenseClient, RepeatedCheckMetadata repeatedCheckMetadata, Bundle bundle) {
    ...
    /* renamed from: $r8$lambda$tTRuJInP7s484yRu-m6AsnoI1z4 */
    public static /* synthetic */ void m11$r8$lambda$tTRuJInP7s484yRum6AsnoI1z4(LicenseClient licenseClient) {
            ...
            if (localCheckEnabled) {
                backgroundRunner.run(new Runnable() { // from class: com.pairip.licensecheck.LicenseClient$$ExternalSyntheticLambda4
                    ...
                    public final void run() {
                        LicenseClient.m8$r8$lambda$GS82Fij7VQePgSFogs63Rcyb0(LicenseClient.this);
                    }
                });
            } else {
        ...
        if (ordinal != 0) {
            if (ordinal == 2) {
                backgroundRunner.run(new Runnable() { // from class: com.pairip.licensecheck.LicenseClient$$ExternalSyntheticLambda6
                    @Override // java.lang.Runnable
                    public final void run() {
                        LicenseClient.m9$r8$lambda$gbvmUiJUmqdCloCudVdYigh7I(LicenseClient.this, licensingServiceBinder);
                    }
                });
                return;
            } else if (ordinal != 4) {
    ...
    private void retryOrThrow(LicenseCheckException error, boolean ignoreErrorOnFinalFailure) {
        ...
        if (i < 3) {
            ...
            this.delayedTaskExecutor.schedule(new Runnable() { // from class: com.pairip.licensecheck.LicenseClient$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    LicenseClient.m11$r8$lambda$tTRuJInP7s484yRum6AsnoI1z4(LicenseClient.this);
                }
            }, 1000L);
    ...
    public void processResponse(int responseCode, final Bundle responsePayload2) {
        try {
            ...
            mainThreadRunner.run(new Runnable() { // from class: com.pairip.licensecheck.LicenseClient$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    LicenseClient.m10$r8$lambda$ot_XkRbEJeEFG1Hyd3H6N4DX_I(LicenseClient.this, repeatedCheckMetadata, responsePayload2);
                }
            });
        } catch (LicenseCheckException e) {
            handleError(e);
    ...
    private void scheduleRepeatedLicenseCheck(RepeatedCheckMetadata repeatedCheckMetadata) {
        ...
        this.delayedTaskExecutor.schedule(new Runnable() { // from class: com.pairip.licensecheck.LicenseClient$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                LicenseClient.$r8$lambda$heJ2Stw6wCNVkkwCytXyCvBISDM(LicenseClient.this);
            }
        }, min);
    ...
    /* loaded from: classes.dex */
    public static class DelayedTaskExecutorImpl implements DelayedTaskExecutor {
