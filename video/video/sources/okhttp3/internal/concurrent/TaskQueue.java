...
public final class TaskQueue {
    ...
    public static /* synthetic */ void execute$default(TaskQueue taskQueue, String str, long j, boolean z, FA0 fa0, int i, Object obj) {
        if ((i & 2) != 0) {
            j = 0;
        }
        if ((i & 4) != 0) {
        ...
        taskQueue.schedule(new TaskQueue$execute$1(str, z, fa0), j);
    }
    ...
    public final void execute(@NotNull String str, long j, boolean z, @NotNull FA0<C7458kA2> fa0) {
        C6562gT0.p(str, "name");
        C6562gT0.p(fa0, "block");
        schedule(new TaskQueue$execute$1(str, z, fa0), j);
    }
    ...
    public final List<Task> getScheduledTasks() {
        List<Task> Y5;
        synchronized (this.taskRunner) {
            Y5 = C10662xF.Y5(this.futureTasks);
        }
        return Y5;
    }
    ...
    public static /* synthetic */ void schedule$default(TaskQueue taskQueue, String str, long j, FA0 fa0, int i, Object obj) {
        if ((i & 2) != 0) {
            j = 0;
        }
        C6562gT0.p(str, "name");
        C6562gT0.p(fa0, "block");
        taskQueue.schedule(new TaskQueue$schedule$2(str, fa0), j);
    }

    public final void schedule(@NotNull String str, long j, @NotNull FA0<Long> fa0) {
        C6562gT0.p(str, "name");
        C6562gT0.p(fa0, "block");
        schedule(new TaskQueue$schedule$2(str, fa0), j);
    }
}
