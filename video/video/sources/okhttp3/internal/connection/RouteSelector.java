...
public final class RouteSelector {
    ...
    public static final class Companion {
        ...
        public final String getSocketHost(@NotNull InetSocketAddress inetSocketAddress) {
            C6562gT0.p(inetSocketAddress, "<this>");
            InetAddress address = inetSocketAddress.getAddress();
            if (address == null) {
                String hostName = inetSocketAddress.getHostName();
                C6562gT0.o(hostName, "hostName");
                return hostName;
            }
            String hostAddress = address.getHostAddress();
            C6562gT0.o(hostAddress, "address.hostAddress");
            return hostAddress;
        }
    ...
    public RouteSelector(@NotNull Address address, @NotNull RouteDatabase routeDatabase, @NotNull Call call, @NotNull EventListener eventListener) {
        ...
        C6562gT0.p(routeDatabase, "routeDatabase");
        ...
        this.proxies = C8222nF.H();
        this.inetSocketAddresses = C8222nF.H();
    ...
    private final void resetNextInetSocketAddress(Proxy proxy) throws IOException {
        ...
        if (proxy.type() != Proxy.Type.DIRECT && proxy.type() != Proxy.Type.SOCKS) {
            ...
            if (address instanceof InetSocketAddress) {
                ...
                C6562gT0.o(address, "proxyAddress");
        ...
        if (1 <= port && port < 65536) {
            ...
            if (Util.canParseAsIpAddress(host)) {
                lookup = C7979mF.k(InetAddress.getByName(host));
            } else {
    ...
    private static final List<Proxy> resetNextProxy$selectProxies(Proxy proxy, HttpUrl httpUrl, RouteSelector routeSelector) {
        ...
        if (list != null && !list.isEmpty()) {
            C6562gT0.o(select, "proxiesOrNull");
    ...
    public final Selection next() throws IOException {
        if (hasNext()) {
            ...
            if (arrayList.isEmpty()) {
                C9444sF.q0(arrayList, this.postponedRoutes);
