...
public final class Exchange {
    ...
    /* loaded from: classes4.dex */
    public final class RequestBodySink extends AbstractC3011Fy0 {
        ...
        public RequestBodySink(@NotNull Exchange exchange, J82 j82, long j) {
            super(j82);
    ...
    /* loaded from: classes4.dex */
    public final class ResponseBodySource extends AbstractC3501Ky0 {
        private long bytesReceived;
        private boolean closed;
        private boolean completed;
        private final long contentLength;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public ResponseBodySource(@NotNull Exchange exchange, InterfaceC7072ia2 interfaceC7072ia2, long j) {
        ...
        public long read(@NotNull C5422bq c5422bq, long j) throws IOException {
            ...
            if (!this.closed) {
                try {
                    long read = delegate().read(c5422bq, j);
    ...
    public Exchange(@NotNull RealCall realCall, @NotNull EventListener eventListener, @NotNull ExchangeFinder exchangeFinder, @NotNull ExchangeCodec exchangeCodec) {
        ...
        C6562gT0.p(exchangeFinder, "finder");
        C6562gT0.p(exchangeCodec, "codec");
        this.call = realCall;
    ...
    @NotNull
    public final J82 createRequestBody(@NotNull Request request, boolean z) throws IOException {
    ...
    public final boolean isCoalescedConnection$okhttp() {
        return !C6562gT0.g(this.finder.getAddress$okhttp().url().host(), this.connection.route().address().url().host());
    }
    ...
    public final ResponseBody openResponseBody(@NotNull Response response) throws IOException {
        ...
        try {
            ...
            return new RealResponseBody(header$default, reportedContentLength, C9604su1.e(new ResponseBodySource(this, this.codec.openResponseBodySource(response), reportedContentLength)));
        } catch (IOException e) {
            this.eventListener.responseFailed(this.call, e);
            trackFailure(e);
            throw e;
