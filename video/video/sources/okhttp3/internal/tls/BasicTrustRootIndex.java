...
public final class BasicTrustRootIndex implements TrustRootIndex {
    ...
    public BasicTrustRootIndex(@NotNull X509Certificate... x509CertificateArr) {
        ...
        for (X509Certificate x509Certificate : x509CertificateArr) {
            ...
            C6562gT0.o(subjectX500Principal, "caCert.subjectX500Principal");
    ...
    public boolean equals(@Nullable Object obj) {
        if (obj != this) {
            if (!(obj instanceof BasicTrustRootIndex) || !C6562gT0.g(((BasicTrustRootIndex) obj).subjectToCaCerts, this.subjectToCaCerts)) {
                return false;
            }
            return true;
        }
