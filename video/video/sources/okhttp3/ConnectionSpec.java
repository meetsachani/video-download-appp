...
public final class ConnectionSpec {
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z) {
        ...
        if (this.cipherSuitesAsString != null) {
            ...
            C6562gT0.o(enabledCipherSuites2, "sslSocket.enabledCipherSuites");
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            C6562gT0.o(enabledProtocols2, "sslSocket.enabledProtocols");
            enabledProtocols = Util.intersect(enabledProtocols2, this.tlsVersionsAsString, C11156zH.q());
        } else {
            enabledProtocols = sSLSocket.getEnabledProtocols();
        }
        String[] supportedCipherSuites = sSLSocket.getSupportedCipherSuites();
        C6562gT0.o(supportedCipherSuites, "supportedCipherSuites");
        int indexOf = Util.indexOf(supportedCipherSuites, "TLS_FALLBACK_SCSV", CipherSuite.Companion.getORDER_BY_NAME$okhttp());
        if (z && indexOf != -1) {
            C6562gT0.o(enabledCipherSuites, "cipherSuitesIntersection");
            String str = supportedCipherSuites[indexOf];
            C6562gT0.o(str, "supportedCipherSuites[indexOfFallbackScsv]");
        ...
        C6562gT0.o(enabledProtocols, "tlsVersionsIntersection");
        return cipherSuites.tlsVersions((String[]) Arrays.copyOf(enabledProtocols, enabledProtocols.length)).build();
    }

    @InterfaceC8046mW0(name = "-deprecated_cipherSuites")
    @InterfaceC9150r20(level = EnumC9879u20.Y, message = "moved to val", replaceWith = @IR1(expression = "cipherSuites", imports = {}))
    @Nullable
    ...
    @InterfaceC8046mW0(name = "-deprecated_supportsTlsExtensions")
    @InterfaceC9150r20(level = EnumC9879u20.Y, message = "moved to val", replaceWith = @IR1(expression = "supportsTlsExtensions", imports = {}))
    /* renamed from: -deprecated_supportsTlsExtensions  reason: not valid java name */
    public final boolean m46deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }

    @InterfaceC8046mW0(name = "-deprecated_tlsVersions")
    @InterfaceC9150r20(level = EnumC9879u20.Y, message = "moved to val", replaceWith = @IR1(expression = "tlsVersions", imports = {}))
    @Nullable
    ...
    @InterfaceC8046mW0(name = "cipherSuites")
    @Nullable
    ...
    public final boolean isCompatible(@NotNull SSLSocket sSLSocket) {
        C6562gT0.p(sSLSocket, "socket");
        if (!this.isTls) {
            return false;
        }
        String[] strArr = this.tlsVersionsAsString;
        if (strArr != null && !Util.hasIntersection(strArr, sSLSocket.getEnabledProtocols(), C11156zH.q())) {
            return false;
        }
    ...
    @InterfaceC8046mW0(name = "isTls")
    public final boolean isTls() {
        return this.isTls;
    }

    @InterfaceC8046mW0(name = "supportsTlsExtensions")
    public final boolean supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }

    @InterfaceC8046mW0(name = "tlsVersions")
    @Nullable
    ...
    public static final class Builder {
        ...
        public final Builder cipherSuites(@NotNull CipherSuite... cipherSuiteArr) {
            C6562gT0.p(cipherSuiteArr, "cipherSuites");
            if (this.tls) {
        ...
        @InterfaceC9150r20(message = "since OkHttp 3.13 all TLS-connections are expected to support TLS extensions.\nIn a future release setting this to true will be unnecessary and setting it to false\nwill have no effect.")
        @NotNull
        ...
        public final Builder tlsVersions(@NotNull TlsVersion... tlsVersionArr) {
            C6562gT0.p(tlsVersionArr, "tlsVersions");
            if (this.tls) {
        ...
        public final Builder cipherSuites(@NotNull String... strArr) {
            C6562gT0.p(strArr, "cipherSuites");
            if (this.tls) {
                if (!(strArr.length == 0)) {
