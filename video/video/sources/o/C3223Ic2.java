...
public final class C3223Ic2 implements Map {
    ...
    public class a implements Iterator {
        ...
        public boolean hasNext() {
            ...
            while (this.Y < C3223Ic2.this.X.length) {
                synchronized (C3223Ic2.this.Y[this.Y]) {
                    try {
                        for (f fVar = C3223Ic2.this.X[this.Y]; fVar != null; fVar = fVar.Z) {
                            this.X.add(fVar);
                        }
                        this.Y++;
                        if (this.X.size() > 0) {
        ...
        public void remove() {
            ...
            if (entry != null) {
                C3223Ic2.this.remove(entry.getKey());
                this.Z = null;
                return;
            }
    ...
    public class b extends AbstractSet {
        ...
        public boolean contains(Object obj) {
            ...
            int f = C3223Ic2.this.f(entry.getKey());
            synchronized (C3223Ic2.this.Y[f]) {
                try {
                    for (f fVar = C3223Ic2.this.X[f]; fVar != null; fVar = fVar.Z) {
        ...
        public boolean remove(Object obj) {
            ...
            synchronized (C3223Ic2.this.Y[f]) {
                try {
                    for (f fVar = C3223Ic2.this.X[f]; fVar != null; fVar = fVar.Z) {
                        if (fVar.equals(entry)) {
                            C3223Ic2.this.remove(fVar.getKey());
                            return true;
                        }
                    }
                    return false;
        ...
        @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
        public int size() {
            return C3223Ic2.this.size();
        }
    }

    /* renamed from: o.Ic2$c */
    /* loaded from: classes4.dex */
    public class c extends a {
        public final /* synthetic */ C3223Ic2 Z0;

        public c(C3223Ic2 c3223Ic2) {
            super();
            this.Z0 = c3223Ic2;
        }

        @Override // o.C3223Ic2.a, java.util.Iterator
        public Object next() {
            return b().getKey();
        }
    }

    /* renamed from: o.Ic2$d */
    /* loaded from: classes4.dex */
    public class d extends AbstractSet {
        ...
        @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
        public boolean contains(Object obj) {
            return C3223Ic2.this.containsKey(obj);
        }
    ...
    /* renamed from: o.Ic2$g */
    /* loaded from: classes4.dex */
    public class g extends a {
        public final /* synthetic */ C3223Ic2 Z0;

        public g(C3223Ic2 c3223Ic2) {
            super();
            this.Z0 = c3223Ic2;
        }
