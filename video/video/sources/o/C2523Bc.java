...
public class C2523Bc extends MultiAutoCompleteTextView implements InterfaceC2981Fp2, InterfaceC10984ya0, InterfaceC3275Ip2 {
    public static final int[] b1 = {16843126};
    public final C3705Nb Y0;
    public final C3904Pc Z0;
    public final C9773tc a1;

    public C2523Bc(Context context) {
        this(context, null);
    }
    ...
    public C2523Bc(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, OL1.b.S);
    }

    public C2523Bc(Context context, AttributeSet attributeSet, int i) {
