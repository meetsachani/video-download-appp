...
public final class C4531Vm1 extends AbstractC7152iv0 {
    public int f;
    ...
    public final void a0(AbstractC7152iv0 abstractC7152iv0) {
        C6562gT0.p(abstractC7152iv0, "from");
        d0(abstractC7152iv0);
    }
    ...
    public final void d0(AbstractC7152iv0 abstractC7152iv0) {
        C6562gT0.p(abstractC7152iv0, "from");
        float[] fArr = abstractC7152iv0.b;
        float[] fArr2 = abstractC7152iv0.c;
        long[] jArr = abstractC7152iv0.a;
        int length = jArr.length - 2;
        if (length >= 0) {
            int i = 0;
            while (true) {
    ...
    public final void h0(VA0<? super Float, ? super Float, Boolean> va0) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (va0.i(Float.valueOf(this.b[i4]), Float.valueOf(this.c[i4])).booleanValue()) {
                                i0(i4);
                            }
                        }
                        j >>= 8;
    ...
    public final void j0(int i) {
        long[] jArr;
        C4531Vm1 c4531Vm1 = this;
        long[] jArr2 = c4531Vm1.a;
        float[] fArr = c4531Vm1.b;
        float[] fArr2 = c4531Vm1.c;
        int i2 = c4531Vm1.d;
        V(i);
        float[] fArr3 = c4531Vm1.b;
        float[] fArr4 = c4531Vm1.c;
        int i3 = 0;
        while (i3 < i2) {
            if (((jArr2[i3 >> 3] >> ((i3 & 7) << 3)) & 255) < 128) {
                ...
                int Q = c4531Vm1.Q(i4 >>> 7);
                long j = i4 & 127;
                long[] jArr3 = c4531Vm1.a;
                int i5 = Q >> 3;
                int i6 = (Q & 7) << 3;
    ...
    public /* synthetic */ C4531Vm1(int i, int i2, C9516sY c9516sY) {
        this((i2 & 1) != 0 ? 6 : i);
    }

    public C4531Vm1(int i) {
        super(null);
        if (i >= 0) {
            V(YX1.z(i));
            return;
