...
public final class C10873y7 implements InterfaceC5776dH2 {
    @InterfaceC5670cr1
    ...
    @InterfaceC5670cr1
    public static C10873y7 a(@InterfaceC5670cr1 View view) {
                                        ...
                                        if (textView6 != null) {
                                            ...
                                            if (textView7 != null) {
                                                ...
                                                if (imageView2 != null) {
                                                    ...
                                                    return new C10873y7(nativeAdView, textView, imageView, textView2, textView3, textView4, mediaView, textView5, ratingBar, textView6, textView7, imageView2, nativeAdView);
                                                }
                                            }
                                        }
                                    }
    ...
    @InterfaceC5670cr1
    public static C10873y7 c(@InterfaceC5670cr1 LayoutInflater layoutInflater) {
        return d(layoutInflater, null, false);
    }

    @InterfaceC5670cr1
    public static C10873y7 d(@InterfaceC5670cr1 LayoutInflater layoutInflater, @InterfaceC11300zs1 ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.admob_native_custom_ad, viewGroup, false);
        if (z) {
