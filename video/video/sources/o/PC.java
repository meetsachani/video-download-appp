...
public class PC extends FrameLayout implements UC {
    @InterfaceC5670cr1
    public final RC Y0;

    public PC(@InterfaceC5670cr1 Context context) {
        this(context, null);
    }
    ...
    public PC(@InterfaceC5670cr1 Context context, @InterfaceC11300zs1 AttributeSet attributeSet) {
