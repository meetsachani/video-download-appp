...
public final class C8354nn1 extends H41 {
    public int f;
    ...
    public final void a0(H41 h41) {
        C6562gT0.p(h41, "from");
        d0(h41);
    }

    public final int b0(long j, int i, int i2) {
        int R = R(j);
        if (R < 0) {
            R = ~R;
        } else {
    ...
    public final void h0(VA0<? super Long, ? super Integer, Boolean> va0) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (va0.i(Long.valueOf(this.b[i4]), Integer.valueOf(this.c[i4])).booleanValue()) {
                                i0(i4);
                            }
                        }
                        j >>= 8;
    ...
    public final void j0(int i) {
        long[] jArr;
        C8354nn1 c8354nn1 = this;
        long[] jArr2 = c8354nn1.a;
        long[] jArr3 = c8354nn1.b;
        int[] iArr = c8354nn1.c;
        int i2 = c8354nn1.d;
        V(i);
        long[] jArr4 = c8354nn1.b;
        int[] iArr2 = c8354nn1.c;
        int i3 = 0;
        while (i3 < i2) {
            if (((jArr2[i3 >> 3] >> ((i3 & 7) << 3)) & 255) < 128) {
                ...
                int Q = c8354nn1.Q(i4 >>> 7);
                long j2 = i4 & 127;
                long[] jArr5 = c8354nn1.a;
                int i5 = Q >> 3;
                int i6 = (Q & 7) << 3;
    ...
    public /* synthetic */ C8354nn1(int i, int i2, C9516sY c9516sY) {
        this((i2 & 1) != 0 ? 6 : i);
    }

    public C8354nn1(int i) {
        super(null);
        if (i >= 0) {
            V(YX1.z(i));
            return;
