...
public class C4979a01 extends X11 {
    public RZ0[] h;
    public int i = 8;
    ...
    public class a implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            C4979a01.this.h[this.a].b(((Integer) valueAnimator.getAnimatedValue()).intValue());
            InterfaceC9744tT0 interfaceC9744tT0 = C4979a01.this.g;
    ...
    public void d() {
        ...
        for (int i = 0; i < this.i; i++) {
            ...
            RZ0 rz0 = this.h[i];
            PointF pointF = this.f;
            rz0.h(new PointF(pointF.x, (pointF.y - (min / 2.0f)) + f));
