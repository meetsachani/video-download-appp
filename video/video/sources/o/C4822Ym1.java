...
/* renamed from: o.Ym1  reason: case insensitive filesystem */
/* loaded from: classes.dex */
public final class C4822Ym1 extends AbstractC9850tv0 {
    public int f;
    ...
    public final void a0(AbstractC9850tv0 abstractC9850tv0) {
        C6562gT0.p(abstractC9850tv0, "from");
        d0(abstractC9850tv0);
    }

    public final long b0(float f, long j, long j2) {
        int R = R(f);
        if (R < 0) {
            R = ~R;
        } else {
    ...
    public final void c0(float f, long j) {
        k0(f, j);
    }

    public final void d0(AbstractC9850tv0 abstractC9850tv0) {
        C6562gT0.p(abstractC9850tv0, "from");
        float[] fArr = abstractC9850tv0.b;
        long[] jArr = abstractC9850tv0.c;
        long[] jArr2 = abstractC9850tv0.a;
    ...
    public final boolean f0(float f, long j) {
        int i = i(f);
        if (i >= 0 && this.c[i] == j) {
            i0(i);
            return true;
    ...
    public final void h0(VA0<? super Float, ? super Long, Boolean> va0) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (va0.i(Float.valueOf(this.b[i4]), Long.valueOf(this.c[i4])).booleanValue()) {
                                i0(i4);
                            }
                        }
                        j >>= 8;
    ...
    public final void j0(int i) {
        long[] jArr;
        C4822Ym1 c4822Ym1 = this;
        long[] jArr2 = c4822Ym1.a;
        float[] fArr = c4822Ym1.b;
        long[] jArr3 = c4822Ym1.c;
        int i2 = c4822Ym1.d;
        V(i);
        float[] fArr2 = c4822Ym1.b;
        long[] jArr4 = c4822Ym1.c;
        int i3 = 0;
        while (i3 < i2) {
            if (((jArr2[i3 >> 3] >> ((i3 & 7) << 3)) & 255) < 128) {
                ...
                int Q = c4822Ym1.Q(i4 >>> 7);
                long j = i4 & 127;
                long[] jArr5 = c4822Ym1.a;
                int i5 = Q >> 3;
                int i6 = (Q & 7) << 3;
    ...
    public final void k0(float f, long j) {
        int R = R(f);
        if (R < 0) {
            R = ~R;
        }
    ...
    public /* synthetic */ C4822Ym1(int i, int i2, C9516sY c9516sY) {
        this((i2 & 1) != 0 ? 6 : i);
    }

    public C4822Ym1(int i) {
        super(null);
        if (i >= 0) {
            V(YX1.z(i));
            return;
