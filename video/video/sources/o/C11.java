...
public final class C11 extends FilterOutputStream implements DataOutput {
    public C11(OutputStream outputStream) {
        super(new DataOutputStream((OutputStream) C10664xF1.E(outputStream)));
    }
    ...
    public void writeLong(long j) throws IOException {
        byte[] A = C7194j51.A(Long.reverseBytes(j));
        write(A, 0, A.length);
    }
