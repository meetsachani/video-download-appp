...
public final class S92 {
    ...
    public S92(int i, int i2, float f, float f2, int i3) {
        this.a = i;
        this.b = i2;
        this.c = f;
        this.d = f2;
    ...
    public final int g(short[] sArr, int i) {
        ...
        if (this.b == 1 && i2 == 1) {
            i3 = h(sArr, i, this.f, this.g);
        } else {
            e(sArr, i, i2);
            int h = h(this.i, 0, this.f / i2, this.g / i2);
            if (i2 != 1) {
                int i6 = h * i2;
                int i7 = i2 * 4;
                int i8 = i6 - i7;
    ...
    public final void o(int i) {
        int i2 = this.m - i;
        short[] f = f(this.n, this.f605o, i2);
        this.n = f;
        short[] sArr = this.l;
        int i3 = this.b;
        System.arraycopy(sArr, i * i3, f, this.f605o * i3, i3 * i2);
        this.m = i;
        this.f605o += i2;
    }
    ...
    public void s() {
        ...
        float f = this.c;
        float f2 = this.d;
        int i3 = this.m + ((int) ((((i2 / (f / f2)) + this.f605o) / (this.e * f2)) + 0.5f));
    ...
    public final void u(int i) {
        ...
        short[] sArr = this.n;
        int i2 = this.b;
        System.arraycopy(sArr, i * i2, sArr, 0, (this.f605o - i) * i2);
        this.f605o -= i;
    }
