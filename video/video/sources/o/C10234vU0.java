...
public class C10234vU0 implements InterfaceC8919q62<Double> {
    ...
    public Double a(CharSequence charSequence, CharSequence charSequence2) {
        ...
        if (charSequence != null && charSequence2 != null) {
            if (C4500Ve2.T(charSequence, charSequence2)) {
                return Double.valueOf(1.0d);
            }
            double d = c(charSequence, charSequence2)[0];
            if (d == 0.0d) {
                return Double.valueOf(0.0d);
            }
            double length = (((d / charSequence.length()) + (d / charSequence2.length())) + ((d - (c[1] / 2.0d)) / d)) / 3.0d;
            if (length >= 0.7d) {
                length += c[2] * 0.1d * (1.0d - length);
            }
