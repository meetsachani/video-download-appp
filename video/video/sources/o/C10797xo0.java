...
public final class C10797xo0 {
    ...
    public static String a(String str) throws C9349rr1 {
        Object[][] objArr;
        Object[][] objArr2;
        Object[][] objArr3;
        Object[][] objArr4;
    ...
    public static String b(int i, int i2, String str) throws C9349rr1 {
        if (str.length() >= i) {
            String substring = str.substring(0, i);
            int i3 = i2 + i;
            if (str.length() >= i3) {
                String substring2 = str.substring(i, i3);
                String str2 = C9811tl1.c + substring + ')' + substring2;
    ...
    public static String c(int i, int i2, String str) throws C9349rr1 {
        String substring = str.substring(0, i);
        int i3 = i2 + i;
        if (str.length() < i3) {
            i3 = str.length();
