...
public final class ZE0 {
    ...
    public static <T> T[] c(T[] tArr, int i, T t) {
        if (i + 1 > tArr.length) {
            ?? r0 = (Object[]) Array.newInstance(tArr.getClass().getComponentType(), e(i));
    ...
    public static boolean[] d(boolean[] zArr, int i, boolean z) {
        if (i + 1 > zArr.length) {
    ...
    public static long[] g(long[] jArr, int i, int i2, long j) {
        if (i + 1 <= jArr.length) {
    ...
    public static <T> T[] h(T[] tArr, int i, int i2, T t) {
        if (i + 1 <= tArr.length) {
            System.arraycopy(tArr, i2, tArr, i2 + 1, i - i2);
            tArr[i2] = t;
            return tArr;
        }
        T[] tArr2 = (T[]) ((Object[]) Array.newInstance(tArr.getClass().getComponentType(), e(i)));
    ...
    public static boolean[] i(boolean[] zArr, int i, int i2, boolean z) {
        if (i + 1 <= zArr.length) {
