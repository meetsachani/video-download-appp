...
public abstract class AbstractC3822Of2 extends Number {
    ...
    public static final class b {
        ...
        public volatile long f576o;

        static {
            try {
                Unsafe b = AbstractC3822Of2.b();
                p = b;
    ...
    static {
        try {
            Unsafe f = f();
            b1 = f;
            c1 = f.objectFieldOffset(AbstractC3822Of2.class.getDeclaredField("Y"));
            d1 = f.objectFieldOffset(AbstractC3822Of2.class.getDeclaredField("Z"));
        } catch (Exception e) {
            throw new Error(e);
        }
    }
