...
public class C2454Aj0 extends MessageFormat {
    ...
    public String X;
    public final Map<String, ? extends InterfaceC2801Dx0> Y;

    public C2454Aj0(String str) {
    ...
    public final StringBuilder b(String str, ParsePosition parsePosition, StringBuilder sb) {
        if (sb != null) {
            sb.append('\'');
        }
        g(parsePosition);
    ...
    public final Format d(String str) {
        ...
        if (this.Y != null) {
            ...
            InterfaceC2801Dx0 interfaceC2801Dx0 = this.Y.get(str);
            if (interfaceC2801Dx0 != null) {
                return interfaceC2801Dx0.a(str, str2, getLocale());
            }
        }
        return null;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !super.equals(obj) || C11304zt1.M(getClass(), obj.getClass())) {
            return false;
        }
        C2454Aj0 c2454Aj0 = (C2454Aj0) obj;
        if (C11304zt1.M(this.X, c2454Aj0.X)) {
            return false;
        }
        return !C11304zt1.M(this.Y, c2454Aj0.Y);
    }
    ...
    public final void j(String str, ParsePosition parsePosition) {
        char[] charArray = str.toCharArray();
        do {
            int f = AbstractC8315nd2.l().f(charArray, parsePosition.getIndex());
            parsePosition.setIndex(parsePosition.getIndex() + f);
            if (f <= 0) {
                return;
            }
        } while (parsePosition.getIndex() < str.length());
    ...
    public C2454Aj0(String str, Locale locale) {
        this(str, locale, null);
    }

    public C2454Aj0(String str, Map<String, ? extends InterfaceC2801Dx0> map) {
        this(str, Locale.getDefault(), map);
    }

    public C2454Aj0(String str, Locale locale, Map<String, ? extends InterfaceC2801Dx0> map) {
        super("");
        setLocale(G21.m(locale));
        this.Y = map;
        applyPattern(str);
    }
}
