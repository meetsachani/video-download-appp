...
public final class C10292vk0 implements XI2 {
    ...
    public class a implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            this.a.setAlpha(C3095Gt2.m(this.b, this.c, this.d, this.e, ((Float) valueAnimator.getAnimatedValue()).floatValue()));
        }
    }

    /* renamed from: o.vk0$b */
    /* loaded from: classes3.dex */
    ...
    public Animator a(@InterfaceC5670cr1 ViewGroup viewGroup, @InterfaceC5670cr1 View view) {
        ...
        float f = alpha;
        return c(view, f, 0.0f, 0.0f, this.a, f);
    }
    ...
    public Animator b(@InterfaceC5670cr1 ViewGroup viewGroup, @InterfaceC5670cr1 View view) {
        ...
        float f = alpha;
        return c(view, 0.0f, f, this.a, 1.0f, f);
    }
    ...
    public void e(@InterfaceC2501Av0(from = 0.0d, to = 1.0d) float f) {
        this.a = f;
    }
}
