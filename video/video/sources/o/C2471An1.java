...
public final class C2471An1<K> extends AbstractC8622ot1<K> {
    public int f;
    ...
    public final void b0(AbstractC8622ot1<K> abstractC8622ot1) {
        C6562gT0.p(abstractC8622ot1, "from");
        e0(abstractC8622ot1);
    }

    public final long c0(K k, long j, long j2) {
        int R = R(k);
        if (R < 0) {
            R = ~R;
        } else {
    ...
    public final void d0(K k, long j) {
        l0(k, j);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public final void e0(AbstractC8622ot1<K> abstractC8622ot1) {
        C6562gT0.p(abstractC8622ot1, "from");
        Object[] objArr = abstractC8622ot1.b;
        long[] jArr = abstractC8622ot1.c;
        long[] jArr2 = abstractC8622ot1.a;
    ...
    public final boolean g0(K k, long j) {
        int i = i(k);
        if (i >= 0 && this.c[i] == j) {
            j0(i);
            return true;
    ...
    public final void i0(VA0<? super K, ? super Long, Boolean> va0) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (va0.i(this.b[i4], Long.valueOf(this.c[i4])).booleanValue()) {
                                j0(i4);
                            }
                        }
                        j >>= 8;
    ...
    public final void l0(K k, long j) {
        int R = R(k);
        if (R < 0) {
            R = ~R;
        }
    ...
    public /* synthetic */ C2471An1(int i, int i2, C9516sY c9516sY) {
        this((i2 & 1) != 0 ? 6 : i);
    }

    public C2471An1(int i) {
        super(null);
        if (i >= 0) {
            V(YX1.z(i));
            return;
