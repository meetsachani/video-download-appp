...
public class C6072eV1 extends Drawable {
    public float a;
    ...
    public C6072eV1(ColorStateList colorStateList, float f) {
        this.a = f;
        e(colorStateList);
        this.c = new RectF();
        this.d = new Rect();
    ...
    public final void i(Rect rect) {
        ...
        this.d.set(rect);
        if (this.f) {
            float d = C6315fV1.d(this.e, this.a, this.g);
            this.d.inset((int) Math.ceil(C6315fV1.c(this.e, this.a, this.g)), (int) Math.ceil(d));
            this.c.set(this.d);
        }
    }
