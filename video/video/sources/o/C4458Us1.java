...
public class C4458Us1 extends AbstractC5991eB {
    public static final EnumSet<a> c = EnumSet.copyOf((Collection) Collections.singletonList(a.semiColonRequired));
    public final EnumSet<a> b;

    /* renamed from: o.Us1$a */
    /* loaded from: classes4.dex */
    public enum a {
        semiColonRequired,
        semiColonOptional,
    ...
    public C4458Us1(a... aVarArr) {
        EnumSet<a> copyOf;
        if (C4206Se.n1(aVarArr)) {
            copyOf = c;
        } else {
            copyOf = EnumSet.copyOf((Collection) Arrays.asList(aVarArr));
        }
        this.b = copyOf;
    }
