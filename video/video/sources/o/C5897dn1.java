...
public final class C5897dn1 extends AbstractC7281jR0 {
    public int f;
    ...
    public final void a0(AbstractC7281jR0 abstractC7281jR0) {
        C6562gT0.p(abstractC7281jR0, "from");
        d0(abstractC7281jR0);
    }

    public final float b0(int i, float f, float f2) {
        int R = R(i);
        if (R < 0) {
            R = ~R;
        } else {
    ...
    public final void d0(AbstractC7281jR0 abstractC7281jR0) {
        C6562gT0.p(abstractC7281jR0, "from");
        int[] iArr = abstractC7281jR0.b;
        float[] fArr = abstractC7281jR0.c;
        long[] jArr = abstractC7281jR0.a;
        int length = jArr.length - 2;
        if (length >= 0) {
            int i = 0;
            while (true) {
    ...
    public final void h0(VA0<? super Integer, ? super Float, Boolean> va0) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (va0.i(Integer.valueOf(this.b[i4]), Float.valueOf(this.c[i4])).booleanValue()) {
                                i0(i4);
                            }
                        }
                        j >>= 8;
    ...
    public final void j0(int i) {
        long[] jArr;
        C5897dn1 c5897dn1 = this;
        long[] jArr2 = c5897dn1.a;
        int[] iArr = c5897dn1.b;
        float[] fArr = c5897dn1.c;
        int i2 = c5897dn1.d;
        V(i);
        int[] iArr2 = c5897dn1.b;
        float[] fArr2 = c5897dn1.c;
        int i3 = 0;
        while (i3 < i2) {
            if (((jArr2[i3 >> 3] >> ((i3 & 7) << 3)) & 255) < 128) {
                ...
                int Q = c5897dn1.Q(i5 >>> 7);
                long j = i5 & 127;
                long[] jArr3 = c5897dn1.a;
                int i6 = Q >> 3;
                int i7 = (Q & 7) << 3;
    ...
    public /* synthetic */ C5897dn1(int i, int i2, C9516sY c9516sY) {
        this((i2 & 1) != 0 ? 6 : i);
    }

    public C5897dn1(int i) {
        super(null);
        if (i >= 0) {
            V(YX1.z(i));
            return;
