...
public class C10748xc extends ImageButton implements InterfaceC2981Fp2, InterfaceC3373Jp2 {
    public final C3705Nb Y0;
    public final C10991yc Z0;
    public boolean a1;

    public C10748xc(Context context) {
        this(context, null);
    }
    ...
    public C10748xc(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, OL1.b.K1);
    }

    public C10748xc(Context context, AttributeSet attributeSet, int i) {
