...
public class C2720Dc0 {
    ...
    public static List<InterfaceC2426Ac0.c> c(List<EncoderProfiles.VideoProfile> list) {
        ...
        for (EncoderProfiles.VideoProfile videoProfile : list) {
            arrayList.add(InterfaceC2426Ac0.c.a(videoProfile.getCodec(), videoProfile.getMediaType(), videoProfile.getBitrate(), videoProfile.getFrameRate(), videoProfile.getWidth(), videoProfile.getHeight(), videoProfile.getProfile(), videoProfile.getBitDepth(), videoProfile.getChromaSubsampling(), videoProfile.getHdrFormat()));
        }
        return arrayList;
    }
}
