...
public class C4776Yb {
    ...
    public C4776Yb(CheckedTextView checkedTextView) {
        this.a = checkedTextView;
    }

    public void a() {
        Drawable a = SB.a(this.a);
        if (a != null) {
            if (this.d || this.e) {
    ...
    */
    public void d(AttributeSet attributeSet, int i) {
        ...
        C6516gH2.G1(checkedTextView, checkedTextView.getContext(), iArr, attributeSet, G.B(), i, 0);
        try {
            int i4 = OL1.m.u3;
            if (G.C(i4) && (u2 = G.u(i4, 0)) != 0) {
                try {
                    CheckedTextView checkedTextView2 = this.a;
                    checkedTextView2.setCheckMarkDrawable(C3220Ic.b(checkedTextView2.getContext(), u2));
                ...
                i3 = OL1.m.w3;
                if (G.C(i3)) {
                    SB.e(this.a, X60.e(G.o(i3, -1), null));
                }
                G.I();
            }
            int i5 = OL1.m.t3;
            if (G.C(i5) && (u = G.u(i5, 0)) != 0) {
                ...
                checkedTextView3.setCheckMarkDrawable(C3220Ic.b(checkedTextView3.getContext(), u));
            }
            i2 = OL1.m.v3;
            if (G.C(i2)) {
            }
