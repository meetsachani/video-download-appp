...
public final class C8765pT implements InterfaceC5776dH2 {
    @InterfaceC5670cr1
    ...
    @InterfaceC5670cr1
    public static C8765pT a(@InterfaceC5670cr1 View view) {
                ...
                if (textView != null) {
                    ...
                    if (textView2 != null) {
                        ...
                        if (textView3 != null) {
                            ...
                            if (textView4 != null) {
                                return new C8765pT(linearLayout, imageView, imageView2, textView, linearLayout, textView2, textView3, textView4);
                            }
                        }
                    }
                }
    ...
    @InterfaceC5670cr1
    public static C8765pT c(@InterfaceC5670cr1 LayoutInflater layoutInflater) {
        return d(layoutInflater, null, false);
    }

    @InterfaceC5670cr1
    public static C8765pT d(@InterfaceC5670cr1 LayoutInflater layoutInflater, @InterfaceC11300zs1 ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.custom_quiz_small_native_layout, viewGroup, false);
        if (z) {
