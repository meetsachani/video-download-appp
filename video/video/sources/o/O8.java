...
public class O8 extends N0 implements EJ, Serializable {
    ...
    public static /* synthetic */ boolean u(Path path, BasicFileAttributes basicFileAttributes, HJ0 hj0) {
    ...
    public FileVisitResult a(final Path path, final BasicFileAttributes basicFileAttributes) {
        ...
        return N0.p(this.Z.stream().allMatch(new Predicate() { // from class: o.K8
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return O8.u(path, basicFileAttributes, (HJ0) obj);
            }
        }));
    }
    ...
    public boolean accept(final File file) {
        return !x() && this.Z.stream().allMatch(new Predicate() { // from class: o.M8
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean accept;
    ...
    public void w(HJ0... hj0Arr) {
        ...
        Stream.of((Object[]) hj0Arr).forEach(new Consumer() { // from class: o.L8
    ...
    public O8(ArrayList<HJ0> arrayList) {
    ...
    public boolean accept(final File file, final String str) {
        return !x() && this.Z.stream().allMatch(new Predicate() { // from class: o.N8
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean accept;
    ...
    public O8(HJ0... hj0Arr) {
        this(hj0Arr.length);
        Objects.requireNonNull(hj0Arr, "fileFilters");
        w(hj0Arr);
    }

    public O8(HJ0 hj0, HJ0 hj02) {
        this(2);
        g(hj0);
        g(hj02);
    }
