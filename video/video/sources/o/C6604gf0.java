...
public class C6604gf0 extends InputStream {
    public static final Queue<C6604gf0> Z = SD2.g(0);
    public InputStream X;
    public IOException Y;

    public static void a() {
        while (true) {
            Queue<C6604gf0> queue = Z;
            if (!queue.isEmpty()) {
                queue.remove();
            } else {
                return;
    ...
    public static C6604gf0 d(InputStream inputStream) {
        C6604gf0 poll;
        Queue<C6604gf0> queue = Z;
        synchronized (queue) {
            poll = queue.poll();
