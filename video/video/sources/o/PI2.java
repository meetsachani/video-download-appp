...
public final class PI2 {
    public static final PI2 k = k(C4654Wt.c, (float) ((C4654Wt.h(50.0f) * 63.66197723675813d) / 100.0d), 50.0f, 2.0f, false);
    ...
    public PI2(float f, float f2, float f3, float f4, float f5, float f6, float[] fArr, float f7, float f8, float f9) {
        this.f = f;
        this.a = f2;
        this.b = f3;
        this.c = f4;
    ...
    public static PI2 k(float[] fArr, float f, float f2, float f3, boolean z) {
        float d;
        float exp;
        float[][] fArr2 = C4654Wt.a;
        float f4 = fArr[0];
        float[] fArr3 = fArr2[0];
        float f5 = fArr[1];
        float f6 = fArr[2];
        ...
        if (f10 >= 0.9d) {
            d = C4654Wt.d(0.59f, 0.69f, (f10 - 0.9f) * 10.0f);
        } else {
            d = C4654Wt.d(0.525f, 0.59f, (f10 - 0.8f) * 10.0f);
        }
        float f11 = d;
        if (z) {
            exp = 1.0f;
        ...
        return new PI2(h, ((fArr8[0] * 2.0f) + fArr8[1] + (fArr8[2] * 0.05f)) * pow, pow, pow, f11, f10, fArr6, cbrt, (float) Math.pow(cbrt, 0.25d), ((float) Math.sqrt(d3)) + 1.48f);
    }
