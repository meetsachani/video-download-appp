...
public final class LG1 implements InterfaceC5776dH2 {
    @InterfaceC5670cr1
    ...
    @InterfaceC5670cr1
    public static LG1 a(@InterfaceC5670cr1 View view) {
                            ...
                            if (textView3 != null) {
                                ...
                                if (textView4 != null) {
                                    ...
                                    if (textView5 != null) {
                                        ...
                                        return new LG1(linearLayout2, linearLayout, textView, textView2, mediaView, mediaView2, textView3, textView4, textView5, linearLayout2);
                                    }
                                }
                            }
                        }
    ...
    @InterfaceC5670cr1
    public static LG1 c(@InterfaceC5670cr1 LayoutInflater layoutInflater) {
        return d(layoutInflater, null, false);
    }

    @InterfaceC5670cr1
    public static LG1 d(@InterfaceC5670cr1 LayoutInflater layoutInflater, @InterfaceC11300zs1 ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.premium_adver_fb_native_custom, viewGroup, false);
        if (z) {
