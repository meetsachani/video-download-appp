...
public class C6489gB {
        ...
        if (charSequence2 != null && charSequence != null) {
            ...
            if (i >= 0 && length2 >= 0 && length2 <= length) {
                ...
                while (true) {
                    ...
                    } else if (a(charSequence, charSequence2, length2, i)) {
                        return i;
                    } else {
                        i--;
                        if (i < 0) {
    ...
    public static boolean f(CharSequence charSequence, boolean z, int i, CharSequence charSequence2, int i2, int i3) {
    ...
    public static char[] h(CharSequence charSequence) {
        int F1 = C4500Ve2.F1(charSequence);
        if (F1 == 0) {
            return C4206Se.e;
        }
        if (charSequence instanceof String) {
